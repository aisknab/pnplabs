...
const CORE_TREE = "2ab1d800d697d4f6f0fa360615f4315ff277c022";
const PROOF_COMMIT = "341fdff1b887ef56f7f51560dd8f213185a1a581";
...
const RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREMS = {
  "PNP.DirectWire.TerminalFullCarrierRealization.project_realization": { hash: "e18ceb7862c428c17a83e7709f12149179b9618aecdb92de9885dec5a7a6cf8a", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.TerminalFullCarrierRealization.project_implementation": { hash: "4adb38449d826339de7be4ef2f076ee3a96bf5da4b0fff319ef956391012acf5", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.TerminalFullCarrierRealization.project_gateCount": { hash: "cf7fb7ec364e8a65984ac9001ea5f4653959f2d0599ad0706aed74bd970a3551", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.TerminalFullCarrierRealization.project_equivalent": { hash: "79c2680c1645a5bb087ae3786eba52204e2297ebcc8049a8f4103603c9343a08", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.TerminalFullCarrierRealization.project_semantics": { hash: "bcc4254513f072db91e3757f0c3962d757480d72d4270b91139a6bf57a325ee6", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.TerminalCheckedFullLift.fullRealization_realization": { hash: "1f98a1fbc39672b171e5d1a5f6f1716c785dbcf128c24c3071802e7fbf5d0caf", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.TerminalCheckedFullLift.fullRealization_profileEqual": { hash: "ee608d7e17b2846b5a87c15b8e6874ac7de023798ebdd827994e9503dc43d7c1", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.terminalCheckedFullLift_iff_fullProfileEqual": { hash: "a038fc4300e2f93af3cdac76907511237e0dd6d6b9e0d3015a7301b82ce8d899", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.TerminalQuotientComparison.checkedFullLift_of_keepsAll": { hash: "22011cdf57634577ca660f526487e3a2a309c716c5ab419a201bc323c0c566ca", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.TerminalFullCarrierRealization.obligationsDischarged": { hash: "44dd06dc5c2d17056eaf5271522830951da6a77bd69fdd28a098880780361d38", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.TerminalCheckedFullLift.obligationsDischarged": { hash: "619562c57b2ccbe271d44d8902d27c8788a9ee262dfab89059b6bf8164fda69b", axioms: [], module: "PNP.ResidualTerminalModeFirewall" },
  "PNP.DirectWire.terminalQuotientEqualityNotConstructive": { hash: "d9f2582756a57c87b345e1b462ae765c654e719dc56171939ecbf3de8a2c0e1c", axioms: [], module: "PNP.ResidualTerminalModeFirewall" }
};

const RESIDUAL_TERMINAL_MODE_FIREWALL_SCOPE = "all-finite-direct-wire-implementations-with-computed-finite-profile-observers-and-explicit-forgetful-projections";
const RESIDUAL_TERMINAL_MODE_FIREWALL_MILESTONE_SCOPE = "For every finite direct-wire implementation, a computed finite profile observer records the ten terminal carrier roles and an explicit forgetful projection selects the quotient coordinates. Projection retains the exact implementation, gate count, and complete multi-output Boolean semantics. A quotient comparison has a checked full lift exactly when every forgotten profile coordinate agrees, lossless projections lift directly, and obligation discharge transports across a checked lift.";
const RESIDUAL_TERMINAL_MODE_FIREWALL_NON_CLAIM = "This is a terminal comparison/lifting firewall only. It supplies no proper or governed supports, arbitrary quotient construction, support or projection-defect minimum, saturation, Package E, BCEL/BN2-BN6, packet or selector completeness, global residual route, ZeroSlack certificate, PCCMin exactness or polynomial runtime, SAT-in-P result, discharged project assumption, or proof that P = NP.";

const RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREMS = {
  ...
  "PNP.DirectWire.terminalFullProfileMinimum_spec": { hash: "aa0ecb861cb6454b659931d96a1bb107edc42902fb0be66ca287b369f2659bfc", axioms: ["propext"], module: "PNP.ResidualTerminalProjectionMinimum" },
  "PNP.DirectWire.terminalQuotientProfileMinimum_spec": { hash: "494e3230379f9fb0bbe634f68987117605fffe8dbcfe130311b2724e9b65c73a", axioms: ["propext"], module: "PNP.ResidualTerminalProjectionMinimum" },
  "PNP.DirectWire.terminalProjectionMinimum_mono": { hash: "c3e9aa3c01a5a9702c311df28dcbadd2a8e8005776418307147b424cc988f034", axioms: ["propext"], module: "PNP.ResidualTerminalProjectionMinimum" },
  "PNP.DirectWire.terminalQuotientMinimum_add_projectionDefect": { hash: "2487f2fa58c556c6166f02e57ed79ed5c1d0e6c2a9ac86fa96630ef10a66d4a0", axioms: ["propext"], module: "PNP.ResidualTerminalProjectionMinimum" },
  ...
  "PNP.DirectWire.terminalProjectionDefect_eq_zero_iff_exists_checkedFullLiftAtMinimum": { hash: "8c1b490e05aca8450c836267b85afeb88f838b5d5b26301599b8392bd0178a17", axioms: ["propext"], module: "PNP.ResidualTerminalProjectionMinimum" },
  "PNP.DirectWire.terminalProfileMinima_eq_of_keepsAll": { hash: "973db9a1c04cce7aa637d65512904844dc9a26e645ed2720d89d3818cdc79c3a", axioms: ["propext"], module: "PNP.ResidualTerminalProjectionMinimum" },
...
const RESIDUAL_TERMINAL_SATURATION_THEOREMS = {
  ...
  "PNP.DirectWire.terminalSaturate_extensive": { hash: "80a5d112df19cb4fd03210ffdd06be067829549a28e2da0746230f79994761fc", axioms: [], module: "PNP.ResidualTerminalSaturation" },
  "PNP.DirectWire.terminalSaturate_closed": { hash: "3f4566c23897191ee812427490e9ce9a4df87e90983775289f60a9472895bdf5", axioms: [], module: "PNP.ResidualTerminalSaturation" },
  "PNP.DirectWire.terminalSaturate_least": { hash: "0cc287c76c18cfe0b0ce632d92b85e6a8173b9cd0841b8fdfafeffc9cb025790", axioms: [], module: "PNP.ResidualTerminalSaturation" },
  "PNP.DirectWire.terminalSaturate_monotone": { hash: "d1bc557a4eb268ad67b96377c3cb668d1d141234cc1548155252f2429f9123ba", axioms: [], module: "PNP.ResidualTerminalSaturation" },
  "PNP.DirectWire.terminalSaturate_idempotent": { hash: "60fbcc602264e47fa5fea3bd772bfa344a1a0d6d2086baf3c7ac7b453b7efda0", axioms: ["Quot.sound", "propext"], module: "PNP.ResidualTerminalSaturation" },
  "PNP.DirectWire.terminalSaturate_fixed_iff_closed": { hash: "ac4339ee65e025371c429d3de428d39118f9d8d5eba92749fa7b08f8013bd22a", axioms: ["Quot.sound", "propext"], module: "PNP.ResidualTerminalSaturation" }
};

const RESIDUAL_TERMINAL_SATURATION_SCOPE = "all-finite-terminal-primitive-record-universes-with-explicit-boolean-rule-tagged-dependencies";
const RESIDUAL_TERMINAL_SATURATION_MILESTONE_SCOPE = "For every finite terminal primitive-record universe and every explicit Boolean dependency system tagged by the manuscript's ten closure mechanisms, the generated reflexive transitive closure contains the seed, is dependency-closed, is least among closed supersets, is monotone and idempotent, and has exactly the closed supports as fixed points.";
const RESIDUAL_TERMINAL_SATURATION_NON_CLAIM = "This closure theorem does not derive the dependency relation from an arbitrary circuit, construct proper support, prove support completion or square legitimacy, instantiate a projection-compatible square, prove SaturatePositive or BCELReady, discharge Package E or BCEL/BN2-BN6, generate a complete residual route, prove ZeroSlack or PCCMin, establish polynomial runtime, put SAT in P, remove a project assumption, or prove P = NP.";
...
const RESIDUAL_TERMINAL_SATURATION_RELEASE_IDENTITIES = {
  ...
  residualTerminalSaturationClosedTheorem: "PNP.DirectWire.terminalSaturate_closed",
  residualTerminalSaturationLeastTheorem: "PNP.DirectWire.terminalSaturate_least",
  residualTerminalSaturationMonotoneTheorem: "PNP.DirectWire.terminalSaturate_monotone",
  residualTerminalSaturationIdempotentTheorem: "PNP.DirectWire.terminalSaturate_idempotent",
  residualTerminalSaturationFixedPointTheorem: "PNP.DirectWire.terminalSaturate_fixed_iff_closed"
};
...
const RESIDUAL_TERMINAL_FULL_BRIDGE_RELEASE_IDENTITIES = {
  residualTerminalFullTerminalizeImplementationTheorem: "PNP.DirectWire.terminalize_implementation",
  residualTerminalFullTerminalizeGateCountTheorem: "PNP.DirectWire.terminalize_gateCount",
  residualTerminalFullRealizeEquivalentTheorem: "PNP.DirectWire.TerminalFullRealization.realize_equivalent",
  residualTerminalFullRealizeSemanticsTheorem: "PNP.DirectWire.TerminalFullRealization.realize_semantics",
  residualTerminalFullReferenceMinimumRealizationGateCountTheorem: "PNP.DirectWire.referenceMinimumTerminalFullRealization_gateCount",
  residualTerminalFullMinimumEqualityTheorem: "PNP.DirectWire.terminalFullMinimum_eq_referenceMinimum",
  residualTerminalFullMinimumSpecTheorem: "PNP.DirectWire.terminalFullMinimum_spec",
  residualTerminalFullMinimumUniquenessTheorem: "PNP.DirectWire.isTerminalFullMinimum_iff_eq_terminalFullMinimum",
  residualTerminalFullMinimumReferenceUniquenessTheorem: "PNP.DirectWire.isTerminalFullMinimum_iff_eq_referenceMinimum",
  residualTerminalFullWholeSpanDescentTheorem: "PNP.DirectWire.WholeSpanResidualWitness.strictResidualDescent",
  residualTerminalFullPositiveWitnessIffTheorem: "PNP.DirectWire.residualSlack_pos_iff_exists_wholeSpanResidualWitness",
  residualTerminalFullZeroAbsenceIffTheorem: "PNP.DirectWire.residualSlack_eq_zero_iff_no_wholeSpanResidualWitness",
  residualTerminalFullReusedStrictDescentTheorem: "PNP.DirectWire.StrictEquivalentGain.strictResidualDescent"
};

const RESIDUAL_TERMINAL_MODE_FIREWALL_RELEASE_IDENTITIES = {
  residualTerminalProjectRealizationTheorem: "PNP.DirectWire.TerminalFullCarrierRealization.project_realization",
  residualTerminalProjectImplementationTheorem: "PNP.DirectWire.TerminalFullCarrierRealization.project_implementation",
  residualTerminalProjectGateCountTheorem: "PNP.DirectWire.TerminalFullCarrierRealization.project_gateCount",
  residualTerminalProjectEquivalentTheorem: "PNP.DirectWire.TerminalFullCarrierRealization.project_equivalent",
  residualTerminalProjectSemanticsTheorem: "PNP.DirectWire.TerminalFullCarrierRealization.project_semantics",
  residualTerminalLiftRealizationTheorem: "PNP.DirectWire.TerminalCheckedFullLift.fullRealization_realization",
  residualTerminalLiftProfileEqualTheorem: "PNP.DirectWire.TerminalCheckedFullLift.fullRealization_profileEqual",
  residualTerminalLiftIffFullProfileEqualTheorem: "PNP.DirectWire.terminalCheckedFullLift_iff_fullProfileEqual",
  residualTerminalKeepsAllLiftTheorem: "PNP.DirectWire.TerminalQuotientComparison.checkedFullLift_of_keepsAll",
  residualTerminalFullObligationsDischargedTheorem: "PNP.DirectWire.TerminalFullCarrierRealization.obligationsDischarged",
  residualTerminalLiftObligationsDischargedTheorem: "PNP.DirectWire.TerminalCheckedFullLift.obligationsDischarged",
  residualTerminalQuotientEqualityNotConstructiveTheorem: "PNP.DirectWire.terminalQuotientEqualityNotConstructive"
};

const RESIDUAL_TERMINAL_PROJECTION_MINIMUM_RELEASE_IDENTITIES = {
  residualProjectionFullMatchCompleteTheorem: "PNP.DirectWire.terminalFullProfileMatchBool_complete",
  residualProjectionQuotientMatchCompleteTheorem: "PNP.DirectWire.terminalQuotientProfileMatchBool_complete",
  residualProjectionFullAttainedGateCountTheorem: "PNP.DirectWire.terminalFullProfileMinimumRealization_gateCount",
  residualProjectionQuotientAttainedGateCountTheorem: "PNP.DirectWire.terminalQuotientProfileMinimumComparison_gateCount",
  residualProjectionFullLowerBoundTheorem: "PNP.DirectWire.terminalFullProfileMinimum_le",
  residualProjectionQuotientLowerBoundTheorem: "PNP.DirectWire.terminalQuotientProfileMinimum_le",
  residualProjectionFullMinimumSpecTheorem: "PNP.DirectWire.terminalFullProfileMinimum_spec",
  residualProjectionQuotientMinimumSpecTheorem: "PNP.DirectWire.terminalQuotientProfileMinimum_spec",
  residualProjectionMonotonicityTheorem: "PNP.DirectWire.terminalProjectionMinimum_mono",
  residualProjectionDefectDecompositionTheorem: "PNP.DirectWire.terminalQuotientMinimum_add_projectionDefect",
  residualProjectionDefectZeroIffMinimaEqualTheorem: "PNP.DirectWire.terminalProjectionDefect_eq_zero_iff_minima_eq",
  residualProjectionDefectZeroIffCheckedLiftTheorem: "PNP.DirectWire.terminalProjectionDefect_eq_zero_iff_exists_checkedFullLiftAtMinimum",
  residualProjectionKeepsAllMinimaEqualTheorem: "PNP.DirectWire.terminalProfileMinima_eq_of_keepsAll",
  residualProjectionPositiveDefectNoLiftTheorem: "PNP.DirectWire.terminalProjectionDefect_pos_no_checkedFullLiftAtMinimum"
};
...
const EXPECTED_FILES = [
  {
    ...
    bytes: 428831,
    sha256: "654dc634d86e7ebf2633c4d7d67d4cbf36a10c57bede51b4f8cf246fd169fefb",
    role: "current inventory-derived seventy-three-page formal-reconstruction report PDF"
  },
  {
  ...
  },
  {
    ...
    bytes: 185272,
    sha256: "f1d9b3f85b0ee7414ab9e40a9e1095f153f208ab9e121f5fd8aa3efef46d7c4a",
  ...
  },
  {
    ...
    bytes: 1725364,
    sha256: "ada16fd663a00a8ff6a10ba29693df2b0a13fe3cf6b68ec7521da9259d5de235",
    role: "exact current core formal-reconstruction status mirror"
  },
  {
    path: "public/pnp-theorem-inventory.json",
    bytes: 13748432,
    sha256: "58d8118f3aef8976a3f1bdb2063a6d08baa7f2fe01e7393881fc9776f738aac9",
    role: "exact current compiled Lean theorem inventory mirror"
  },
  {
    path: "downloads/formal-publication-release.json",
    bytes: 662177,
    sha256: "cf1efe84ee73b8f4da09cb05187da1ced7ea84def7373ddd6ba88a59a6f49ef8",
...
function assertFailClosedStatus(status) {
  ...
  if (status.coordinate !== "PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-04-101") fail("status coordinate mismatch");
  if (status.publicSurfaceBaselineCoordinate !== "PUBLIC-SURFACE-BASELINE-2026-08-04-RESIDUAL-TERMINAL-SATURATION-100") fail("status public-surface coordinate mismatch");
  if (status.formalPublicationMapCoordinate !== "PNP-FORMAL-PUBLICATION-MAP-2026-08-04-101" || status.formalPublicationMapSha256 !== "a86df7f8d45a5430bc1b7cc67dfac31e8663a9e81ed24abc0f25a2cd299b0b7c" || status.leanSourceClosureSha256 !== "5cb2ae9d032d09c08f34424ccdf0b67452d75b8a933b60114c5267cc69385a7f") fail("status source identity mismatch");
  if (!Array.isArray(status.formalPublicationMilestones) || status.formalPublicationMilestones.length !== 81 || status.formalPublicationMilestones.filter((row) => row.earned === true).length !== 78 || status.formalPublicationMilestones.filter((row) => row.status === "not-formalized").length !== 3) fail("status formal-publication milestone counts mismatch");
  ...
  if (!lockedNANDGlobalCandidateMilestone || lockedNANDGlobalCandidateMilestone.earned !== true || lockedNANDGlobalCandidateMilestone.allPresent !== true || lockedNANDGlobalCandidateMilestone.allKernelTypesMatch !== true || lockedNANDGlobalCandidateMilestone.axiomClosureUsesOnlyLeanStandardAllowlist !== true || lockedNANDGlobalCandidateMilestone.requiredTheorems?.length !== 11) fail("status locked-NAND global-candidate boundary mismatch");
  if (!(status.leanLockedNANDGlobalCandidateAssemblyFormalized === true && status.leanLockedNANDGlobalBaselineCandidateFormalized === true && status.leanLockedNANDGlobalCandidateAxiomAuditPassed === true && status.leanLockedNANDGlobalCandidateAuditedDeclarationCount === 71 && status.leanLockedNANDGlobalCandidateScope === "arbitrary-finite-topological-nand-circuits-exact-baseline-and-four-gate-extension")) fail("status locked-NAND global-candidate evidence mismatch");
  ...
  const lockedNANDSourceParserNames = Object.keys(LOCKED_NAND_SOURCE_PARSER_THEOREMS);
  if (!lockedNANDSourceParserMilestone
      ...
      || lockedNANDSourceParserMilestone.scope !== LOCKED_NAND_SOURCE_PARSER_MILESTONE_SCOPE
      || lockedNANDSourceParserMilestone.nonClaim !== LOCKED_NAND_SOURCE_PARSER_NON_CLAIM
      || JSON.stringify(lockedNANDSourceParserMilestone.requiredTheorems) !== JSON.stringify(lockedNANDSourceParserNames)
      || lockedNANDSourceParserMilestone.earned !== true
      || lockedNANDSourceParserMilestone.allPresent !== true
      || lockedNANDSourceParserMilestone.allAssumptionFree !== false
      ...
      || lockedNANDSourceParserMilestone.sourceClosureFingerprintMatches !== true) fail("status locked-NAND source-parser publication boundary mismatch");
  if (!Array.isArray(lockedNANDSourceParserMilestone.theoremRows) || lockedNANDSourceParserMilestone.theoremRows.length !== lockedNANDSourceParserNames.length) fail("status locked-NAND source-parser theorem-row count mismatch");
  for (const [name, evidence] of Object.entries(LOCKED_NAND_SOURCE_PARSER_THEOREMS)) {
    const row = lockedNANDSourceParserMilestone.theoremRows.find((candidate) => candidate.name === name);
    if (!row
        || row.present !== true
        || row.kind !== "theorem"
        ...
        || row.kernelTypeFingerprintMatches !== true) fail(`status locked-NAND source-parser theorem evidence mismatch: ${name}`);
  }
  if (!(status.leanConcreteLockedNANDParserMachineFormalized === true
      ...
      && status.leanConcreteLockedNANDParserScope === LOCKED_NAND_SOURCE_PARSER_SCOPE
      && status.leanConcreteLockedNANDEmitterMachineFormalized === true
      && status.leanConcreteLockedNANDPolynomialReductionFormalized === true)) fail("status locked-NAND source-parser evidence mismatch");
  ...
  const lockedNANDTargetEmitterNames = Object.keys(LOCKED_NAND_TARGET_EMITTER_THEOREMS);
  if (!lockedNANDTargetEmitterMilestone
      ...
      || lockedNANDTargetEmitterMilestone.scope !== LOCKED_NAND_TARGET_EMITTER_MILESTONE_SCOPE
      || lockedNANDTargetEmitterMilestone.nonClaim !== LOCKED_NAND_TARGET_EMITTER_NON_CLAIM
      || JSON.stringify(lockedNANDTargetEmitterMilestone.requiredTheorems) !== JSON.stringify(lockedNANDTargetEmitterNames)
      || lockedNANDTargetEmitterMilestone.earned !== true
      || lockedNANDTargetEmitterMilestone.allPresent !== true
      || lockedNANDTargetEmitterMilestone.allAssumptionFree !== false
      ...
      || lockedNANDTargetEmitterMilestone.sourceClosureFingerprintMatches !== true) fail("status locked-NAND target-emitter publication boundary mismatch");
  if (!Array.isArray(lockedNANDTargetEmitterMilestone.theoremRows) || lockedNANDTargetEmitterMilestone.theoremRows.length !== lockedNANDTargetEmitterNames.length) fail("status locked-NAND target-emitter theorem-row count mismatch");
  for (const [name, evidence] of Object.entries(LOCKED_NAND_TARGET_EMITTER_THEOREMS)) {
    const row = lockedNANDTargetEmitterMilestone.theoremRows.find((candidate) => candidate.name === name);
    if (!row
        || row.present !== true
        || row.kind !== "theorem"
        || JSON.stringify(row.axioms) !== JSON.stringify(evidence.axioms)
        || row.actualKernelTypeSha256 !== evidence.hash
        || row.expectedKernelTypeSha256 !== evidence.hash
        || row.kernelTypeFingerprintMatches !== true) fail(`status locked-NAND target-emitter theorem evidence mismatch: ${name}`);
  }
  if (!(status.leanConcreteLockedNANDEmitterMachineFormalized === true
      ...
      && status.leanConcreteLockedNANDEmitterScope === LOCKED_NAND_TARGET_EMITTER_SCOPE
      && status.leanConcreteLockedNANDPolynomialReductionFormalized === true)) fail("status locked-NAND target-emitter evidence mismatch");
  ...
  const lockedNANDPolynomialReductionNames = Object.keys(LOCKED_NAND_POLYNOMIAL_REDUCTION_THEOREMS);
  if (!lockedNANDPolynomialReductionMilestone
      ...
      || lockedNANDPolynomialReductionMilestone.scope !== LOCKED_NAND_POLYNOMIAL_REDUCTION_MILESTONE_SCOPE
      || lockedNANDPolynomialReductionMilestone.nonClaim !== LOCKED_NAND_POLYNOMIAL_REDUCTION_NON_CLAIM
      || JSON.stringify(lockedNANDPolynomialReductionMilestone.requiredTheorems) !== JSON.stringify(lockedNANDPolynomialReductionNames)
      || lockedNANDPolynomialReductionMilestone.earned !== true
      || lockedNANDPolynomialReductionMilestone.allPresent !== true
      || lockedNANDPolynomialReductionMilestone.allAssumptionFree !== false
      ...
      || lockedNANDPolynomialReductionMilestone.sourceClosureFingerprintMatches !== true) fail("status locked-NAND polynomial-reduction publication boundary mismatch");
  if (!Array.isArray(lockedNANDPolynomialReductionMilestone.theoremRows) || lockedNANDPolynomialReductionMilestone.theoremRows.length !== lockedNANDPolynomialReductionNames.length) fail("status locked-NAND polynomial-reduction theorem-row count mismatch");
  for (const [name, evidence] of Object.entries(LOCKED_NAND_POLYNOMIAL_REDUCTION_THEOREMS)) {
    const row = lockedNANDPolynomialReductionMilestone.theoremRows.find((candidate) => candidate.name === name);
    if (!row
        || row.present !== true
        || row.kind !== "theorem"
        || JSON.stringify(row.axioms) !== JSON.stringify(evidence.axioms)
        || row.actualKernelTypeSha256 !== evidence.hash
        || row.expectedKernelTypeSha256 !== evidence.hash
        || row.kernelTypeFingerprintMatches !== true) fail(`status locked-NAND polynomial-reduction theorem evidence mismatch: ${name}`);
  }
  ...
  if (!cnfToNANDPolynomialReductionMilestone
      ...
      || cnfToNANDPolynomialReductionMilestone.sourceClosureFingerprintMatches !== true) fail("status CNF-to-NAND polynomial-reduction publication boundary mismatch");
  for (const [name, evidence] of Object.entries(CNF_TO_NAND_POLYNOMIAL_REDUCTION_THEOREMS)) {
    ...
    if (!row
        ...
        || row.actualKernelTypeSha256 !== evidence.hash
        || row.expectedKernelTypeSha256 !== evidence.hash
        || row.kernelTypeFingerprintMatches !== true) fail(`status CNF-to-NAND polynomial-reduction theorem evidence mismatch: ${name}`);
  }
  if (!(status.leanConcreteCNFToNANDPolynomialReductionFormalized === true
      ...
      && status.leanConcreteCNFToNANDPolynomialReductionScope === CNF_TO_NAND_POLYNOMIAL_REDUCTION_SCOPE)) fail("status CNF-to-NAND polynomial-reduction evidence mismatch");
  ...
  if (!residualGainChainMilestone
      ...
      || residualGainChainMilestone.sourceClosureFingerprintMatches !== true) fail("status residual-gain chain publication boundary mismatch");
  for (const [name, evidence] of Object.entries(RESIDUAL_GAIN_CHAIN_THEOREMS)) {
    ...
    if (!row || row.present !== true || row.kind !== "theorem"
        ...
        || row.actualKernelTypeSha256 !== evidence.hash
        || row.expectedKernelTypeSha256 !== evidence.hash
        || row.kernelTypeFingerprintMatches !== true) fail(`status residual-gain chain theorem evidence mismatch: ${name}`);
  }
  ...
  if (!residualTerminalFullBridgeMilestone
      ...
      || residualTerminalFullBridgeMilestone.status !== "formalized-terminal-full-mode-semantic-bridge"
      ...
      || residualTerminalFullBridgeMilestone.sourceClosureFingerprintMatches !== true) fail("status residual terminal full-carrier bridge publication boundary mismatch");
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_FULL_BRIDGE_THEOREMS)) {
    const row = residualTerminalFullBridgeMilestone?.theoremRows?.find((candidate) => candidate.name === name);
    if (!row || row.present !== true || row.kind !== "theorem"
        || JSON.stringify(row.axioms) !== JSON.stringify(evidence.axioms)
        || row.actualKernelTypeSha256 !== evidence.hash
        || row.expectedKernelTypeSha256 !== evidence.hash
        || row.kernelTypeFingerprintMatches !== true) fail(`status residual terminal full-carrier bridge theorem evidence mismatch: ${name}`);
  }
  if (!(status.leanResidualTerminalFullBridgeFormalized === true
  ...
  const residualTerminalModeFirewallNames = Object.keys(RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREMS);
  if (!residualTerminalModeFirewallMilestone
      ...
      || residualTerminalModeFirewallMilestone.status !== "formalized-terminal-mode-firewall"
      ...
      || JSON.stringify(residualTerminalModeFirewallMilestone.requiredTheorems) !== JSON.stringify(residualTerminalModeFirewallNames)
      || residualTerminalModeFirewallMilestone.earned !== true
      || residualTerminalModeFirewallMilestone.allPresent !== true
      || residualTerminalModeFirewallMilestone.allAssumptionFree !== true
      || residualTerminalModeFirewallMilestone.axiomClosureUsesOnlyLeanStandardAllowlist !== true
      || residualTerminalModeFirewallMilestone.allKernelTypesMatch !== true
      || residualTerminalModeFirewallMilestone.sourceClosureFingerprintMatches !== true) fail("status residual terminal mode-firewall publication boundary mismatch");
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREMS)) {
    const row = residualTerminalModeFirewallMilestone?.theoremRows?.find((candidate) => candidate.name === name);
    if (!row || row.present !== true || row.kind !== "theorem"
        || JSON.stringify(row.axioms) !== JSON.stringify(evidence.axioms)
        || row.actualKernelTypeSha256 !== evidence.hash
        || row.expectedKernelTypeSha256 !== evidence.hash
        || row.kernelTypeFingerprintMatches !== true) fail(`status residual terminal mode-firewall theorem evidence mismatch: ${name}`);
  }
  if (!(status.leanResidualTerminalQuotientCarrierFormalized === true
  ...
  const residualTerminalProjectionMinimumNames = Object.keys(RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREMS);
  if (!residualTerminalProjectionMinimumMilestone
      ...
      || residualTerminalProjectionMinimumMilestone.status !== "formalized-terminal-projection-minimum"
      ...
      || JSON.stringify(residualTerminalProjectionMinimumMilestone.requiredTheorems) !== JSON.stringify(residualTerminalProjectionMinimumNames)
      || residualTerminalProjectionMinimumMilestone.earned !== true
      || residualTerminalProjectionMinimumMilestone.allPresent !== true
      || residualTerminalProjectionMinimumMilestone.allAssumptionFree !== false
      || residualTerminalProjectionMinimumMilestone.axiomClosureUsesOnlyLeanStandardAllowlist !== true
      || residualTerminalProjectionMinimumMilestone.allKernelTypesMatch !== true
      || residualTerminalProjectionMinimumMilestone.sourceClosureFingerprintMatches !== true) fail("status residual terminal projection-minimum publication boundary mismatch");
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREMS)) {
    const row = residualTerminalProjectionMinimumMilestone?.theoremRows?.find((candidate) => candidate.name === name);
    if (!row || row.present !== true || row.kind !== "theorem"
        || JSON.stringify(row.axioms) !== JSON.stringify(evidence.axioms)
        || row.actualKernelTypeSha256 !== evidence.hash
        || row.expectedKernelTypeSha256 !== evidence.hash
        || row.kernelTypeFingerprintMatches !== true) fail(`status residual terminal projection-minimum theorem evidence mismatch: ${name}`);
  }
  if (!(status.leanResidualProjectionMinimumFormalized === true
  ...
  const residualTerminalProjectionTransferNames = Object.keys(RESIDUAL_TERMINAL_PROJECTION_TRANSFER_THEOREMS);
  if (!residualTerminalProjectionTransferMilestone
      ...
      || residualTerminalProjectionTransferMilestone.status !== "formalized-terminal-projection-transfer"
      ...
      || JSON.stringify(residualTerminalProjectionTransferMilestone.requiredTheorems) !== JSON.stringify(residualTerminalProjectionTransferNames)
      || residualTerminalProjectionTransferMilestone.earned !== true
      || residualTerminalProjectionTransferMilestone.allPresent !== true
      || residualTerminalProjectionTransferMilestone.allAssumptionFree !== false
      || residualTerminalProjectionTransferMilestone.axiomClosureUsesOnlyLeanStandardAllowlist !== true
      || residualTerminalProjectionTransferMilestone.allKernelTypesMatch !== true
      || residualTerminalProjectionTransferMilestone.sourceClosureFingerprintMatches !== true) fail("status residual terminal projection-transfer publication boundary mismatch");
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_PROJECTION_TRANSFER_THEOREMS)) {
    const row = residualTerminalProjectionTransferMilestone?.theoremRows?.find((candidate) => candidate.name === name);
    if (!row || row.present !== true || row.kind !== "theorem"
        || JSON.stringify(row.axioms) !== JSON.stringify(evidence.axioms)
        || row.actualKernelTypeSha256 !== evidence.hash
        || row.expectedKernelTypeSha256 !== evidence.hash
        || row.kernelTypeFingerprintMatches !== true) fail(`status residual terminal projection-transfer theorem evidence mismatch: ${name}`);
  }
  if (!(status.leanResidualProjectionTransferFormalized === true
  ...
  const residualTerminalSaturationNames = Object.keys(RESIDUAL_TERMINAL_SATURATION_THEOREMS);
  if (!residualTerminalSaturationMilestone
      ...
      || residualTerminalSaturationMilestone.status !== "formalized-terminal-saturation-closure"
      ...
      || JSON.stringify(residualTerminalSaturationMilestone.requiredTheorems) !== JSON.stringify(residualTerminalSaturationNames)
      || residualTerminalSaturationMilestone.earned !== true
      || residualTerminalSaturationMilestone.allPresent !== true
      || residualTerminalSaturationMilestone.allAssumptionFree !== false
      || residualTerminalSaturationMilestone.axiomClosureUsesOnlyLeanStandardAllowlist !== true
      || residualTerminalSaturationMilestone.allKernelTypesMatch !== true
      || residualTerminalSaturationMilestone.sourceClosureFingerprintMatches !== true) fail("status residual terminal saturation publication boundary mismatch");
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_SATURATION_THEOREMS)) {
    const row = residualTerminalSaturationMilestone?.theoremRows?.find((candidate) => candidate.name === name);
    if (!row || row.present !== true || row.kind !== "theorem"
        || JSON.stringify(row.axioms) !== JSON.stringify(evidence.axioms)
        || row.actualKernelTypeSha256 !== evidence.hash
        || row.expectedKernelTypeSha256 !== evidence.hash
        || row.kernelTypeFingerprintMatches !== true) fail(`status residual terminal saturation theorem evidence mismatch: ${name}`);
  }
  if (!(status.leanResidualTerminalSaturationFormalized === true
      ...
      && status.leanPCCMinPolynomialRuntimeFormalized === false)) fail("status residual terminal saturation evidence mismatch");
...
function assertInventory(inventory) {
  ...
  if (inventory.coordinate !== "PNP-LEAN-THEOREM-INVENTORY-2026-08-04-101") fail("inventory coordinate mismatch");
  if (inventory.declarationCount !== 24054 || inventory.theoremCount !== 12985) fail("inventory declaration counts mismatch");
  if (inventory.assumptionFreeTheoremCount !== 6903 || inventory.excludedPrivateDeclarationCount !== 14317 || inventory.sourceClosureModuleCount !== 216 || inventory.axiomCount !== 4) fail("inventory theorem/module/axiom counts mismatch");
  if (JSON.stringify(inventory.declarationKindCounts) !== JSON.stringify({ axiom: 4, constructor: 673, definition: 9814, inductive: 289, opaque: 0, quotient: 0, recursor: 289, theorem: 12985 })) fail("inventory declaration-kind counts mismatch");
  ...
  for (const [name, evidence] of Object.entries(LOCKED_NAND_CARRIER_TRACE_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== "PNP.LockedNANDCarrierTrace" || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory locked-NAND carrier-trace theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory locked-NAND carrier-trace fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(LOCKED_NAND_GLOBAL_CANDIDATE_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== "PNP.LockedNANDGlobalCandidates" || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory locked-NAND global-candidate theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory locked-NAND global-candidate fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== "PNP.LockedNANDGlobalCandidates" || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory locked-NAND global BaselineDistinct theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory locked-NAND global BaselineDistinct fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(LOCKED_NAND_GLOBAL_UNSATISFIABLE_FINAL_ZERO_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== "PNP.LockedNANDGlobalUnsatisfiableFinalZero" || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory locked-NAND unsatisfiable final-zero theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory locked-NAND unsatisfiable final-zero fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory locked-NAND global semantic-threshold theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory locked-NAND global semantic-threshold fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory locked-NAND encoded semantic-reduction theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory locked-NAND encoded semantic-reduction fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(LOCKED_NAND_SOURCE_PARSER_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== evidence.module || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory locked-NAND source-parser theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory locked-NAND source-parser fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(LOCKED_NAND_TARGET_EMITTER_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== evidence.module || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory locked-NAND target-emitter theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory locked-NAND target-emitter fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(LOCKED_NAND_POLYNOMIAL_REDUCTION_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
  ...
  for (const [name, evidence] of Object.entries(CNF_TO_NAND_POLYNOMIAL_REDUCTION_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== evidence.module || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory CNF-to-NAND polynomial-reduction theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory CNF-to-NAND polynomial-reduction fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(RESIDUAL_GAIN_CHAIN_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
  ...
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_FULL_BRIDGE_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== evidence.module
        || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory residual terminal full-carrier bridge theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory residual terminal full-carrier bridge fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== evidence.module
        || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory residual terminal mode-firewall theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory residual terminal mode-firewall fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== evidence.module
        || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory residual terminal projection-minimum theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory residual terminal projection-minimum fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_PROJECTION_TRANSFER_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== evidence.module
        || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory residual terminal projection-transfer theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory residual terminal projection-transfer fingerprint mismatch: ${name}`);
  }
  for (const [name, evidence] of Object.entries(RESIDUAL_TERMINAL_SATURATION_THEOREMS)) {
    const theorem = inventory.milestoneCandidates?.find((candidate) => candidate.name === name);
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== evidence.module
        || JSON.stringify(theorem.axioms) !== JSON.stringify(evidence.axioms)) fail(`inventory residual terminal saturation theorem mismatch: ${name}`);
    if (milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== evidence.hash) fail(`inventory residual terminal saturation fingerprint mismatch: ${name}`);
  }
  ...
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_FIRST_LITERAL_THIRD_UNARY_UNIT_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-first-literal-third-unary-unit-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-first-literal-third-unary-unit-step fingerprint mismatch: ${name}`);
  }
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_FIRST_LITERAL_TERMINATOR_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-first-literal-terminator-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-first-literal-terminator-step fingerprint mismatch: ${name}`);
  }
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_FIRST_LITERAL_SUCCESSOR_TOKEN_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-first-literal-successor-token-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-first-literal-successor-token-step fingerprint mismatch: ${name}`);
  }
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-padding-or-unary-opportunity-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-padding-or-unary-opportunity-step fingerprint mismatch: ${name}`);
  }
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_SECOND_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-second-padding-or-unary-opportunity-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-second-padding-or-unary-opportunity-step fingerprint mismatch: ${name}`);
  }
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_THIRD_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-third-padding-or-unary-opportunity-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-third-padding-or-unary-opportunity-step fingerprint mismatch: ${name}`);
  }
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step fingerprint mismatch: ${name}`);
  }
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step fingerprint mismatch: ${name}`);
  }
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-sixth-padding-or-opening-unary-opportunity-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-sixth-padding-or-opening-unary-opportunity-step fingerprint mismatch: ${name}`);
  }
  for (const [name, row] of Object.entries(BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREMS)) {
    ...
    if (!theorem || theorem.kind !== "theorem" || theorem.module !== expectedModule || JSON.stringify(theorem.axioms) !== JSON.stringify(row.axioms)) fail(`inventory Cook-Levin builder second-constraint-seventh-padding-or-unary-opportunity-step theorem mismatch: ${name}`);
    if (theorem && milestoneTheoremKernelTypeSha256(name, theorem.kernelType) !== row.hash) fail(`inventory Cook-Levin builder second-constraint-seventh-padding-or-unary-opportunity-step fingerprint mismatch: ${name}`);
  }
  ...
  if (inventory.milestoneCandidates?.length !== 2152) fail("inventory reviewed theorem-candidate count mismatch");
}
...
function assertCurrentManifest(manifest) {
  ...
  if (manifest.coordinate !== "PNP-FORMAL-PUBLICATION-RELEASE-2026-08-04-84") fail("current formal-publication coordinate mismatch");
  ...
  if (manifest.source?.formalPublicationMapCoordinate !== "PNP-FORMAL-PUBLICATION-MAP-2026-08-04-101" || manifest.source?.formalPublicationMapSha256 !== "a86df7f8d45a5430bc1b7cc67dfac31e8663a9e81ed24abc0f25a2cd299b0b7c" || manifest.source?.leanSourceClosureSha256 !== "5cb2ae9d032d09c08f34424ccdf0b67452d75b8a933b60114c5267cc69385a7f") fail("current manifest publication-map identity mismatch");
  if (manifest.artifacts?.report?.pageCount !== 73) fail("current report must have seventy-three pages");
  ...
  if (JSON.stringify(earned.cookLevinBuilderSecondConstraintFirstLiteralTerminatorStepAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.cookLevinBuilderSecondConstraintFirstLiteralTerminatorStepProjectAxiomClosure) || earned.cookLevinBuilderSecondConstraintFirstLiteralTerminatorStepProjectAxiomClosure.length !== 0) fail("current manifest Cook-Levin builder second-constraint-first-literal-terminator-step axiom closure mismatch");
  ...
  if (!(earned.lockedNANDCarrierLayoutFormalized === true && earned.lockedNANDCarrierTraceAxiomAuditPassed === true && earned.lockedNANDCarrierTraceAuditedDeclarationCount === 71 && earned.lockedNANDCarrierTraceScope === "arbitrary-finite-topological-nand-circuits-carrier-separation-and-trace-equivalence")) fail("current manifest locked-NAND carrier-trace boundary mismatch");
  if (JSON.stringify(earned.lockedNANDCarrierTraceAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.lockedNANDCarrierTraceProjectAxiomClosure) || earned.lockedNANDCarrierTraceProjectAxiomClosure.length !== 0) fail("current manifest locked-NAND carrier-trace axiom closure mismatch");
  const lockedNANDCarrierTraceHashes = earned.lockedNANDCarrierTraceTheoremKernelTypeSha256;
  if (!lockedNANDCarrierTraceHashes || Object.keys(lockedNANDCarrierTraceHashes).length !== 8 || !Object.entries(LOCKED_NAND_CARRIER_TRACE_THEOREMS).every(([name, row]) => lockedNANDCarrierTraceHashes[name] === row.hash)) fail("current manifest locked-NAND carrier-trace fingerprint mismatch");
  if (!Object.entries(LOCKED_NAND_CARRIER_TRACE_RELEASE_IDENTITIES).every(([suffix, theorem]) => earned[`lockedNAND${suffix}`] === theorem)) fail("current manifest locked-NAND carrier-trace theorem identity mismatch");
  if (!(earned.lockedNANDGlobalCandidateAssemblyFormalized === true && earned.lockedNANDGlobalBaselineCandidateFormalized === true && earned.lockedNANDGlobalCandidateAxiomAuditPassed === true && earned.lockedNANDGlobalCandidateAuditedDeclarationCount === 71 && earned.lockedNANDGlobalCandidateScope === "arbitrary-finite-topological-nand-circuits-exact-baseline-and-four-gate-extension")) fail("current manifest locked-NAND global-candidate boundary mismatch");
  if (JSON.stringify(earned.lockedNANDGlobalCandidateAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.lockedNANDGlobalCandidateProjectAxiomClosure) || earned.lockedNANDGlobalCandidateProjectAxiomClosure.length !== 0) fail("current manifest locked-NAND global-candidate axiom closure mismatch");
  const lockedNANDGlobalCandidateHashes = earned.lockedNANDGlobalCandidateTheoremKernelTypeSha256;
  if (!lockedNANDGlobalCandidateHashes || Object.keys(lockedNANDGlobalCandidateHashes).length !== 11 || !Object.entries(LOCKED_NAND_GLOBAL_CANDIDATE_THEOREMS).every(([name, row]) => lockedNANDGlobalCandidateHashes[name] === row.hash)) fail("current manifest locked-NAND global-candidate fingerprint mismatch");
  if (!Object.entries(LOCKED_NAND_GLOBAL_CANDIDATE_RELEASE_IDENTITIES).every(([suffix, theorem]) => earned[`lockedNAND${suffix}`] === theorem)) fail("current manifest locked-NAND global-candidate theorem identity mismatch");
  if (!(earned.lockedNANDGlobalBaselineDistinctFormalized === true && earned.lockedNANDGlobalBaselineDistinctAxiomAuditPassed === true && earned.lockedNANDGlobalBaselineDistinctAuditedDeclarationCount === 5 && earned.lockedNANDGlobalBaselineDistinctScope === "arbitrary-finite-topological-nand-circuits-global-baseline-output-conditions-and-exact-reference-minimum")) fail("current manifest locked-NAND global BaselineDistinct boundary mismatch");
  if (JSON.stringify(earned.lockedNANDGlobalBaselineDistinctAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.lockedNANDGlobalBaselineDistinctProjectAxiomClosure) || earned.lockedNANDGlobalBaselineDistinctProjectAxiomClosure.length !== 0) fail("current manifest locked-NAND global BaselineDistinct axiom closure mismatch");
  const lockedNANDGlobalBaselineDistinctHashes = earned.lockedNANDGlobalBaselineDistinctTheoremKernelTypeSha256;
  if (!lockedNANDGlobalBaselineDistinctHashes || Object.keys(lockedNANDGlobalBaselineDistinctHashes).length !== 5 || !Object.entries(LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_THEOREMS).every(([name, row]) => lockedNANDGlobalBaselineDistinctHashes[name] === row.hash)) fail("current manifest locked-NAND global BaselineDistinct fingerprint mismatch");
  if (!Object.entries(LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_RELEASE_IDENTITIES).every(([suffix, theorem]) => earned[`lockedNAND${suffix}`] === theorem)) fail("current manifest locked-NAND global BaselineDistinct theorem identity mismatch");
  if (!(earned.lockedNANDUnsatisfiableFinalZeroFormalized === true && earned.lockedNANDUnsatisfiableFinalZeroAxiomAuditPassed === true && earned.lockedNANDUnsatisfiableFinalZeroAuditedDeclarationCount === 2 && earned.lockedNANDUnsatisfiableFinalZeroScope === "arbitrary-finite-topological-nand-circuits-whole-carrier-unsatisfiable-final-zero-and-exact-reference-minimum")) fail("current manifest locked-NAND unsatisfiable final-zero boundary mismatch");
  if (JSON.stringify(earned.lockedNANDUnsatisfiableFinalZeroAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.lockedNANDUnsatisfiableFinalZeroProjectAxiomClosure) || earned.lockedNANDUnsatisfiableFinalZeroProjectAxiomClosure.length !== 0) fail("current manifest locked-NAND unsatisfiable final-zero axiom closure mismatch");
  const lockedNANDGlobalUnsatisfiableFinalZeroHashes = earned.lockedNANDUnsatisfiableFinalZeroTheoremKernelTypeSha256;
  if (!lockedNANDGlobalUnsatisfiableFinalZeroHashes || Object.keys(lockedNANDGlobalUnsatisfiableFinalZeroHashes).length !== 2 || !Object.entries(LOCKED_NAND_GLOBAL_UNSATISFIABLE_FINAL_ZERO_THEOREMS).every(([name, row]) => lockedNANDGlobalUnsatisfiableFinalZeroHashes[name] === row.hash)) fail("current manifest locked-NAND unsatisfiable final-zero fingerprint mismatch");
  if (!Object.entries(LOCKED_NAND_GLOBAL_UNSATISFIABLE_FINAL_ZERO_RELEASE_IDENTITIES).every(([suffix, theorem]) => earned[`lockedNAND${suffix}`] === theorem)) fail("current manifest locked-NAND unsatisfiable final-zero theorem identity mismatch");
  if (!(earned.lockedNANDGlobalSemanticThresholdFormalized === true && earned.lockedNANDGlobalSemanticThresholdAxiomAuditPassed === true && earned.lockedNANDGlobalSemanticThresholdAuditedDeclarationCount === 8 && earned.lockedNANDGlobalSemanticThresholdScope === "arbitrary-finite-topological-nand-circuits-complete-six-field-premises-and-typed-semantic-threshold")) fail("current manifest locked-NAND global semantic-threshold boundary mismatch");
  if (JSON.stringify(earned.lockedNANDGlobalSemanticThresholdAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.lockedNANDGlobalSemanticThresholdProjectAxiomClosure) || earned.lockedNANDGlobalSemanticThresholdProjectAxiomClosure.length !== 0) fail("current manifest locked-NAND global semantic-threshold axiom closure mismatch");
  const lockedNANDGlobalSemanticThresholdHashes = earned.lockedNANDGlobalSemanticThresholdTheoremKernelTypeSha256;
  if (!lockedNANDGlobalSemanticThresholdHashes || Object.keys(lockedNANDGlobalSemanticThresholdHashes).length !== 8 || !Object.entries(LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_THEOREMS).every(([name, row]) => lockedNANDGlobalSemanticThresholdHashes[name] === row.hash)) fail("current manifest locked-NAND global semantic-threshold fingerprint mismatch");
  if (!Object.entries(LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_RELEASE_IDENTITIES).every(([suffix, theorem]) => earned[`lockedNAND${suffix}`] === theorem)) fail("current manifest locked-NAND global semantic-threshold theorem identity mismatch");
  if (!(earned.lockedNANDEncodedSemanticReductionFormalized === true && earned.lockedNANDEncodedSemanticReductionAxiomAuditPassed === true && earned.lockedNANDEncodedSemanticReductionAuditedDeclarationCount === 48 && earned.lockedNANDEncodedSemanticReductionScope === "strict-version-zero-codec-direct-normalization-semantics-complete-candidate-bytes-and-fail-closed-semantic-reduction" && earned.lockedNANDCanonicalEncodingFormalized === true && earned.lockedNANDCompleteCandidateCodecFormalized === true && earned.lockedNANDNormalizationSemanticsFormalized === true && earned.lockedNANDParserMachineFormalized === true && earned.lockedNANDEmitterMachineFormalized === true && earned.lockedNANDPolynomialReductionFormalized === true)) fail("current manifest locked-NAND encoded semantic-reduction boundary mismatch");
  if (JSON.stringify(earned.lockedNANDEncodedSemanticReductionAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.lockedNANDEncodedSemanticReductionProjectAxiomClosure) || earned.lockedNANDEncodedSemanticReductionProjectAxiomClosure.length !== 0) fail("current manifest locked-NAND encoded semantic-reduction axiom closure mismatch");
  const lockedNANDEncodedSemanticReductionHashes = earned.lockedNANDEncodedSemanticReductionTheoremKernelTypeSha256;
  if (!lockedNANDEncodedSemanticReductionHashes || Object.keys(lockedNANDEncodedSemanticReductionHashes).length !== 11 || !Object.entries(LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_THEOREMS).every(([name, row]) => lockedNANDEncodedSemanticReductionHashes[name] === row.hash)) fail("current manifest locked-NAND encoded semantic-reduction fingerprint mismatch");
  if (!Object.entries(LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_RELEASE_IDENTITIES).every(([suffix, theorem]) => earned[`lockedNAND${suffix}`] === theorem)) fail("current manifest locked-NAND encoded semantic-reduction theorem identity mismatch");
  if (!(earned.lockedNANDSourceParserFormalized === true
      ...
      && earned.lockedNANDSourceParserScope === LOCKED_NAND_SOURCE_PARSER_SCOPE
      ...
      && earned.lockedNANDSourceParserCompiledRawTimeBound === "6 * 4096 * (n + 1)^3"
      && earned.lockedNANDParserMachineFormalized === true
      && earned.lockedNANDEmitterMachineFormalized === true
      && earned.lockedNANDPolynomialReductionFormalized === true)) fail("current manifest locked-NAND source-parser boundary mismatch");
  if (JSON.stringify(earned.lockedNANDSourceParserAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.lockedNANDSourceParserProjectAxiomClosure) || earned.lockedNANDSourceParserProjectAxiomClosure.length !== 0) fail("current manifest locked-NAND source-parser axiom closure mismatch");
  const lockedNANDSourceParserHashes = earned.lockedNANDSourceParserTheoremKernelTypeSha256;
  if (!lockedNANDSourceParserHashes || Object.keys(lockedNANDSourceParserHashes).length !== 20 || !Object.entries(LOCKED_NAND_SOURCE_PARSER_THEOREMS).every(([name, row]) => lockedNANDSourceParserHashes[name] === row.hash)) fail("current manifest locked-NAND source-parser fingerprint mismatch");
  if (!Object.entries(LOCKED_NAND_SOURCE_PARSER_RELEASE_IDENTITIES).every(([suffix, theorem]) => earned[`lockedNANDSourceParser${suffix}`] === theorem)) fail("current manifest locked-NAND source-parser theorem identity mismatch");
  if (!(earned.lockedNANDTargetEmitterFormalized === true
      ...
      && earned.lockedNANDTargetEmitterScope === LOCKED_NAND_TARGET_EMITTER_SCOPE
      ...
      && earned.lockedNANDTargetEmitterOutputSizeBound === "4 * (409 * (n + 1) + (100 * (n + 1)) * (403 * (n + 1)) + (100 * (n + 1)) * (201 * (n + 1)))"
      && earned.lockedNANDEmitterMachineFormalized === true
      && earned.lockedNANDPolynomialReductionFormalized === true)) fail("current manifest locked-NAND target-emitter boundary mismatch");
  if (JSON.stringify(earned.lockedNANDTargetEmitterAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.lockedNANDTargetEmitterProjectAxiomClosure) || earned.lockedNANDTargetEmitterProjectAxiomClosure.length !== 0) fail("current manifest locked-NAND target-emitter axiom closure mismatch");
  const lockedNANDTargetEmitterHashes = earned.lockedNANDTargetEmitterTheoremKernelTypeSha256;
  if (!lockedNANDTargetEmitterHashes || Object.keys(lockedNANDTargetEmitterHashes).length !== 22 || !Object.entries(LOCKED_NAND_TARGET_EMITTER_THEOREMS).every(([name, row]) => lockedNANDTargetEmitterHashes[name] === row.hash)) fail("current manifest locked-NAND target-emitter fingerprint mismatch");
  if (!Object.entries(LOCKED_NAND_TARGET_EMITTER_RELEASE_IDENTITIES).every(([suffix, theorem]) => earned[`lockedNANDTargetEmitter${suffix}`] === theorem)) fail("current manifest locked-NAND target-emitter theorem identity mismatch");
  if (!(earned.lockedNANDPolynomialReductionFormalized === true
      ...
      && earned.lockedNANDPolynomialReductionScope === LOCKED_NAND_POLYNOMIAL_REDUCTION_SCOPE
      ...
      && earned.lockedNANDPolynomialReductionRawRefinementFormalized === true)) fail("current manifest locked-NAND polynomial-reduction boundary mismatch");
  if (JSON.stringify(earned.lockedNANDPolynomialReductionAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.lockedNANDPolynomialReductionProjectAxiomClosure) || earned.lockedNANDPolynomialReductionProjectAxiomClosure.length !== 0) fail("current manifest locked-NAND polynomial-reduction axiom closure mismatch");
  ...
  if (!(earned.cnfToNANDSemanticCompilerFormalized === true
      ...
      && earned.cnfToNANDPolynomialReductionFormalized === true)) fail("current manifest CNF-to-NAND semantic-compiler boundary mismatch");
  ...
  if (!(earned.cnfToNANDPolynomialReductionFormalized === true
      ...
      && earned.cnfToNANDLockedReductionCompositionFormalized === true)) fail("current manifest CNF-to-NAND polynomial-reduction boundary mismatch");
  if (JSON.stringify(earned.cnfToNANDPolynomialReductionAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"]) || !Array.isArray(earned.cnfToNANDPolynomialReductionProjectAxiomClosure) || earned.cnfToNANDPolynomialReductionProjectAxiomClosure.length !== 0) fail("current manifest CNF-to-NAND polynomial-reduction axiom closure mismatch");
  const cnfToNANDPolynomialReductionHashes = earned.cnfToNANDPolynomialReductionTheoremKernelTypeSha256;
  if (!cnfToNANDPolynomialReductionHashes || Object.keys(cnfToNANDPolynomialReductionHashes).length !== 28 || !Object.entries(CNF_TO_NAND_POLYNOMIAL_REDUCTION_THEOREMS).every(([name, row]) => cnfToNANDPolynomialReductionHashes[name] === row.hash)) fail("current manifest CNF-to-NAND polynomial-reduction fingerprint mismatch");
  if (!Object.entries(CNF_TO_NAND_POLYNOMIAL_REDUCTION_RELEASE_IDENTITIES).every(([suffix, theorem]) => earned[`cnfToNANDPolynomialReduction${suffix}`] === theorem)) fail("current manifest CNF-to-NAND polynomial-reduction theorem identity mismatch");
  if (!(earned.residualGainChainVerifierFormalized === true
      ...
      && earned.residualGainChainPolynomialRuntimeFormalized === false)) fail("current manifest residual-gain chain boundary mismatch");
  if (JSON.stringify(earned.residualGainChainAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"])
      ...
      || earned.residualGainChainProjectAxiomClosure.length !== 0) fail("current manifest residual-gain chain axiom closure mismatch");
  ...
  if (!(earned.residualTerminalFullBridgeFormalized === true
      && earned.residualTerminalFullBridgeAxiomAuditPassed === true
      && earned.residualTerminalFullBridgeAuditedDeclarationCount === 22
      && earned.residualTerminalFullBridgeEmptyAxiomDeclarationCount === 22
      && earned.residualTerminalizationExactFormalized === true
      && earned.residualTerminalFullMinimumSpecificationFormalized === true
      && earned.residualTerminalMuBridgeFormalized === true
      && earned.residualWholeSpanPositiveWitnessIffFormalized === true
      && earned.residualWholeSpanStrictDescentFormalized === true
  ...
  if (!Array.isArray(earned.residualTerminalFullBridgeAxiomClosure)
      ...
      || !Array.isArray(earned.residualTerminalFullBridgeProjectAxiomClosure)
      || earned.residualTerminalFullBridgeProjectAxiomClosure.length !== 0) fail("current manifest residual terminal full-carrier bridge axiom closure mismatch");
  const residualTerminalFullBridgeHashes = earned.residualTerminalFullBridgeTheoremKernelTypeSha256;
  if (!residualTerminalFullBridgeHashes || Object.keys(residualTerminalFullBridgeHashes).length !== 13
      || !Object.entries(RESIDUAL_TERMINAL_FULL_BRIDGE_THEOREMS).every(([name, row]) => residualTerminalFullBridgeHashes[name] === row.hash)) fail("current manifest residual terminal full-carrier bridge fingerprint mismatch");
  if (!Object.entries(RESIDUAL_TERMINAL_FULL_BRIDGE_RELEASE_IDENTITIES).every(([field, theorem]) => earned[field] === theorem)) fail("current manifest residual terminal full-carrier bridge theorem identity mismatch");
  if (!(earned.residualTerminalModeFirewallFormalized === true
      && earned.residualTerminalModeFirewallAxiomAuditPassed === true
      && earned.residualTerminalModeFirewallAuditedDeclarationCount === 29
      && earned.residualTerminalModeFirewallEmptyAxiomDeclarationCount === 29
      && earned.residualTerminalQuotientCarrierFormalized === true
      && earned.residualTerminalProfileProjectionExactFormalized === true
      && earned.residualTerminalCheckedFullLiftFormalized === true
  ...
  if (!Array.isArray(earned.residualTerminalModeFirewallAxiomClosure)
      ...
      || !Array.isArray(earned.residualTerminalModeFirewallProjectAxiomClosure)
      || earned.residualTerminalModeFirewallProjectAxiomClosure.length !== 0) fail("current manifest residual terminal mode-firewall axiom closure mismatch");
  const residualTerminalModeFirewallHashes = earned.residualTerminalModeFirewallTheoremKernelTypeSha256;
  if (!residualTerminalModeFirewallHashes || Object.keys(residualTerminalModeFirewallHashes).length !== 12
      || !Object.entries(RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREMS).every(([name, row]) => residualTerminalModeFirewallHashes[name] === row.hash)) fail("current manifest residual terminal mode-firewall fingerprint mismatch");
  if (!Object.entries(RESIDUAL_TERMINAL_MODE_FIREWALL_RELEASE_IDENTITIES).every(([field, theorem]) => earned[field] === theorem)) fail("current manifest residual terminal mode-firewall theorem identity mismatch");
  if (!(earned.residualProjectionMinimumFormalized === true
      && earned.residualProjectionMinimumAxiomAuditPassed === true
      && earned.residualProjectionMinimumAuditedDeclarationCount === 27
      && earned.residualProjectionMinimumEmptyAxiomDeclarationCount === 9
      && earned.residualProjectionMinimumPropextOnlyDeclarationCount === 18
      && earned.residualProjectionMinimumExecutableFullScanFormalized === true
      && earned.residualProjectionMinimumExecutableQuotientScanFormalized === true
      && earned.residualProjectionMinimumAttainmentFormalized === true
      && earned.residualProjectionMinimumUniversalLowerBoundsFormalized === true
      && earned.residualProjectionMinimumMonotonicityFormalized === true
  ...
  if (JSON.stringify(earned.residualProjectionMinimumAxiomClosure) !== JSON.stringify(["propext"])
      ...
      || earned.residualProjectionMinimumProjectAxiomClosure.length !== 0) fail("current manifest residual terminal projection-minimum axiom closure mismatch");
  const residualTerminalProjectionMinimumHashes = earned.residualProjectionMinimumTheoremKernelTypeSha256;
  if (!residualTerminalProjectionMinimumHashes || Object.keys(residualTerminalProjectionMinimumHashes).length !== 14
      || !Object.entries(RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREMS).every(([name, row]) => residualTerminalProjectionMinimumHashes[name] === row.hash)) fail("current manifest residual terminal projection-minimum fingerprint mismatch");
  if (!Object.entries(RESIDUAL_TERMINAL_PROJECTION_MINIMUM_RELEASE_IDENTITIES).every(([field, theorem]) => earned[field] === theorem)) fail("current manifest residual terminal projection-minimum theorem identity mismatch");
  if (!(earned.residualProjectionTransferFormalized === true
      && earned.residualProjectionTransferAxiomAuditPassed === true
      && earned.residualProjectionTransferSignedDeltasFormalized === true
  ...
  if (JSON.stringify(earned.residualProjectionTransferAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"])
      ...
      || earned.residualProjectionTransferProjectAxiomClosure.length !== 0) fail("current manifest residual terminal projection-transfer axiom closure mismatch");
  const residualTerminalProjectionTransferHashes = earned.residualProjectionTransferTheoremKernelTypeSha256;
  if (!residualTerminalProjectionTransferHashes || Object.keys(residualTerminalProjectionTransferHashes).length !== 4
      || !Object.entries(RESIDUAL_TERMINAL_PROJECTION_TRANSFER_THEOREMS).every(([name, row]) => residualTerminalProjectionTransferHashes[name] === row.hash)) fail("current manifest residual terminal projection-transfer fingerprint mismatch");
  if (!(earned.residualTerminalSaturationFormalized === true
      && earned.residualTerminalSaturationAxiomAuditPassed === true
      && earned.residualTerminalSaturationAuditedDeclarationCount === 18
      && earned.residualTerminalSaturationEmptyAxiomDeclarationCount === 15
      && earned.residualTerminalSaturationPropextQuotSoundDeclarationCount === 3
      && earned.residualTerminalPrimitiveUniverseFormalized === true
      && earned.residualTerminalSaturationExtensiveFormalized === true
      && earned.residualTerminalSaturationLeastFormalized === true
      ...
      && earned.pccMinPolynomialRuntimeFormalized === false)) fail("current manifest residual terminal saturation boundary mismatch");
  if (JSON.stringify(earned.residualTerminalSaturationAxiomClosure) !== JSON.stringify(["Quot.sound", "propext"])
      || !Array.isArray(earned.residualTerminalSaturationProjectAxiomClosure)
      || earned.residualTerminalSaturationProjectAxiomClosure.length !== 0) fail("current manifest residual terminal saturation axiom closure mismatch");
  const residualTerminalSaturationHashes = earned.residualTerminalSaturationTheoremKernelTypeSha256;
  if (!residualTerminalSaturationHashes || Object.keys(residualTerminalSaturationHashes).length !== 7
      || !Object.entries(RESIDUAL_TERMINAL_SATURATION_THEOREMS).every(([name, row]) => residualTerminalSaturationHashes[name] === row.hash)) fail("current manifest residual terminal saturation fingerprint mismatch");
  if (!Object.entries(RESIDUAL_TERMINAL_SATURATION_RELEASE_IDENTITIES).every(([field, theorem]) => earned[field] === theorem)) fail("current manifest residual terminal saturation theorem identity mismatch");
...
export function verifyReleaseSeal(options = {}) {
  ...
  if (seal.current_publication_coordinate !== "PNP-FORMAL-PUBLICATION-RELEASE-2026-08-04-84") fail("release seal publication coordinate mismatch");
