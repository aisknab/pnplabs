...
const CORE_COMMIT = "a23dd28052c4bbeee281ed0ce691ef7350ef2215";
const CORE_TREE = "bceb595ee6783770a47270ada6c492a627b4f26a";
const PROOF_COMMIT = "ae61c50516a57065e650499c008f637d210d7bdb";
...
const EXPECTED_FILES = [
  {
    ...
    bytes: 299464,
    sha256: "8e61812c7f4e74a31190c3ffd765a4615f66ddcf05166b9efd1f1d3fa7c13e93",
    role: "current inventory-derived twenty-page formal-reconstruction report PDF"
  },
  {
  ...
  },
  {
    ...
    bytes: 42402,
    sha256: "32d8782bb3e533a59028285cf494236e05673686fd9d5bac20e08a1a1f0afdb0",
  ...
  },
  {
    ...
    bytes: 336490,
    sha256: "5245733ecba4f5b18a8bf782281b8076c55e5807b77d56f1db6d1848bf737d64",
    role: "exact current core formal-reconstruction status mirror"
  },
  {
    path: "public/pnp-theorem-inventory.json",
    bytes: 2621754,
    sha256: "c8b62ac6d6119dba556db6cf31aacb6a5ab3b55f7a4d7c4f9fe83a305c72bb41",
    role: "exact current compiled Lean theorem inventory mirror"
  },
  {
    path: "downloads/formal-publication-release.json",
    bytes: 65372,
    sha256: "ad89b4ddc6152f0710f8cc5e047db7a56beb2bb471d13e02cdd1509bef21f9e7",
...
function assertFailClosedStatus(status) {
  ...
  if (status.coordinate !== "PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-17-48") fail("status coordinate mismatch");
  if (status.publicSurfaceBaselineCoordinate !== "PUBLIC-SURFACE-BASELINE-2026-07-17-COOK-LEVIN-BUILDER-BODY-START-PREFIX-47") fail("status public-surface coordinate mismatch");
  if (status.formalPublicationMapCoordinate !== "PNP-FORMAL-PUBLICATION-MAP-2026-07-17-48" || status.formalPublicationMapSha256 !== "4d8a4fd0d23a9232a8cd07b55e995510ad32f25b2327de8b008c9b47e7c6b03f" || status.leanSourceClosureSha256 !== "17d3594b778d9e9c6f82d9111673378913a279229fb1b8fc21079e8f3052098c") fail("status source identity mismatch");
...
function assertInventory(inventory) {
  ...
  if (inventory.coordinate !== "PNP-LEAN-THEOREM-INVENTORY-2026-07-17-48") fail("inventory coordinate mismatch");
  if (inventory.declarationCount !== 7500 || inventory.theoremCount !== 3536) fail("inventory declaration counts mismatch");
  if (inventory.assumptionFreeTheoremCount !== 2795 || inventory.excludedPrivateDeclarationCount !== 2124 || inventory.sourceClosureModuleCount !== 68 || inventory.axiomCount !== 4) fail("inventory theorem/module/axiom counts mismatch");
  ...
  if (inventory.milestoneCandidates?.length !== 454) fail("inventory reviewed theorem-candidate count mismatch");
}
...
function assertCurrentManifest(manifest) {
  ...
  if (manifest.coordinate !== "PNP-FORMAL-PUBLICATION-RELEASE-2026-07-17-31") fail("current formal-publication coordinate mismatch");
  ...
  if (manifest.source?.formalPublicationMapCoordinate !== "PNP-FORMAL-PUBLICATION-MAP-2026-07-17-48" || manifest.source?.formalPublicationMapSha256 !== "4d8a4fd0d23a9232a8cd07b55e995510ad32f25b2327de8b008c9b47e7c6b03f" || manifest.source?.leanSourceClosureSha256 !== "17d3594b778d9e9c6f82d9111673378913a279229fb1b8fc21079e8f3052098c") fail("current manifest publication-map identity mismatch");
  if (manifest.artifacts?.report?.pageCount !== 20) fail("current report must have twenty pages");
  ...
  if (!bodyStartHashes || Object.keys(bodyStartHashes).length !== 40 || !Object.entries(BUILDER_BODY_START_PREFIX_THEOREMS).every(([name, evidence]) => bodyStartHashes[name] === evidence.hash)) fail("current manifest Cook-Levin builder body-start-prefix fingerprint mismatch");
...
export function verifyReleaseSeal(options = {}) {
  ...
  if (seal.current_publication_coordinate !== "PNP-FORMAL-PUBLICATION-RELEASE-2026-07-17-31") fail("release seal publication coordinate mismatch");
