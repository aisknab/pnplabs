...
const REVIEWED_CORE_COMMIT = "650dbecaa067ff71b996d26d13315da9dd2cdcc9";
const REVIEWED_CORE_TREE = "94cb12d3bddb453b9e78d9ea8bfa2583c39643a0";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 59) failures.push("formal-publication report must have exactly fifty-nine pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 11565 || inventory.theoremCount !== 6685 || inventory.assumptionFreeTheoremCount !== 3528 || inventory.excludedPrivateDeclarationCount !== 4432 || inventory.sourceClosureModuleCount !== 101 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 1874) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
