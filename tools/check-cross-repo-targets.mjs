...
const REVIEWED_CORE_COMMIT = "bb51e4a9a502f41c360c995946025ef09e9afa97";
const REVIEWED_CORE_TREE = "cfc53f876c30d7a79ed3ffaf67673ce3c8cf8327";
const REVIEWED_PROOF_COMMIT = "251e3c5ac04b93545b0dd8510c1eec51d854858d";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 26) failures.push("formal-publication report must have exactly twenty-six pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 8006 || inventory.theoremCount !== 3903 || inventory.assumptionFreeTheoremCount !== 2921 || inventory.excludedPrivateDeclarationCount !== 2444 || inventory.sourceClosureModuleCount !== 72 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 633) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
