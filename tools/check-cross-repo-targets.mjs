...
const REVIEWED_CORE_COMMIT = "2079ea0df337d413c2402a3820087aea4aca9efa";
const REVIEWED_CORE_TREE = "60b3b6663d381c5e95029cc20c66ab31928e784c";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 50) failures.push("formal-publication report must have exactly fifty pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 10587 || inventory.theoremCount !== 5920 || inventory.assumptionFreeTheoremCount !== 3344 || inventory.excludedPrivateDeclarationCount !== 4043 || inventory.sourceClosureModuleCount !== 93 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 1581) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
