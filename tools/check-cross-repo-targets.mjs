...
const REVIEWED_CORE_COMMIT = "655d767f486a8ef64ee841b24ba853c4e0414658";
const REVIEWED_CORE_TREE = "a177eac640ef51557208b131b313ec0ff1c703d7";
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 11811 || inventory.theoremCount !== 6873 || inventory.assumptionFreeTheoremCount !== 3574 || inventory.excludedPrivateDeclarationCount !== 4511 || inventory.sourceClosureModuleCount !== 103 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 1944) {
      failures.push(`public inventory reviewed theorem-candidate count mismatch: found ${inventory.milestoneCandidates?.length ?? "missing"}, expected 1944`);
    }
  }
}
