...
const REVIEWED_CORE_COMMIT = "8ac394c0fb19fbaabec883a498a1ad35d730b77f";
const REVIEWED_CORE_TREE = "9dacf36b058e09470f4790536d37b0480916df8c";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 46) failures.push("formal-publication report must have exactly forty-six pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 10300 || inventory.theoremCount !== 5678 || inventory.assumptionFreeTheoremCount !== 3306 || inventory.excludedPrivateDeclarationCount !== 3828 || inventory.sourceClosureModuleCount !== 90 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 1479) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
