...
const REVIEWED_CORE_COMMIT = "8a4645c90af934b3a54396aea810cc9d6d944724";
const REVIEWED_CORE_TREE = "ae5343c32e0625b6939f438aafde790059ca1d77";
const REVIEWED_PROOF_COMMIT = "fa38349f8d6168cde7f20ca819d98054383a890d";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 25) failures.push("formal-publication report must have exactly twenty-five pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 7845 || inventory.theoremCount !== 3788 || inventory.assumptionFreeTheoremCount !== 2886 || inventory.excludedPrivateDeclarationCount !== 2380 || inventory.sourceClosureModuleCount !== 71 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 585) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
