...
const REVIEWED_CORE_COMMIT = "151e25f791def55a7855b20bd805cfb088c4d853";
const REVIEWED_CORE_TREE = "b0194b3f98c24acc1b2b75b59edf5c69e1697b40";
const REVIEWED_PROOF_COMMIT = "54ae0f9d9ef7ede310b2a761832c1c404a913f51";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 30) failures.push("formal-publication report must have exactly thirty pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 8473 || inventory.theoremCount !== 4267 || inventory.assumptionFreeTheoremCount !== 3013 || inventory.excludedPrivateDeclarationCount !== 2779 || inventory.sourceClosureModuleCount !== 76 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 841) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
