...
const REVIEWED_CORE_COMMIT = "9d2bff977cfc3ad5dbea9da60d46448276eea2cd";
const REVIEWED_CORE_TREE = "a48617d1fe7298677563b063d5a36184fb33d952";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 56) failures.push("formal-publication report must have exactly fifty-six pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 11178 || inventory.theoremCount !== 6388 || inventory.assumptionFreeTheoremCount !== 3451 || inventory.excludedPrivateDeclarationCount !== 4308 || inventory.sourceClosureModuleCount !== 98 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 1764) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
