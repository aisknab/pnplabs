...
const REVIEWED_CORE_COMMIT = "977748fa95202c86cf1235e7336e76d908a11eb1";
const REVIEWED_CORE_TREE = "8d207f7c12f36dc22fae6c010ea2dad62643ec31";
const REVIEWED_PROOF_COMMIT = "8022034756e0f6b95e5fabd1d98868538019cb61";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 21) failures.push("formal-publication report must have exactly twenty-one pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 7626 || inventory.theoremCount !== 3640 || inventory.assumptionFreeTheoremCount !== 2827 || inventory.excludedPrivateDeclarationCount !== 2214 || inventory.sourceClosureModuleCount !== 69 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 508) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
