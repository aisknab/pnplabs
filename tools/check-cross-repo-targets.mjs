...
const REVIEWED_CORE_COMMIT = "a524162f6db2a18961ea33b9470c45ae9bc98d99";
const REVIEWED_CORE_TREE = "65da52d3f1ddc9470612e89db99308f99b436089";
const REVIEWED_PROOF_COMMIT = "06a8c2dd448a3df97a90f6ece5a0fd4abf4dd359";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 27) failures.push("formal-publication report must have exactly twenty-seven pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 8094 || inventory.theoremCount !== 3974 || inventory.assumptionFreeTheoremCount !== 2939 || inventory.excludedPrivateDeclarationCount !== 2502 || inventory.sourceClosureModuleCount !== 73 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 673) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
