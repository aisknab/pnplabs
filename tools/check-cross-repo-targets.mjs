...
const REVIEWED_CORE_COMMIT = "59d89b6b07ae16e649cda19dfeb3c78b335397ea";
const REVIEWED_CORE_TREE = "f62c8553fc98e4cb0aba8174193264da027c1d55";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 60) failures.push("formal-publication report must have exactly sixty pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 11688 || inventory.theoremCount !== 6779 || inventory.assumptionFreeTheoremCount !== 3551 || inventory.excludedPrivateDeclarationCount !== 4464 || inventory.sourceClosureModuleCount !== 102 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
