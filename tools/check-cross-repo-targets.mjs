...
const REVIEWED_CORE_COMMIT = "fdc5e2f7e58e11dd0cd834378e05a9be0492573c";
const REVIEWED_CORE_TREE = "c13f132f69af662f9e867be611ae381050c36086";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 58) failures.push("formal-publication report must have exactly fifty-eight pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 11424 || inventory.theoremCount !== 6576 || inventory.assumptionFreeTheoremCount !== 3497 || inventory.excludedPrivateDeclarationCount !== 4379 || inventory.sourceClosureModuleCount !== 100 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 1834) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
