...
const REVIEWED_CORE_COMMIT = "bcabe7b58b7d72e738471f036f1c44b905b949eb";
const REVIEWED_CORE_TREE = "a7dfb2b64f2a3659f66b7ab691800ba33dd0d7b6";
const REVIEWED_PROOF_COMMIT = "0155aa99c1e89fbcce0d2635bc28fea4da225890";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 28) failures.push("formal-publication report must have exactly twenty-eight pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 8229 || inventory.theoremCount !== 4080 || inventory.assumptionFreeTheoremCount !== 2964 || inventory.excludedPrivateDeclarationCount !== 2585 || inventory.sourceClosureModuleCount !== 74 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 729) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
