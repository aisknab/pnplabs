...
const REVIEWED_CORE_COMMIT = "cf0220e7e73b13b5b2639c3b6b0ec1b170090ecf";
const REVIEWED_CORE_TREE = "371c1e78025328a752e1f146bddd7ad52e370f7a";
...
function validateReleaseManifest(manifest, expectedIdentity, failures) {
  ...
  if (manifest.artifacts?.report?.pageCount !== 57) failures.push("formal-publication report must have exactly fifty-seven pages");
...
function validateCurrentPayloads(contents, failures) {
  ...
  if (inventoryBuffer) {
    ...
    if (inventory.declarationCount !== 11301 || inventory.theoremCount !== 6482 || inventory.assumptionFreeTheoremCount !== 3474 || inventory.excludedPrivateDeclarationCount !== 4349 || inventory.sourceClosureModuleCount !== 99 || inventory.axiomCount !== 4) failures.push("public inventory count boundary mismatch");
    ...
    if (inventory.milestoneCandidates?.length !== 1799) failures.push("public inventory reviewed theorem-candidate count mismatch");
  }
}
