...
function assertPinnedCore(sourceDir) {
  ...
  if (sha256(map) !== "daddcdf827fd1b1643995ddbd8b2e449a1608a2e6f73444f3b945a78b5ad6f40") {
  ...
  if (publicationMap.coordinate !== "PNP-FORMAL-PUBLICATION-MAP-2026-07-19-58"
      || publicationMap.milestoneSourceClosureSha256 !== "c34dec0242ed84b5f915166a55ee1183dd0450cee9445b8dd0a8721c765facaf"
...
function checkPdfPageCount(pdfPath) {
  ...
  if (!match || Number(match[1]) !== 33) fail(`${pdfPath}: expected exactly thirty-three pages`);
}
...
function assertCorePayloadBoundary(sourcePath, buffer) {
  ...
  if (sourcePath === "public/pnp-status.json") {
    if (payload.coordinate !== "PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-19-58" || payload.publicSurfaceBaselineCoordinate !== "PUBLIC-SURFACE-BASELINE-2026-07-19-COOK-LEVIN-BUILDER-THIRD-CLAUSE-SEPARATOR-STEP-57") fail("core status coordinate mismatch");
    if (payload.formalPublicationMapCoordinate !== "PNP-FORMAL-PUBLICATION-MAP-2026-07-19-58" || payload.formalPublicationMapSha256 !== "daddcdf827fd1b1643995ddbd8b2e449a1608a2e6f73444f3b945a78b5ad6f40" || payload.leanSourceClosureSha256 !== "c34dec0242ed84b5f915166a55ee1183dd0450cee9445b8dd0a8721c765facaf") fail("core status source identity mismatch");
    ...
    if (payload.coordinate !== "PNP-LEAN-THEOREM-INVENTORY-2026-07-19-58") fail("core inventory coordinate mismatch");
    ...
    if (payload.declarationCount !== 8680 || payload.theoremCount !== 4425 || payload.assumptionFreeTheoremCount !== 3043 || payload.excludedPrivateDeclarationCount !== 2892 || payload.sourceClosureModuleCount !== 78 || payload.axiomCount !== 4 || payload.milestoneCandidates?.length !== 912) fail("core inventory counts mismatch");
    ...
    if (payload.milestoneCandidates?.length !== 912) fail("core inventory reviewed theorem-candidate count mismatch");
  }
}
