...
function assertPinnedCore(sourceDir) {
  ...
  if (sha256(map) !== "fc092da4d96c4856d7fd081e8e726c2e46e41c6492aebccc785427ad0c221b08") {
  ...
  if (publicationMap.coordinate !== "PNP-FORMAL-PUBLICATION-MAP-2026-07-19-59"
      || publicationMap.milestoneSourceClosureSha256 !== "49d0e1f95d163c3ae68ba9e8e8234bf8af77f67e7f692b41f292dfceba3a0eb3"
...
function checkPdfPageCount(pdfPath) {
  ...
  if (!match || Number(match[1]) !== 34) fail(`${pdfPath}: expected exactly thirty-four pages`);
}
...
function assertCorePayloadBoundary(sourcePath, buffer) {
  ...
  if (sourcePath === "public/pnp-status.json") {
    if (payload.coordinate !== "PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-19-59" || payload.publicSurfaceBaselineCoordinate !== "PUBLIC-SURFACE-BASELINE-2026-07-19-COOK-LEVIN-BUILDER-THIRD-CLAUSE-FIRST-LITERAL-PREFIX-58") fail("core status coordinate mismatch");
    if (payload.formalPublicationMapCoordinate !== "PNP-FORMAL-PUBLICATION-MAP-2026-07-19-59" || payload.formalPublicationMapSha256 !== "fc092da4d96c4856d7fd081e8e726c2e46e41c6492aebccc785427ad0c221b08" || payload.leanSourceClosureSha256 !== "49d0e1f95d163c3ae68ba9e8e8234bf8af77f67e7f692b41f292dfceba3a0eb3") fail("core status source identity mismatch");
    ...
    if (payload.coordinate !== "PNP-LEAN-THEOREM-INVENTORY-2026-07-19-59") fail("core inventory coordinate mismatch");
    ...
    if (payload.declarationCount !== 8811 || payload.theoremCount !== 4530 || payload.assumptionFreeTheoremCount !== 3062 || payload.excludedPrivateDeclarationCount !== 2974 || payload.sourceClosureModuleCount !== 79 || payload.axiomCount !== 4 || payload.milestoneCandidates?.length !== 960) fail("core inventory counts mismatch");
    ...
    if (payload.milestoneCandidates?.length !== 960) fail("core inventory reviewed theorem-candidate count mismatch");
  }
}
