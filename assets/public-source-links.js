...
const currentCommit = '9a01a9aee903b0d76132e80d40eed9004dc4eae1';
...
if (page === 'faq.html') {
  ...
  if (list && !document.querySelector('#historical-report-faq')) {
    ...
    details.innerHTML = `<summary>Where is the historical 57-page manuscript?</summary><p>It remains at source tag <a href="${historicalSource}"><code>${historicalTag}</code></a>, commit <code>${historicalCommit}</code>, with provenance in <a href="${historicalArchive}"><code>archive/legacy-v0/ARCHIVE.json</code></a>. It is audit material and never current theorem authority.</p>`;
    list.append(details);
  }
}
