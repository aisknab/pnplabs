...
const STATUS_COORDINATE = "PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-22-179";
const STATUS_SHA256 = 'dd16963d04598adffca270f6bce64a08a3dab24aaa2bfb02904d1e2c6e69bc0f';
const FORMAL_PUBLICATION_MAP_COORDINATE = "PNP-FORMAL-PUBLICATION-MAP-2026-08-22-179";
const FORMAL_PUBLICATION_MAP_SHA256 = "7fd81bc4bb3dac467f202a97141b6b74e3b97552b24702374e5d15dae4b65ba4";
const PUBLIC_SURFACE_COORDINATE = 'PUBLIC-SURFACE-BASELINE-2026-08-10-CONCRETE-LOCKED-NAND-THRESHOLD-121';
const INVENTORY_COORDINATE = "PNP-LEAN-THEOREM-INVENTORY-2026-08-22-179";
const INVENTORY_SHA256 = "4089caf6cb75eadfee204781c052d7118ac3a7948a2c64a9c2df83561abad308";
const SOURCE_CLOSURE_SHA256 = "3f746125b6e29864fa87312026c2a5e5422e3c850b76b8cfdc72b8c96a044079";
...
const RESIDUAL_TERMINAL_PACKET_SEMANTIC_HN_ACTIVITY_BINDING_DECLARATIONS = Object.freeze([
  ["PNP.DirectWire.TerminalPacketTypedRealizerTable.checkPacketSemanticHNActivityBinding_eq_true_iff",["Quot.sound","propext"],"PNP.ResidualTerminalPacketSemanticHNActivityBinding","d0c5415add270e972a377a7c8729fcd9a6df7692f1f9b39e5bc5009d223415c2"],
  ["PNP.DirectWire.TerminalPacketTypedRealizerTable.packetSemanticFieldsAgree_of_checkedHNActivityBinding",["Quot.sound","propext"],"PNP.ResidualTerminalPacketSemanticHNActivityBinding","6b0f5f837cec199fa603493791dc88e2f3abddda853113cd513a0677868129f5"],
  ["PNP.DirectWire.TerminalPacketTypedRealizerTable.packetSelectorSemanticFirstRoutes_ne_of_checkedHNActivityBinding",["Quot.sound","propext"],"PNP.ResidualTerminalPacketSemanticHNActivityBinding","523bccc3a2d4345f67e878f6a91b783d702c8e43b6b06642997952390374c0a9"],
  ["PNP.DirectWire.TerminalBN6PacketConclusion.existsSemanticHNBudgetBoundDescentFailure_of_selectorSilence",["Quot.sound","propext"],"PNP.ResidualTerminalPacketSemanticHNActivityBinding","2d0d295b380d37ddb5d6a6a8e6114480e456c43721c513bcd7998baaf412a8c5"],
  ["PNP.DirectWire.terminalBN6_packet_semantic_hn_activity_bound_descent_failure",["Quot.sound","propext"],"PNP.ResidualTerminalPacketSemanticHNActivityBinding","c58d517ad2209fa46b2a86f22099ff388b47bf965de9145a8c6a1e652f05b6af"],
]);
const RESIDUAL_TERMINAL_PACKET_DESCENT_NO_LOWER_BINDING_DECLARATIONS = Object.freeze([
  ["PNP.DirectWire.TerminalBN6GroupedFamily.checkPacketDescentNoLower_eq_true_iff",["Quot.sound","propext"],"PNP.ResidualTerminalPacketDescentNoLowerBinding","33307742fc9844bddbdf9a828ac9f2946b29d0aaf5aa0294efa083b5575855e3"],
  ["PNP.DirectWire.TerminalBN6PacketConclusion.checkPacketDescentNoLower_eq_false_of_selectorSilence",["Quot.sound","propext"],"PNP.ResidualTerminalPacketDescentNoLowerBinding","2652da58ccbfd2978e2c7779636b6e93c0a03853bf96870c4e51b6aad73e0ba0"],
  ["PNP.DirectWire.TerminalBN6PacketConclusion.false_of_checkedPacketDescentNoLower_and_selectorSilence",["Quot.sound","propext"],"PNP.ResidualTerminalPacketDescentNoLowerBinding","d235dacd3be3be6e5a568614dfe14bcdf9ffcabed2fe7f5e4e6aa603af671e9e"],
  ["PNP.DirectWire.terminalBN6_packet_descent_no_lower_rejected",["Quot.sound","propext"],"PNP.ResidualTerminalPacketDescentNoLowerBinding","4c8a1a5f2a0d27e55df9144a40ba608421b7c7f41271ad683a2ef603821a8cda"],
]);
const RESIDUAL_TERMINAL_PACKET_NO_LOWER_LEDGER_DECLARATIONS = Object.freeze([
  ["PNP.DirectWire.TerminalPacketTypedRealizerTable.checkPacketNoLowerLedger_eq_true_iff",["propext"],"PNP.ResidualTerminalPacketNoLowerLedger","4933640232598ca15f5e59a1e44afc61cb3d0464b99acb85817b10a942756e0f"],
  ["PNP.DirectWire.TerminalBN6PacketConclusion.checkPacketNoLowerLedger_eq_false",["Quot.sound","propext"],"PNP.ResidualTerminalPacketNoLowerLedger","0823247a05acf3b9e710e938e5443fb4e0c600c5e73957a2e7c0bfb580a17d99"],
  ["PNP.DirectWire.TerminalPacketTypedRealizerTable.not_packetConclusion_of_checkedPacketNoLowerLedger",["Quot.sound","propext"],"PNP.ResidualTerminalPacketNoLowerLedger","fafceb9656698473415a9221ca9a36c63021be6f3d09f370dc73b63fc5d94615"],
  ["PNP.DirectWire.terminalBN6_packet_no_lower_ledger_excludes_positive_packet",["Quot.sound","propext"],"PNP.ResidualTerminalPacketNoLowerLedger","67c93587e524fb98ecefa2f653fe2d398ffc283a17756d7d68e4dbfa78fa35a9"],
]);
const RESIDUAL_TERMINAL_HRESOLVE_COVERAGE_LEDGER_DECLARATIONS = Object.freeze([
  ["PNP.DirectWire.terminalHResolveClassify_eq_exact_iff",["propext"],"PNP.ResidualTerminalHResolveCoverageLedger","fbf117b9fe425a364742a0f9310f056ed81326485a140a3c3315208ebc31bfa4"],
  ["PNP.DirectWire.terminalHResolveClassify_eq_gain_iff",["propext"],"PNP.ResidualTerminalHResolveCoverageLedger","8d280c65ea8eefb7c9592a9674aa34d8f565575e571b7d22527b539c422d5ffb"],
  ["PNP.DirectWire.terminalHResolveClassify_eq_blocked_iff",["propext"],"PNP.ResidualTerminalHResolveCoverageLedger","a09c47ec9b07293b759d3c2f1d6a955df0a479b3b3bc8022086e72e8438a1e9d"],
  ["PNP.DirectWire.terminalHResolveClassify_eq_unresolved_iff",["propext"],"PNP.ResidualTerminalHResolveCoverageLedger","754f7099a176615266cc3309566ad843290e0fc1dfebcb5d1c09e22250512a81"],
  ["PNP.DirectWire.TerminalHResolveFamily.routeLedger_sound",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCoverageLedger","ef104717e64db666abafa383155d81596a7d1f508badfc3dfb4563bef8fc3727"],
  ["PNP.DirectWire.TerminalHResolveFamily.routeLedger_complete",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCoverageLedger","6a40d0d984d3e418278030815c4db34591f1414785c9d38d2e8e7155754ed34a"],
  ["PNP.DirectWire.TerminalHResolveFamily.checkNoHereditarySidecar_eq_true_iff",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCoverageLedger","a3bd27b58349e7e0d0a8bca62885d788e48f0959ef0687f266fe4466ce126f2d"],
  ["PNP.DirectWire.TerminalHResolveFamily.not_exact_of_checkedNoHereditarySidecar",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCoverageLedger","6e921a877da8b723eb0e03d698f3f4c1226a518c7a5aae98291dd686ebf5f624"],
  ["PNP.DirectWire.TerminalHResolveFamily.not_gain_of_checkedNoHereditarySidecar",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCoverageLedger","0ee82be4fa054e56a77c1b36e446b12188a0d3753cbb65f80a8a84023b4d5510"],
  ["PNP.DirectWire.terminal_hresolve_checked_sidecar_excludes_constructive_routes",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCoverageLedger","34a58ece01f76e5c93c809d514db65e2d09b3114c474d9a6385cea7d2ba35fa8"],
]);
const RESIDUAL_TERMINAL_HRESOLVE_SUPPORT_RESOLVER_DECLARATIONS = Object.freeze([
  ["PNP.DirectWire.terminalListSubsets_nodup",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveSupportResolver","20b2a4997693c2992627f3bd6bbac935529209ff80172a7e72c89822993ef3fa"],
  ["PNP.DirectWire.terminalHResolveSupportFamily_nodup",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveSupportResolver","12b545debd0204200afc5be09fd1e0c881f642bda7fbadefdbd76c824aef4596"],
  ["PNP.DirectWire.canonicalTerminalSupportSeed_mem_terminalHResolveSupportFamily",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveSupportResolver","8524cf247dd11640bf472ed4c77b0ccac2411286bfc8f8c50137466ac5cd470b"],
  ["PNP.DirectWire.terminalHResolveSupportExact_iff_semanticallyMinimum",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveSupportResolver","ecf50b36d176945b7e72e3cacf3439bf840c413b39cc2636baefcbcaaa671c90"],
  ["PNP.DirectWire.terminalHResolveSupportGain_iff_exists_strictEquivalentGain",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveSupportResolver","f1b66d49979d7aa5a03ffb01d219daf0241d41aa1b68df16a94d9cc93fcba73b"],
  ["PNP.DirectWire.terminalHResolveSupport_exact_or_gain",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveSupportResolver","59a11a45ff57d9e3aa84fb66d458554111090797cff4e0ff6cfb6f6cef0da231"],
  ["PNP.DirectWire.terminalHResolveSupportClassify_eq_exact_iff",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveSupportResolver","9117a221c84b2c039fb4803d92d83988700ef51de0c70f8bf9ce88423e8d8b85"],
  ["PNP.DirectWire.terminalHResolveSupportClassify_eq_gain_iff",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveSupportResolver","f155ba3303e3189f18777ca5aae2ac909cacfd08ca02c38ac71b020c401736ab"],
...
const RESIDUAL_TERMINAL_BUDGET_NO_LOWER_LEDGER_DECLARATIONS = Object.freeze([
  ["PNP.DirectWire.terminalBudgetNoLowerClassify_eq_exact_iff",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetNoLowerLedger","41c86fdd39c37c99a7f836f74fdfb4bbfcd7be4750c797cb96a2ec24232498f6"],
  ["PNP.DirectWire.terminalBudgetNoLowerClassify_eq_gain_iff",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetNoLowerLedger","91eb2fb51691fa4a633d45a1742ea1332c94c69999dd6eaaecee6728e0c1146f"],
  ["PNP.DirectWire.terminalBudgetNoLowerClassify_eq_noBudget_iff",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetNoLowerLedger","b4d2167b67ba29a3a1171ebdafdc143ae1f878fa7bf8d8a9fed7832cf1ff3ea9"],
  ["PNP.DirectWire.terminalBudgetNoLowerRouteLedger_complete",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetNoLowerLedger","ab09bb0e1000df6e81daa528f4dc4ab5ae93e4d0d746e2f8f8b866a44418cd12"],
  ["PNP.DirectWire.terminalBudgetNoLowerRouteLedger_sound",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetNoLowerLedger","18305b5c8522e34cd549aea56f21101217169772556dfee709ed067d1d67645f"],
  ["PNP.DirectWire.checkTerminalBudgetNoLowerLedger_eq_true_iff",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetNoLowerLedger","61315099cf4bf6e35c28e847dd3ec9a56118f2961a7d7143d3907669e4b6506f"],
...
const RESIDUAL_TERMINAL_HN_BWL_CERTIFIED_PATH_MINIMUM_DECLARATIONS = Object.freeze([
  ["PNP.DirectWire.checkTerminalNatVectorLexLE_eq_true_iff",["propext"],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","1d06a97fd7f748cf57fa79b1a60a053e008e5274e145b42ec00c165b91440dc5"],
  ["PNP.DirectWire.terminalNatVectorLexLE_total_of_length_eq",[],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","488506033db9fd823277f370c9d22109776728339e378c3d96999bd93f55851d"],
  ["PNP.DirectWire.terminalNatVectorLexLE_refl",[],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","0ecda227d6cabf9cf9ffa51c1d7b8754cca8230b58a8293c3c35ad5ea62ea603"],
  ["PNP.DirectWire.terminalNatVectorLexLE_trans",[],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","d3acbda51a53d19fd5a10a04658aa727b1b77762efb09e9e4e3bd8cfdf7c8948"],
  ["PNP.DirectWire.TerminalHNBWLObjective.checkLexLE_eq_true_iff",["propext"],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","de254f24492b2bb71bba226789807e836329570ea943347b824693450cd98fdb"],
  ["PNP.DirectWire.TerminalHNBWLObjective.lexLE_refl",[],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","531648222febca4b35e2df7fe2dab44a350aa50f1e77c4f601017fd289afee53"],
  ["PNP.DirectWire.TerminalHNBWLObjective.lexLE_total",[],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","4d311abcde5d778e771a8b1676df1bc2760e65d23cb59e47106f3feb2b071c6f"],
  ["PNP.DirectWire.TerminalHNBWLObjective.lexLE_trans",[],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","eb9187fcf760208e67646c15d389b640007b9527456e1904f5714297c27d12ef"],
  ["PNP.DirectWire.terminalHNBWLChoose_eq_left_or_right",[],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","d62799fda97f2aee33ecf46682db164ec869203999b2f56547ca2865df171bda"],
  ["PNP.DirectWire.terminalHNBWLChoose_lexLE_left",["propext"],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","ff6c4ac17c938c02b5466df8abedce31acceaa04453e3e2a5e71a8b0c21141da"],
  ["PNP.DirectWire.terminalHNBWLChoose_lexLE_right",["propext"],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","96bf5e9bc018ff1f96e19018f9919cf083c5509abcdfe2d264290912def78a03"],
  ["PNP.DirectWire.terminalHNBWLMinimum?_eq_none_iff",["propext"],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","64141090dfed234bb678fb9d758bb2b7b0af8c470fee411a6c0593e400b42055"],
  ["PNP.DirectWire.terminalHNBWLMinimum?_sound",["propext"],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","49fe1209297af83ac6d68bfa95c5e9c559b2f9d32176000ad2ad33231dd9309d"],
  ["PNP.DirectWire.terminalHNBWLMinimum?_exists_of_ne_nil",["propext"],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","9a53ee168de637d01731595a4d0b3c96af2039cecef531a0d4fe62a47888b634"],
  ["PNP.DirectWire.terminal_hn_bwl_certified_path_minimum_complete",["propext"],"PNP.ResidualTerminalHNBWLCertifiedPathMinimum","fd5a191f5cc72cab4e766e663becaee9d07366c6ba347a897ad8a3b03d9e2d25"],
]);
const RESIDUAL_TERMINAL_HRESOLVE_CERTIFIED_PATH_FAMILY_DECLARATIONS = Object.freeze([
  ["PNP.DirectWire.TerminalHResolveCertifiedPathCandidate.checkHDisjoint_eq_true_iff",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCertifiedPathFamily","618f82dee094b60602bd719d146f6134b6b4847f7cd6d1b0aaa608a3132a1e65"],
  ["PNP.DirectWire.TerminalHResolveCertifiedPathCandidate.minimum?_complete",["propext"],"PNP.ResidualTerminalHResolveCertifiedPathFamily","20fb52927e7c5f7ca6a4bf9e9af307a878d2f60b46fef3a3a2a78707f9ad4bbf"],
  ["PNP.DirectWire.terminalHResolveGreedyCertifiedPathFamily_subset",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCertifiedPathFamily","8aeb7125af254557137e52e763908fbb8f46fdc1cab001f4a49ae517e34c0b6a"],
  ["PNP.DirectWire.terminalHResolveGreedyCertifiedPathFamily_nodup",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCertifiedPathFamily","a133a454e5f3700d5c644bbab7f81649462c36bb77228caf96418361e4613aa4"],
  ["PNP.DirectWire.terminalHResolveGreedyCertifiedPathFamily_pairwise",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCertifiedPathFamily","8327cf69dc20a587804765d4747097718daad235528d803169d22462c0f9c46b"],
  ["PNP.DirectWire.terminalHResolveGreedyCertifiedPathFamily_maximal",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCertifiedPathFamily","53998173b2aa4fcdf6c200d830bd4081c9e7857c181469e3873372c822cadeae"],
  ["PNP.DirectWire.terminal_hresolve_certified_path_family_complete",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveCertifiedPathFamily","afa671a255c4e3e1e840ad632863d9441604275906436d6ff40462af4ce008e9"],
]);
const RESIDUAL_TERMINAL_HRESOLVE_ZEROSLACK_SIDECAR_DECLARATIONS = Object.freeze([
  ["PNP.HResolveSidecarCertificate.accepted",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveZeroSlackSidecar","55d744332baf2b97d8f09878f43fbc2a3f1321fb44c98875d1adddc333b0fba9"],
  ["PNP.HResolveSidecarCertificate.not_exact",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveZeroSlackSidecar","150bbe27229f80035a9f909cade997afa2a8dc5d764208daa9ffb5c610c7f165"],
  ["PNP.HResolveSidecarCertificate.not_gain",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveZeroSlackSidecar","be1830a305f072269dc4b87fcc83431b680c3ac5997228230a3a0e3b258fe552"],
  ["PNP.HResolveSidecarCertificate.blocked_of_mem",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveZeroSlackSidecar","a4ef62fd886cc9790b082a46846385e82423096a2cd8441905943b0e495408b4"],
  ["PNP.HResolveSidecarCertificate.exact_route_sound",[],"PNP.ResidualTerminalHResolveZeroSlackSidecar","12972e8b0b6f869bdcca53829b3609cf214b2586eb6e0d5d1ac9541c7755f100"],
  ["PNP.HResolveSidecarCertificate.gain_route_sound",[],"PNP.ResidualTerminalHResolveZeroSlackSidecar","129f4d0176153b831ed957ee92a62c2073e09e09fb778caa66bb4893e629d56d"],
  ["PNP.hresolve_zeroslack_sidecar_checked_complete",["Quot.sound","propext"],"PNP.ResidualTerminalHResolveZeroSlackSidecar","fd970a799e2afdcc83b011d3d7476557efe33bdbc48decc563785d1602d89709"],
]);
const RESIDUAL_TERMINAL_BUDGET_ZEROSLACK_SIDECAR_DECLARATIONS = Object.freeze([
  ["PNP.BudgetSidecarCertificate.excluded",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetZeroSlackSidecar","a15cd6efe59fd66ddaab02635ee9f7aef0a82b43476ae57404cc7a1453fa5ba3"],
  ["PNP.BudgetSidecarCertificate.no_feasible_support",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetZeroSlackSidecar","c43f95f6685ef2bfd1c74341121879e8800e14071c71551b6f52443214c3c9f5"],
  ["PNP.BudgetSidecarCertificate.exact_route_sound",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetZeroSlackSidecar","d8a95988cf255477a8e89a4677c8ab5acfa3129540dbf8aac0d9e477cb4e1922"],
  ["PNP.BudgetSidecarCertificate.gain_route_sound",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetZeroSlackSidecar","030c2b43009fff9c76409479aa0ed39d46451e011b4de89e09f604e0f0eb9968"],
  ["PNP.budget_zeroslack_sidecar_checked_complete",["Quot.sound","propext"],"PNP.ResidualTerminalBudgetZeroSlackSidecar","7829c7dd487dfec295ad0504483a30ebe0a22e43cd4da685920f8df8f40bce4b"],
]);
const RESIDUAL_TERMINAL_SELECTOR_HB_ZEROSLACK_SIDECAR_DECLARATIONS = Object.freeze([
  ["PNP.SelectorHBZeroSlackSidecarCertificate.accepted",["Quot.sound","propext"],"PNP.ResidualTerminalSelectorHBZeroSlackSidecar","67c70ec0e459367d654987206e3c2cd52553e82c8f23b7f16022a9762d1d261c"],
  ["PNP.SelectorHBZeroSlackSidecarCertificate.no_faithful",["Quot.sound","propext"],"PNP.ResidualTerminalSelectorHBZeroSlackSidecar","171fafc844fb693b973fa2ea791ac5750c9e598be66d8c1b2f590595cab72bff"],
  ["PNP.SelectorHBZeroSlackSidecarCertificate.claim_eq_bot",["Quot.sound","propext"],"PNP.ResidualTerminalSelectorHBZeroSlackSidecar","22e94e24106d10ddb099f0382892d7d1bc75620bd15a45d04123ddf98f1b791a"],
  ["PNP.SelectorHBZeroSlackSidecarCertificate.hb_closure_valid",["Quot.sound","propext"],"PNP.ResidualTerminalSelectorHBZeroSlackSidecar","467e8cbac6c5e66bc9f3d4c07b2a70d7f2123a3a94f3c1321dfd5a0ca4e390d2"],
  ["PNP.SelectorHBZeroSlackSidecarCertificate.no_hb_active",["Quot.sound","propext"],"PNP.ResidualTerminalSelectorHBZeroSlackSidecar","4d124cd8d0a094b5afc6f65753a0fc25ebe3de53f7982e9c9c14baa3f42ab92e"],
  ["PNP.SelectorHBZeroSlackSidecarCertificate.depends_wellFounded",["Quot.sound","propext"],"PNP.ResidualTerminalSelectorHBZeroSlackSidecar","5271acc313495928f3c92cd7af78837c8e40d4b4efbfc1b65e558b4e22877e8a"],
  ["PNP.selector_hb_zeroslack_sidecar_checked_complete",["Quot.sound","propext"],"PNP.ResidualTerminalSelectorHBZeroSlackSidecar","2a9dbe37bb6f13d6cb78be8d374fbcc826079845b2c9c724ac4f6d58ad2c51e3"],
]);
...
const FAIL_CLOSED_FORMAL_STATUS = Object.freeze({
  ...
  leanResidualTerminalPacketDescentNoLowerBindingFormalized: false,
  leanResidualTerminalPacketDescentNoLowerBindingAxiomAuditPassed: false,
  leanResidualTerminalPacketDescentNoLowerBindingScope: null,
  leanResidualTerminalPacketNoLowerLedgerFormalized: false,
  leanResidualTerminalPacketNoLowerLedgerAxiomAuditPassed: false,
  leanResidualTerminalPacketNoLowerLedgerScope: null,
  leanResidualTerminalHResolveCoverageLedgerFormalized: false,
  leanResidualTerminalHResolveCoverageLedgerAxiomAuditPassed: false,
  leanResidualTerminalHResolveCoverageLedgerScope: null,
  ...
  leanResidualTerminalHNBWLCertifiedPathMinimumFormalized: false,
  leanResidualTerminalHNBWLCertifiedPathMinimumAxiomAuditPassed: false,
  leanResidualTerminalHNBWLCertifiedPathMinimumScope: null,
  leanResidualTerminalHResolveCertifiedPathFamilyFormalized: false,
  leanResidualTerminalHResolveCertifiedPathFamilyAxiomAuditPassed: false,
  leanResidualTerminalHResolveCertifiedPathFamilyScope: null,
  leanResidualTerminalHResolveZeroSlackSidecarFormalized: false,
  leanResidualTerminalHResolveZeroSlackSidecarAxiomAuditPassed: false,
  leanResidualTerminalHResolveZeroSlackSidecarScope: null,
  leanResidualTerminalBudgetZeroSlackSidecarFormalized: false,
  leanResidualTerminalBudgetZeroSlackSidecarAxiomAuditPassed: false,
  leanResidualTerminalBudgetZeroSlackSidecarScope: null,
  leanResidualTerminalSelectorHBZeroSlackSidecarFormalized: false,
  leanResidualTerminalSelectorHBZeroSlackSidecarAxiomAuditPassed: false,
  leanResidualTerminalSelectorHBZeroSlackSidecarScope: null,
...
leanResidualTerminalPacketDescentNoLowerBindingFormalized = ${payload.leanResidualTerminalPacketDescentNoLowerBindingFormalized ?? false}
leanResidualTerminalPacketDescentNoLowerBindingAxiomAuditPassed = ${payload.leanResidualTerminalPacketDescentNoLowerBindingAxiomAuditPassed ?? false}
leanResidualTerminalPacketDescentNoLowerBindingScope = ${payload.leanResidualTerminalPacketDescentNoLowerBindingScope === null ? 'null' : JSON.stringify(payload.leanResidualTerminalPacketDescentNoLowerBindingScope)}
leanResidualTerminalPacketNoLowerLedgerFormalized = ${payload.leanResidualTerminalPacketNoLowerLedgerFormalized ?? false}
leanResidualTerminalPacketNoLowerLedgerAxiomAuditPassed = ${payload.leanResidualTerminalPacketNoLowerLedgerAxiomAuditPassed ?? false}
leanResidualTerminalPacketNoLowerLedgerScope = ${payload.leanResidualTerminalPacketNoLowerLedgerScope === null ? 'null' : JSON.stringify(payload.leanResidualTerminalPacketNoLowerLedgerScope)}
leanResidualTerminalHResolveCoverageLedgerFormalized = ${payload.leanResidualTerminalHResolveCoverageLedgerFormalized ?? false}
leanResidualTerminalHResolveCoverageLedgerAxiomAuditPassed = ${payload.leanResidualTerminalHResolveCoverageLedgerAxiomAuditPassed ?? false}
leanResidualTerminalHResolveCoverageLedgerScope = ${payload.leanResidualTerminalHResolveCoverageLedgerScope === null ? 'null' : JSON.stringify(payload.leanResidualTerminalHResolveCoverageLedgerScope)}
...
leanResidualTerminalHNBWLCertifiedPathMinimumFormalized = ${payload.leanResidualTerminalHNBWLCertifiedPathMinimumFormalized ?? false}
leanResidualTerminalHNBWLCertifiedPathMinimumAxiomAuditPassed = ${payload.leanResidualTerminalHNBWLCertifiedPathMinimumAxiomAuditPassed ?? false}
leanResidualTerminalHNBWLCertifiedPathMinimumScope = ${payload.leanResidualTerminalHNBWLCertifiedPathMinimumScope === null ? 'null' : JSON.stringify(payload.leanResidualTerminalHNBWLCertifiedPathMinimumScope)}
leanResidualTerminalHResolveCertifiedPathFamilyFormalized = ${payload.leanResidualTerminalHResolveCertifiedPathFamilyFormalized ?? false}
leanResidualTerminalHResolveCertifiedPathFamilyAxiomAuditPassed = ${payload.leanResidualTerminalHResolveCertifiedPathFamilyAxiomAuditPassed ?? false}
leanResidualTerminalHResolveCertifiedPathFamilyScope = ${payload.leanResidualTerminalHResolveCertifiedPathFamilyScope === null ? 'null' : JSON.stringify(payload.leanResidualTerminalHResolveCertifiedPathFamilyScope)}
leanResidualTerminalHResolveZeroSlackSidecarFormalized = ${payload.leanResidualTerminalHResolveZeroSlackSidecarFormalized ?? false}
leanResidualTerminalHResolveZeroSlackSidecarAxiomAuditPassed = ${payload.leanResidualTerminalHResolveZeroSlackSidecarAxiomAuditPassed ?? false}
leanResidualTerminalHResolveZeroSlackSidecarScope = ${payload.leanResidualTerminalHResolveZeroSlackSidecarScope === null ? 'null' : JSON.stringify(payload.leanResidualTerminalHResolveZeroSlackSidecarScope)}
leanResidualTerminalBudgetZeroSlackSidecarFormalized = ${payload.leanResidualTerminalBudgetZeroSlackSidecarFormalized ?? false}
leanResidualTerminalBudgetZeroSlackSidecarAxiomAuditPassed = ${payload.leanResidualTerminalBudgetZeroSlackSidecarAxiomAuditPassed ?? false}
leanResidualTerminalBudgetZeroSlackSidecarScope = ${payload.leanResidualTerminalBudgetZeroSlackSidecarScope === null ? 'null' : JSON.stringify(payload.leanResidualTerminalBudgetZeroSlackSidecarScope)}
leanResidualTerminalSelectorHBZeroSlackSidecarFormalized = ${payload.leanResidualTerminalSelectorHBZeroSlackSidecarFormalized ?? false}
leanResidualTerminalSelectorHBZeroSlackSidecarAxiomAuditPassed = ${payload.leanResidualTerminalSelectorHBZeroSlackSidecarAxiomAuditPassed ?? false}
leanResidualTerminalSelectorHBZeroSlackSidecarScope = ${payload.leanResidualTerminalSelectorHBZeroSlackSidecarScope === null ? 'null' : JSON.stringify(payload.leanResidualTerminalSelectorHBZeroSlackSidecarScope)}
...
function validateInventory(inventory) {
  ...
  const residualTerminalPacketSemanticHNActivityBinding =
    RESIDUAL_TERMINAL_PACKET_SEMANTIC_HN_ACTIVITY_BINDING_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
    }));
  const residualTerminalPacketDescentNoLowerBinding =
    RESIDUAL_TERMINAL_PACKET_DESCENT_NO_LOWER_BINDING_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
    }));
  const residualTerminalPacketNoLowerLedger =
    RESIDUAL_TERMINAL_PACKET_NO_LOWER_LEDGER_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
    }));
  const residualTerminalHResolveCoverageLedger =
    RESIDUAL_TERMINAL_HRESOLVE_COVERAGE_LEDGER_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
    }));
  const residualTerminalHResolveSupportResolver =
    RESIDUAL_TERMINAL_HRESOLVE_SUPPORT_RESOLVER_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
  ...
  const residualTerminalBudgetNoLowerLedger =
    RESIDUAL_TERMINAL_BUDGET_NO_LOWER_LEDGER_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
  ...
  const residualTerminalHNBWLCertifiedPathMinimum =
    RESIDUAL_TERMINAL_HN_BWL_CERTIFIED_PATH_MINIMUM_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
    }));
  const residualTerminalHResolveCertifiedPathFamily =
    RESIDUAL_TERMINAL_HRESOLVE_CERTIFIED_PATH_FAMILY_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
    }));
  const residualTerminalHResolveZeroSlackSidecar =
    RESIDUAL_TERMINAL_HRESOLVE_ZEROSLACK_SIDECAR_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
    }));
  const residualTerminalBudgetZeroSlackSidecar =
    RESIDUAL_TERMINAL_BUDGET_ZEROSLACK_SIDECAR_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
    }));
  const residualTerminalSelectorHBZeroSlackSidecar =
    RESIDUAL_TERMINAL_SELECTOR_HB_ZEROSLACK_SIDECAR_DECLARATIONS.map(([name, axioms, module, hash]) => ({
      row: inventory.milestoneCandidates?.find((candidate) => candidate?.name === name),
      axioms,
      module,
      hash,
  ...
  return membership?.kind === 'theorem'
    ...
    && residualTerminalPacketBudgetHBActivityBinding.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    && residualTerminalPacketSemanticHNActivityBinding.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    && residualTerminalPacketDescentNoLowerBinding.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    && residualTerminalPacketNoLowerLedger.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    && residualTerminalHResolveCoverageLedger.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    ...
    && residualTerminalHResolveMaximalHDisjointFamily.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    && residualTerminalHNBWLCertifiedPathMinimum.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    && residualTerminalHResolveCertifiedPathFamily.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    && residualTerminalHResolveZeroSlackSidecar.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    && residualTerminalBudgetZeroSlackSidecar.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
    && residualTerminalSelectorHBZeroSlackSidecar.every(({ row, axioms, module }) => row?.kind === 'theorem'
      && row.module === module
      && sameJson(row.axioms, axioms))
...
function validateStatus(status, inventory) {
  ...
  const residualTerminalPacketSemanticHNActivityBindingMilestone = status?.formalPublicationMilestones?.find(
    (row) => row.id === 'residual-terminal-packet-semantic-hn-activity-binding'
  );
  const residualTerminalPacketDescentNoLowerBindingMilestone = status?.formalPublicationMilestones?.find(
    (row) => row.id === 'residual-terminal-packet-descent-no-lower-binding'
  );
  const residualTerminalPacketNoLowerLedgerMilestone = status?.formalPublicationMilestones?.find(
    (row) => row.id === 'residual-terminal-packet-no-lower-ledger'
  );
  const residualTerminalHResolveCoverageLedgerMilestone = status?.formalPublicationMilestones?.find(
  ...
  const residualTerminalHNBWLCertifiedPathMinimumMilestone = status?.formalPublicationMilestones?.find(
    (row) => row.id === 'residual-terminal-hn-bwl-certified-path-minimum'
  );
  const residualTerminalHResolveCertifiedPathFamilyMilestone = status?.formalPublicationMilestones?.find(
    (row) => row.id === 'residual-terminal-hresolve-certified-path-family'
  );
  const residualTerminalHResolveZeroSlackSidecarMilestone = status?.formalPublicationMilestones?.find(
    (row) => row.id === 'residual-terminal-hresolve-zeroslack-sidecar'
  );
  const residualTerminalBudgetZeroSlackSidecarMilestone = status?.formalPublicationMilestones?.find(
    (row) => row.id === 'residual-terminal-budget-zeroslack-sidecar'
  );
  const residualTerminalSelectorHBZeroSlackSidecarMilestone = status?.formalPublicationMilestones?.find(
    (row) => row.id === 'residual-terminal-selector-hb-zeroslack-sidecar'
  );
  ...
  return status?.kind === 'PNPFormalReconstructionStatus0'
    ...
    && status.leanResidualTerminalPacketSemanticHNActivityBindingFormalized === true
    && status.leanResidualTerminalPacketSemanticHNActivityBindingAxiomAuditPassed === true
    && status.leanResidualTerminalPacketSemanticHNActivityBindingScope === "all-arbitrary-finite-frontier-obligation-activation-direction-mismatch-to-HN-activity-checked-sole-descent-route-under-checked-semantic-HN-budget-HB-and-well-founded-HB-closure"

    && residualTerminalPacketDescentNoLowerBindingMilestone?.classification === "formalized-residual-terminal-packet-descent-no-lower-binding"
    && residualTerminalPacketDescentNoLowerBindingMilestone.status === "formalized-residual-terminal-packet-descent-no-lower-binding"
    && residualTerminalPacketDescentNoLowerBindingMilestone.scope === "For every arbitrary finite grouped BN6 family and selector-rank carrier, the executable local Packet descent no-lower checker scans every canonical handle and accepts exactly when no fully computed first route is residual nondecrease. Under a supplied positive Packet conclusion, checked semantic/HN and budget/HB bindings, executable selector silence, and checked well-founded HB no-outcome closure, the checker is forced to reject; assuming that same local row accepted yields a contradiction."
    && residualTerminalPacketDescentNoLowerBindingMilestone.nonClaim === "This is one checked local Packet no-lower row over a supplied finite grouped family, rank map, residual ranks, typed fields, realizer table, dependency table, and accepted binding, silence, and closure checks. It does not construct those inputs from terminal data or complete the manuscript's no-lower ledger. It does not cover HResolve, BudgetResolve, normalization, named descent routes, saturation, or replay; derive unconditional HB closure; establish complete Packet adequacy or unconditional ZeroSlack; prove PCCMin, encoded-size or polynomial-runtime bounds, SAT in P; remove a project assumption; or prove P = NP."
    && sameJson(
      residualTerminalPacketDescentNoLowerBindingMilestone.requiredTheorems,
      RESIDUAL_TERMINAL_PACKET_DESCENT_NO_LOWER_BINDING_DECLARATIONS.map(([name]) => name)
    )
    && residualTerminalPacketDescentNoLowerBindingMilestone.theoremRows?.every((row) => {
      const expected = RESIDUAL_TERMINAL_PACKET_DESCENT_NO_LOWER_BINDING_DECLARATIONS.find(([name]) => name === row.name);
      return expected
        && row.present === true
        && row.kind === 'theorem'
        && sameJson(row.axioms, expected[1])
    ...
    && status.leanResidualTerminalPacketDescentNoLowerBindingFormalized === true
    && status.leanResidualTerminalPacketDescentNoLowerBindingAxiomAuditPassed === true
    && status.leanResidualTerminalPacketDescentNoLowerBindingScope === "all-arbitrary-finite-canonical-packet-handles-exhaustive-local-descent-no-lower-row-rejected-under-checked-positive-packet-semantic-HN-budget-HB-selector-silence-and-HB-closure"

    && residualTerminalPacketNoLowerLedgerMilestone?.classification === "formalized-residual-terminal-packet-no-lower-ledger"
    && residualTerminalPacketNoLowerLedgerMilestone.status === "formalized-residual-terminal-packet-no-lower-ledger"
    && residualTerminalPacketNoLowerLedgerMilestone.scope === "For every supplied arbitrary finite grouped BN6 family, typed realizer table, HB dependency table, finite rank map, and before/after residual ranks, one Boolean recomputes the five executable checks for semantic/HN binding, budget/HB binding, selector silence, HB no-outcome closure, and Packet descent/no-lower. Its reflection theorem characterizes exact acceptance, a positive Packet forces rejection, and an accepted ledger excludes a positive Packet conclusion for those same inputs."
    && residualTerminalPacketNoLowerLedgerMilestone.nonClaim === "This closes the Packet branch only, not the complete no-lower ledger. The grouped family, BN5 coordinates, activation atoms, direction and budget values, rank map, residual ranks, realizer claims, activity environment, dependency rows, and all terminal data remain supplied. It does not implement HResolve, BudgetResolve, normalization, other named obstructions, saturation, or replay; derive unconditional HB closure; establish unconditional ZeroSlack; prove PCCMin, encoded-size or polynomial-runtime bounds, SAT in P; remove a project assumption; or prove P = NP."
    && sameJson(
      residualTerminalPacketNoLowerLedgerMilestone.requiredTheorems,
      RESIDUAL_TERMINAL_PACKET_NO_LOWER_LEDGER_DECLARATIONS.map(([name]) => name)
    )
    && residualTerminalPacketNoLowerLedgerMilestone.theoremRows?.every((row) => {
      const expected = RESIDUAL_TERMINAL_PACKET_NO_LOWER_LEDGER_DECLARATIONS.find(([name]) => name === row.name);
      return expected
        && row.present === true
        && row.kind === 'theorem'
        && sameJson(row.axioms, expected[1])
    ...
    && status.leanResidualTerminalPacketNoLowerLedgerFormalized === true
    && status.leanResidualTerminalPacketNoLowerLedgerAxiomAuditPassed === true
    && status.leanResidualTerminalPacketNoLowerLedgerScope === "all-arbitrary-finite-five-row-Packet-no-lower-ledger-positive-Packet-exclusion-under-computed-semantic-HN-budget-HB-selector-silence-and-HB-closure"

    && residualTerminalHResolveCoverageLedgerMilestone?.classification === "formalized-residual-terminal-hresolve-coverage-ledger"
    && residualTerminalHResolveCoverageLedgerMilestone.status === "formalized-residual-terminal-hresolve-coverage-ledger"
    && residualTerminalHResolveCoverageLedgerMilestone.scope === "For every arbitrary finite supplied HResolve candidate family with decidable equality and arbitrary decidable exact, gain, and blocker predicates, Lean computes a fixed-priority exact, gain, blocked, or unresolved route for every candidate, generates a sound and complete route ledger, and checks both duplicate-free enumeration and all-candidate blocked coverage. The checker accepts exactly a NoHereditary sidecar for that supplied family, and acceptance excludes exact and gain routes for every enumerated candidate."
    && residualTerminalHResolveCoverageLedgerMilestone.nonClaim === "The finite HResolve candidate family and its decidable exact, gain, and blocker predicates remain supplied. This milestone does not construct the governed hereditary universe from terminal data or prove that those predicates implement the manuscript's HN grammar, BWL exactness, H-disjointness, exact-minimum semantics, strict-gain semantics, or blocker dependency semantics. It does not discharge the full historical HResolve theorem, implement BudgetResolve, normalization, the complete no-lower ledger, saturation, or replay; establish unconditional HB closure or ZeroSlack; prove PCCMin, encoded-size or polynomial-runtime bounds, SAT in P; remove a project assumption; or prove P = NP."
    && sameJson(
      residualTerminalHResolveCoverageLedgerMilestone.requiredTheorems,
      RESIDUAL_TERMINAL_HRESOLVE_COVERAGE_LEDGER_DECLARATIONS.map(([name]) => name)
    )
    && residualTerminalHResolveCoverageLedgerMilestone.theoremRows?.every((row) => {
      const expected = RESIDUAL_TERMINAL_HRESOLVE_COVERAGE_LEDGER_DECLARATIONS.find(([name]) => name === row.name);
      return expected
        && row.present === true
        && row.kind === 'theorem'
        && sameJson(row.axioms, expected[1])
    ...
    && status.leanResidualTerminalHResolveCoverageLedgerFormalized === true
    && status.leanResidualTerminalHResolveCoverageLedgerAxiomAuditPassed === true
    && status.leanResidualTerminalHResolveCoverageLedgerScope === "all-arbitrary-finite-supplied-HResolve-candidates-unique-route-ledger-and-NoHereditary-sidecar-excludes-exact-and-gain-under-decidable-supplied-predicates"

    && residualTerminalHResolveSupportResolverMilestone?.classification === "formalized-residual-terminal-hresolve-support-resolver"
    && residualTerminalHResolveSupportResolverMilestone.status === "formalized-residual-terminal-hresolve-support-resolver"
    && residualTerminalHResolveSupportResolverMilestone.scope === "For every finite direct-wire candidate and profile-width model, Lean constructs the complete duplicate-free family of canonical terminal support seeds, saturates each seed in the candidate-derived terminal system, and computes either an exact route with semantic-minimum evidence or a gain route with a strict-equivalent-gain witness."
    && residualTerminalHResolveSupportResolverMilestone.nonClaim === "The reference search is exhaustive over the complete finite terminal support universe and may be exponential in the number of primitive records. This milestone does not implement the manuscript's HN grammar, BWL exactness, H-disjointness, blocker or NoHereditary semantics, polynomial HResolve, BudgetResolve, the complete no-lower ledger, unconditional ZeroSlack, PCCMin, polynomial runtime, SAT in P, or P = NP."
    && sameJson(
      residualTerminalHResolveSupportResolverMilestone.requiredTheorems,
      RESIDUAL_TERMINAL_HRESOLVE_SUPPORT_RESOLVER_DECLARATIONS.map(([name]) => name)
    )
    && residualTerminalHResolveSupportResolverMilestone.theoremRows?.every((row) => {
      const expected = RESIDUAL_TERMINAL_HRESOLVE_SUPPORT_RESOLVER_DECLARATIONS.find(([name]) => name === row.name);
      return expected
        && row.present === true
        && row.kind === 'theorem'
        && sameJson(row.axioms, expected[1])
    ...
    && residualTerminalHNBWLCertifiedPathMinimumMilestone.status === "formalized-residual-terminal-hn-bwl-certified-path-minimum"
    && residualTerminalHNBWLCertifiedPathMinimumMilestone.scope === "For every nonempty finite supplied family of certified hereditary paths, Lean computes the exact four-coordinate lexicographic minimum by realized cost, residual rank, frontier deviation, and direct-wire code. The selected member preserves semantic fidelity, frontier fidelity, nonempty block coverage, and one of four HN shapes; an explicit completeness premise extends its lower bound to every path in the supplied governed predicate."
    && residualTerminalHNBWLCertifiedPathMinimumMilestone.nonClaim === "The certified path family, governed predicate, and family completeness remain supplied inputs. This milestone does not derive accepted paths from terminal data, prove shape-grammar soundness or completeness, LN confluence, ParseOrExit, independent leaf tightness, or the full BWL theorem, solve a leaf, construct the H0-H4 NoHereditary sidecar, implement full HResolve, complete the no-lower ledger, establish unconditional ZeroSlack, prove PCCMin or polynomial generation and runtime, put SAT in P, remove a project assumption, or prove P = NP."
    && sameJson(
      residualTerminalHNBWLCertifiedPathMinimumMilestone.requiredTheorems,
      RESIDUAL_TERMINAL_HN_BWL_CERTIFIED_PATH_MINIMUM_DECLARATIONS.map(([name]) => name)
    )
    && residualTerminalHNBWLCertifiedPathMinimumMilestone.theoremRows?.every((row) => {
      const expected = RESIDUAL_TERMINAL_HN_BWL_CERTIFIED_PATH_MINIMUM_DECLARATIONS.find(([name]) => name === row.name);
      return expected
        && row.present === true
        && row.kind === 'theorem'
        && sameJson(row.axioms, expected[1])
    ...
    && status.leanResidualTerminalHNBWLCertifiedPathMinimumFormalized === true
    && status.leanResidualTerminalHNBWLCertifiedPathMinimumAxiomAuditPassed === true
    && status.leanResidualTerminalHNBWLCertifiedPathMinimumScope === "all-nonempty-finite-supplied-four-coordinate-certified-path-families-exact-lexicographic-minimum-with-explicit-governed-family-completeness"

    && residualTerminalHResolveCertifiedPathFamilyMilestone?.classification === "formalized-residual-terminal-hresolve-certified-path-family"
    && residualTerminalHResolveCertifiedPathFamilyMilestone.status === "formalized-residual-terminal-hresolve-certified-path-family"
    && residualTerminalHResolveCertifiedPathFamilyMilestone.scope === "For every duplicate-free finite supplied family of proof-bearing hereditary candidates, Lean constructs a duplicate-free maximal pairwise H-disjoint selected family. Every selected candidate has an exact four-coordinate certified-path minimum preserving semantic, frontier, block, shape, and footprint-coherence evidence; every rejected candidate has a selected blocker carrying the exact first interference route."
    && residualTerminalHResolveCertifiedPathFamilyMilestone.nonClaim === "The candidates, certified paths, hereditary footprints, governed predicates, family-completeness proofs, and path-to-footprint coherence proofs remain supplied inputs. This milestone does not derive them from terminal data, prove HN grammar soundness or completeness, LN confluence, ParseOrExit, independent leaf tightness, or the H0-H4 NoHereditary sidecar, connect blockers to HB rank semantics, implement full or polynomial HResolve, complete the no-lower ledger, establish unconditional ZeroSlack, prove PCCMin or polynomial runtime, put SAT in P, remove a project assumption, or prove P = NP."
    && sameJson(
      residualTerminalHResolveCertifiedPathFamilyMilestone.requiredTheorems,
      RESIDUAL_TERMINAL_HRESOLVE_CERTIFIED_PATH_FAMILY_DECLARATIONS.map(([name]) => name)
    )
    && residualTerminalHResolveCertifiedPathFamilyMilestone.theoremRows?.every((row) => {
      const expected = RESIDUAL_TERMINAL_HRESOLVE_CERTIFIED_PATH_FAMILY_DECLARATIONS.find(([name]) => name === row.name);
      return expected
        && row.present === true
        && row.kind === 'theorem'
        && sameJson(row.axioms, expected[1])
    ...
    && status.leanResidualTerminalHResolveCertifiedPathFamilyFormalized === true
    && status.leanResidualTerminalHResolveCertifiedPathFamilyAxiomAuditPassed === true
    && status.leanResidualTerminalHResolveCertifiedPathFamilyScope === "all-duplicate-free-finite-supplied-proof-bearing-hereditary-candidates-maximal-H-disjoint-family-with-exact-certified-path-minima-and-selected-blocker-routes"

    && residualTerminalHResolveZeroSlackSidecarMilestone?.classification === "formalized-residual-terminal-hresolve-zeroslack-sidecar"
    && residualTerminalHResolveZeroSlackSidecarMilestone.status === "formalized-residual-terminal-hresolve-zeroslack-sidecar"
    && residualTerminalHResolveZeroSlackSidecarMilestone.scope === "For every arbitrary finite supplied governed HResolve family, the report-facing ZeroSlack boundary now consumes a checked proof-bearing NoHereditary sidecar: duplicate-free total blocked coverage is recomputed, exact and gain routes are excluded for every listed candidate, and those route predicates are separately bound to semantic minimum and strict equivalent gain propositions."
    && residualTerminalHResolveZeroSlackSidecarMilestone.nonClaim === "The governed candidate family, implementation map, exact, gain, and blocked predicates, their decidability, and blocker semantics remain supplied inputs. This milestone does not derive hereditary candidates from terminal data, prove HN grammar soundness or completeness, BWL, ParseOrExit, leaf tightness, H0-H4 blocker semantics, full or polynomial HResolve, complete the no-lower ledger, establish unconditional ZeroSlack, prove PCCMin or polynomial runtime, put SAT in P, remove a project assumption, or prove P = NP."
    && sameJson(
      residualTerminalHResolveZeroSlackSidecarMilestone.requiredTheorems,
      RESIDUAL_TERMINAL_HRESOLVE_ZEROSLACK_SIDECAR_DECLARATIONS.map(([name]) => name)
    )
    && residualTerminalHResolveZeroSlackSidecarMilestone.theoremRows?.every((row) => {
      const expected = RESIDUAL_TERMINAL_HRESOLVE_ZEROSLACK_SIDECAR_DECLARATIONS.find(([name]) => name === row.name);
      return expected
        && row.present === true
        && row.kind === 'theorem'
        && sameJson(row.axioms, expected[1])
    ...
    && status.leanResidualTerminalHResolveZeroSlackSidecarFormalized === true
    && status.leanResidualTerminalHResolveZeroSlackSidecarAxiomAuditPassed === true
    && status.leanResidualTerminalHResolveZeroSlackSidecarScope === "all-arbitrary-finite-proof-bearing-HResolve-NoHereditary-sidecars-with-checked-coverage-and-semantic-exact-gain-bindings"

    && residualTerminalBudgetZeroSlackSidecarMilestone?.classification === "formalized-residual-terminal-budget-zeroslack-sidecar"
    && residualTerminalBudgetZeroSlackSidecarMilestone.status === "formalized-residual-terminal-budget-zeroslack-sidecar"
    && residualTerminalBudgetZeroSlackSidecarMilestone.scope === "For arbitrary finite direct-wire candidates and supplied natural caps, the report-facing ZeroSlack boundary now consumes a checked proof-bearing NoBudget sidecar. A failed exhaustive search over the complete canonical terminal support universe excludes every budget-feasible support, while separately checked exact and gain routes entail semantic minimum and strict equivalent gain propositions."
    && residualTerminalBudgetZeroSlackSidecarMilestone.nonClaim === "The natural terminal support caps are supplied inputs, and exhaustive enumeration, saturation, and reference minimization may be exponential. This milestone does not formalize the B0-B4 Budget grammar or blocker semantics, implement full or polynomial BudgetResolve, prove a complete no-lower ledger, establish unconditional ZeroSlack, prove PCCMin or polynomial runtime, put SAT in P, remove a project assumption, or prove P = NP."
    && sameJson(
      residualTerminalBudgetZeroSlackSidecarMilestone.requiredTheorems,
      RESIDUAL_TERMINAL_BUDGET_ZEROSLACK_SIDECAR_DECLARATIONS.map(([name]) => name)
    )
    && residualTerminalBudgetZeroSlackSidecarMilestone.theoremRows?.every((row) => {
      const expected = RESIDUAL_TERMINAL_BUDGET_ZEROSLACK_SIDECAR_DECLARATIONS.find(([name]) => name === row.name);
      return expected
        && row.present === true
        && row.kind === 'theorem'
        && sameJson(row.axioms, expected[1])
    ...
    && status.leanResidualTerminalBudgetZeroSlackSidecarFormalized === true
    && status.leanResidualTerminalBudgetZeroSlackSidecarAxiomAuditPassed === true
    && status.leanResidualTerminalBudgetZeroSlackSidecarScope === "all-finite-direct-wire-candidates-proof-bearing-Budget-NoBudget-sidecars-with-checked-terminal-envelope-exclusion-and-semantic-exact-gain-bindings"

    && residualTerminalSelectorHBZeroSlackSidecarMilestone?.classification === "formalized-residual-terminal-selector-hb-zeroslack-sidecar"
    && residualTerminalSelectorHBZeroSlackSidecarMilestone.status === "formalized-residual-terminal-selector-hb-zeroslack-sidecar"
    && residualTerminalSelectorHBZeroSlackSidecarMilestone.scope === "For arbitrary finite supplied grouped BN6, typed-realizer, and exact-rank HB dependency tables, the report-facing ZeroSlack boundary now consumes one checked proof-bearing Selector/HB sidecar. The exact executable checks yield all-canonical-selector nonfaithfulness, exact typed-bottom rows, complete no-outcome closure, all-node HN/BUD inactivity, and a well-founded dependency relation."
    && residualTerminalSelectorHBZeroSlackSidecarMilestone.nonClaim === "The grouped BN6 family, typed-realizer and dependency tables, environment, realizer claims, activity bits, dependency rows, and finite rank map remain supplied inputs. This milestone does not derive them from terminal data, prove selector faithfulness or compatibility, establish HN/BUD blocker semantics or semantic dependency completeness, connect selector silence to the BCEL contradiction, complete the no-lower ledger, establish unconditional ZeroSlack, prove PCCMin or polynomial runtime, put SAT in P, remove a project assumption, or prove P = NP."
    && sameJson(
      residualTerminalSelectorHBZeroSlackSidecarMilestone.requiredTheorems,
      RESIDUAL_TERMINAL_SELECTOR_HB_ZEROSLACK_SIDECAR_DECLARATIONS.map(([name]) => name)
    )
    && residualTerminalSelectorHBZeroSlackSidecarMilestone.theoremRows?.every((row) => {
      const expected = RESIDUAL_TERMINAL_SELECTOR_HB_ZEROSLACK_SIDECAR_DECLARATIONS.find(([name]) => name === row.name);
      return expected
        && row.present === true
        && row.kind === 'theorem'
        && sameJson(row.axioms, expected[1])
    ...
    && status.leanResidualTerminalSelectorHBZeroSlackSidecarFormalized === true
    && status.leanResidualTerminalSelectorHBZeroSlackSidecarAxiomAuditPassed === true
    && status.leanResidualTerminalSelectorHBZeroSlackSidecarScope === "all-arbitrary-finite-proof-bearing-selector-silence-and-HB-closure-sidecars-with-checked-typed-bottom-rows-all-node-inactivity-and-well-founded-dependencies"
