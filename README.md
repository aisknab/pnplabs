...
Its 1 reviewed theorem pin and all 63 declarations in the focused audit are free of project-specific axioms and `Classical.choice`. The endpoint uses only Lean-standard `Quot.sound` and `propext`.
