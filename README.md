...
Its 11 reviewed theorem pins use only `propext` or `Quot.sound` with `propext`; the focused 16-declaration audit has 9 `propext`-only and 7 `Quot.sound` plus `propext` declarations, with no project axiom.
...
cd pnp
git checkout 81155a482de1e7cf1cd974cc8078dbd94d88d8ae
npm ci
lake build PNP
