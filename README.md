...
Its 6 reviewed theorem pins use only `propext` or `Quot.sound` with `propext`; the focused 9-declaration audit has 3 `propext`-only and 6 `Quot.sound` plus `propext` declarations, with no project axiom.
