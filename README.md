...
Its 11 reviewed theorem pins use only `propext` or `Quot.sound` with `propext`; the focused 16-declaration audit has 4 `propext`-only and 12 `Quot.sound` plus `propext` declarations, with no project axiom.
...
cd pnp
git checkout d9940d34f6273831dd889f1e23073ce9bff1b039
npm ci
lake build PNP
