...
| Milestone map | Reviewed theorem-name/type pins and fixed source digest | Presence, theorem kind, type match, exact approved axiom closure with no project axiom, source match | 138 of 140 scoped rows are earned, through the terminal chain, the complete finite Packet selector pipeline, the generic finite charge-surplus kernel, the checked unit-charge blueprint realizer, the checked finite Packet typed-realizer contract, exact-rank acyclicity and total-table coverage for a supplied finite HN and budget dependency system, checked HN/BUD inactivity, conditional and executable selector silence, selector-faithfulness routing, canonical faithfulness-table construction, total acceptance-or-earliest-route classification, exact earliest-failed-field semantics, exact RankWF reflection of the final Packet descent field, canonical reflection of table-owned rank, the internal source route, positive source charge, grouped-footprint colour eligibility, BN5 frontier and obligation acceptance, and BN4 activation acceptance computed from equality of nested activation atoms in explicit typed source and selector terminal BN5 coordinates. Atom equality matches equality of the canonical activation predicates on every cut; an activation first route is prior frontier and obligation equality with atom inequality; colour, charge, exactRoute, and rank remain excluded; a final descent route retains actual nondecrease evidence; and the positive Packet/HB endpoint carries exact failure evidence without route-clear or binding premises. The BN5 coordinates, finite rank map, direction, budget, before/after ranks, activity bits, dependency rows, exhaustive claims, candidate implementations, replacement blueprints, grouped BN6 family, and upstream data remain explicit inputs. The coordinates are not terminal-derived and the result does not prove the manuscript's complete BN4, BN5, or Packet adequacy bridge. External manuscript semantics for the two remaining routes, decreasing complete global coverage, existence of a decreasing transition, a no-lower ledger, positive slack, terminal construction of those inputs, blocker semantics, semantic dependency completeness, full external selector compatibility, unconditional HB negative closure, polynomial enumeration or runtime, complete PkgC, Package E, BCELReady, unconditional global ZeroSlack, polynomial PCCMin, CNF-SAT in P, and a final conclusion remain outside the earned scope. |
