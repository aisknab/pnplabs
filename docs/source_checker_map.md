...
core commit `52d2f64bc836dd5417d7324a77e94f5a8fb89e48`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the eight-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `52d2f64bc836dd5417d7324a77e94f5a8fb89e48` | Exact source tree reviewed and merged through concrete CNF-SAT verifier correctness and NP membership |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 42 reviewed milestone candidates; canonical counts |
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current eight-page non-claiming report; mirrored by this site |
