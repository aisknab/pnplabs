...
core commit `305443db5a3954be42d1d56912c7f64232efff2a`. Its generated status payload is current
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `305443db5a3954be42d1d56912c7f64232efff2a` | Exact source tree reviewed and merged through concrete CNF-SAT verifier correctness, NP membership, and the four-stage compiler's exact all-input verdict, output, no-timeout, and external polynomial bounds |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 172 reviewed milestone candidates; canonical counts |
