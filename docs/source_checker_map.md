...
core commit `bcabe7b58b7d72e738471f036f1c44b905b949eb`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the twenty-eight-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `bcabe7b58b7d72e738471f036f1c44b905b949eb` | Exact source tree reviewed and merged through concrete CNF-SAT NP membership, raw-machine compilation, Cook-Levin semantic/size/schedule results, the complete first clause, and the complete negative literal on variable zero beginning clause two |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 729 reviewed milestone candidates; canonical counts |
...
| Generated status | `public/pnp-status.json` | Thirty-one earned scoped milestones, three unearned global milestones, four project axioms, and six blockers |
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current twenty-eight-page non-claiming report; mirrored by this site |
