...
core commit `87495e636bb33140921cf582925cc395f10ad128`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the 166-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current 166-page non-claiming report; mirrored by this site |
