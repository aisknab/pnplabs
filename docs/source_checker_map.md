...
core commit `1f749eec50cb57c0595b1fa1e8dfc8ccd497c2e8`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the 154-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current 154-page non-claiming report; mirrored by this site |
