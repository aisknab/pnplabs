...
core commit `4cdfd0e3d263f473177bbef9e9b26d7756810bdf`. Its generated status payload is current
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `4cdfd0e3d263f473177bbef9e9b26d7756810bdf` | Exact source tree reviewed and merged through concrete CNF-SAT NP membership, raw-machine compilation, Cook-Levin semantic/size/schedule results and its bounded builder prefix, plus carrier/trace equivalence, exact baseline/four-gate candidate assembly, all six typed locked-NAND semantic premises, the exact satisfiable/reference-minimum threshold, and residual slack at most four |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 1,977 reviewed milestone candidates; canonical counts |
...
| Generated status | `public/pnp-status.json` | Sixty-five earned scoped milestones—including the arbitrary-circuit locked-NAND semantic threshold and residual-slack bound—three unearned global milestones, four project axioms, and six blockers |
