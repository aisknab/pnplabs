...
core commit `4ccb40cb06ceeb2c375f072f16826a3fd4ae945f`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the 158-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current 158-page non-claiming report; mirrored by this site |
