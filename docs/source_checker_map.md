...
core commit `71199826f380c39fa59796f0d9025651e34e1fe0`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the 160-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current 160-page non-claiming report; mirrored by this site |
