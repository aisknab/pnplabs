...
core commit `e0d08b9d0f294b64d41035125ce0dab1ee6188d8`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the 143-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `e0d08b9d0f294b64d41035125ce0dab1ee6188d8` (tree `b835319af691a07d8770f19cf6e5d0cba4c26c56`) | Exact source tree reviewed and merged through the concrete and terminal chain, the finite Packet/HB and sidecar layers, the report-facing compatibility links, typed PCCPack reflection, the proof-bearing PCCMin orchestration, the checked conditional ZeroSlack bridges, the BCEL-derived BN6 skeleton, canonical positive-cell grouping, exact raw cut-ledger conservation, the sparse V53 cut basis and activation route, and PkgC cancellation-or-BN6-positive-cellization classification over supplied active V54 consumers. |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 3,141 reviewed milestone candidates; canonical counts |
...
| Generated status | `public/pnp-status.json` | Formal artefact coverage is 177 of 179 scoped milestone rows. The newest result classifies every finite supplied active V54 consumer family into the first exact same-key PkgC cancellation or an all-singletonized branch that derives raw BN6 positive cells, support-size facts, payload order, and exact all-cut activation conservation. Terminal data, source systems, active cuts, positive payloads, the typed restorer, upstream BN3 through BN5 construction, checked BCEL/Packet integration, and complete encoded-size bounds remain supplied or open. A cancellation is not a verified global gain or rank decrease, and the result does not complete PkgC through BN6 integration, prove manuscript-wide SaturatePositive or BCELReady, construct executable PCCMin, prove unconditional ZeroSlack or encoded-size polynomial runtime, provide a target decider or SAT hardness transport, or create the root theorem. Two global rows and five blockers remain; no project-specific axioms remain. The row ratio is not proof completion. |
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current 143-page non-claiming report; mirrored by this site |
...
- The key mathematical review targets remain locked-NAND threshold correctness, exact codec/parser/emitter/compiler behavior and reduction composition, the M186 locked-NAND, M187 residual-band, M188 typed PCCPack compatibility/axiom-removal, M189 through M194 supplied oracle, table, and route boundaries, M195 through M198 same-candidate BCEL, grouping, and raw-ledger boundaries, M199's sparse V53 constant-cut basis, M200's singleton/pair proper-cut activation route, and M201's PkgC cancellation-or-BN6-positive-cellization classifier. M201 derives the raw positive-cell ledger only from supplied active V54 consumers and a supplied typed restorer; local proof-bearing cancellation is not a verified global gain or rank decrease. The route still does not construct terminal data, source systems, active cuts, payload or rank data, route-clear proof, claim or HB tables, resolvers, blocker semantics, or complete encoded-size bounds; integrate the M201 family with the checked BCEL/Packet route; complete PkgC through BN6 integration; prove manuscript-wide SaturatePositive or BCELReady or unconditional ZeroSlack; or establish encoded-size polynomial execution. The missing target decider and SAT NP-hardness or CNFSAT NP-completeness transport, polynomial residual-band minimization and promise bounds, no-hidden-minimization discipline, proof-ref soundness, and public theorem boundary discipline remain open.
