...
core commit `bd7e84a49e027020f2d6f6fc4c3cac1f7541aace`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the seven-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `bd7e84a49e027020f2d6f6fc4c3cac1f7541aace` | Exact source tree reviewed and merged for the concrete machine/cost-kernel milestone |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 34 reviewed milestone candidates; canonical counts |
...
| Generated status | `public/pnp-status.json` | Eight earned scoped milestones, three unearned global milestones, five project axioms, and seven blockers |
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current seven-page non-claiming report; mirrored by this site |
