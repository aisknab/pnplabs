...
core commit `ebebf9356116e3b8dca9fbae6999826c026fa18b`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the 140-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| Generated status | `public/pnp-status.json` | Formal artefact coverage is 174 of 176 scoped milestone rows. The newest result proves that M197's canonical duplicate-footprint coalescing preserves the exact direct raw crossing-mass sum on every cut and exposes the remaining activation mismatch directly against the supplied raw ledger. The terminal problem, positive premise, checked finite BCEL-ready certificate, raw positive cells and payloads, tables, ranks, route-clear proof, resolvers, normalizer, blocker semantics, encoded-size bounds, and exhaustive powerset classifier remain supplied. Constant activation is not derived, and the raw-ledger mismatch is not a constructed gain or globally decreasing transition. The result does not derive cells from every terminal input, complete PkgC/BN3 through BN6 integration, prove manuscript-wide SaturatePositive or BCELReady, construct executable PCCMin, prove unconditional ZeroSlack or encoded-size polynomial runtime, provide a target decider or SAT hardness transport, or create the root theorem. Two global rows and five blockers remain; no project-specific axioms remain. The row ratio is not proof completion. |
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current 140-page non-claiming report; mirrored by this site |
...
- The key mathematical review targets remain locked-NAND threshold correctness, exact codec/parser/emitter/compiler behavior and reduction composition, the M186 locked-NAND, M187 residual-band, M188 typed PCCPack compatibility/axiom-removal, M189 supplied-total-oracle boundaries, M190 supplied-normalizer/oracle composition boundaries, M191 rank-ordered orchestration boundaries, M192 supplied checked-Packet-table boundaries, M193 checked HB closure, the M194 supplied route-clear-data boundary, the M195 supplied same-candidate BCEL/Packet boundary, the M196 supplied grouped-family boundary, the M197 supplied raw-positive-cell boundary, and the M198 raw cut-ledger boundary. M197 canonically groups supplied raw supports and payloads, and M198 proves that grouping preserves their direct crossing-mass sum, but neither derives those cells from terminal input. The route does not derive the terminal problem, positive premise, checked finite BCEL-ready certificate, raw cells, payload or rank data, route-clear proof, claim or HB tables, supplied stages, blocker semantics, or encoded-size bounds; convert the raw-ledger mismatch into a globally decreasing gain or derive constant activation; complete PkgC/BN3 through BN6 integration; prove manuscript-wide SaturatePositive or BCELReady or unconditional ZeroSlack; or establish encoded-size polynomial execution. The missing target decider and SAT NP-hardness or CNFSAT NP-completeness transport, polynomial residual-band minimization and promise bounds, no-hidden-minimization discipline, proof-ref soundness, and public theorem boundary discipline remain open.
