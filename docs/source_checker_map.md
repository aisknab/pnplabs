...
core commit `e355f1c93ef17f7d8069cc128b204a351b4792b7`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the 142-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `e355f1c93ef17f7d8069cc128b204a351b4792b7` (tree `2c1d5db7d1cb9da674411ae48016ec110c3510ea`) | Exact source tree reviewed and merged through the concrete and terminal chain, the finite Packet/HB and sidecar layers, the report-facing compatibility links, typed PCCPack reflection, the proof-bearing PCCMin orchestration, the checked conditional ZeroSlack bridges, the BCEL-derived BN6 skeleton, canonical positive-cell grouping, exact raw cut-ledger conservation, the sparse V53 constant-cut basis, and the singleton/pair proper-cut activation route. |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 3,140 reviewed milestone candidates; canonical counts |
...
| Generated status | `public/pnp-status.json` | Formal artefact coverage is 176 of 178 scoped milestone rows. The newest result proves that singleton and order-preserving pair proper cuts form a duplicate-free quadratic-size family equivalent to the complete sparse V53 proper-cut equation. A total classifier returns the first exact small-cut mismatch or derives the equation; the checked adapter reflects a mismatch through the direct raw ledger or reaches conditional ZeroSlack. Terminal data, raw cells and payloads, tables, ranks, route-clear proof, resolvers, normalizer, blocker semantics, upstream construction, and complete encoded-size bounds remain supplied. The local list bound is not a complete runtime theorem, a mismatch is not a gain or global rank decrease, and the result does not complete PkgC/BN3 through BN6 integration, prove manuscript-wide SaturatePositive or BCELReady, construct executable PCCMin, prove unconditional ZeroSlack or encoded-size polynomial runtime, provide a target decider or SAT hardness transport, or create the root theorem. Two global rows and five blockers remain; no project-specific axioms remain. The row ratio is not proof completion. |
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current 142-page non-claiming report; mirrored by this site |
...
- The key mathematical review targets remain locked-NAND threshold correctness, exact codec/parser/emitter/compiler behavior and reduction composition, the M186 locked-NAND, M187 residual-band, M188 typed PCCPack compatibility/axiom-removal, M189--M194 supplied oracle, table, and route boundaries, M195--M198 same-candidate BCEL, grouping, and raw-ledger boundaries, M199's sparse V53 constant-cut basis, and M200's singleton/pair proper-cut activation route. M200 supplies a quadratic-size test family and an exact first-mismatch classifier, but its local list bound is not a complete runtime theorem and the returned mismatch is not a globally decreasing gain. The route still does not construct terminal data, raw cells, payload or rank data, route-clear proof, claim or HB tables, resolvers, blocker semantics, or complete encoded-size bounds; complete PkgC/BN3 through BN6 integration; prove manuscript-wide SaturatePositive or BCELReady or unconditional ZeroSlack; or establish encoded-size polynomial execution. The missing target decider and SAT NP-hardness or CNFSAT NP-completeness transport, polynomial residual-band minimization and promise bounds, no-hidden-minimization discipline, proof-ref soundness, and public theorem boundary discipline remain open.
