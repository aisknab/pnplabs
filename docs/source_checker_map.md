...
core commit `ca60f66498eaa4a6242e15c86fa86a2fe62e78f9`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the seventy-nine-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `ca60f66498eaa4a6242e15c86fa86a2fe62e78f9` (tree `86a19d87f564dd644f78ceea604c18a30ad223ca`) | Exact source tree reviewed and merged through concrete CNF-SAT NP membership, raw-machine compilation, Cook-Levin semantic/size/schedule results and its bounded builder prefix, the locked-NAND typed threshold and concrete compiler/reduction chain, the universal residual-gain bound and global stopping specification, the terminal full-carrier and quotient/full firewall bridges, exhaustive attained full/quotient projection minima, the exact signed four-corner projection-transfer identity, finite terminal saturation under explicitly supplied rule-tagged dependencies, executable exact boundary/interface wire completion, arbitrary finite terminal-support extraction with exact open semantics and whole-circuit recovery, governed proper-positive support search, saturated support-square meet/join closure, exact governed boundary, interface, and ten-role profile completion for every computed square corner, exact governed frontier gluing, governed projection commutation, side-tight four-corner minimum arithmetic with a fail-closed exactness gate, exact common-carrier transport for every computed support square, reversible placement of independently attained corner optima, deterministic classification of coherent optimum transport or its exact first failure, conditional side-tight coherent completion, the complete tight-basis maximum under exact local route silence, and computed BN2 square legitimacy with its local conclusion-or-first-route boundary |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 2,397 reviewed milestone candidates; canonical counts |
...
| Generated status | `public/pnp-status.json` | Ninety-two earned scoped milestones, including the arbitrary-circuit locked-NAND threshold, its encoded semantic boundary, strict-v0 parser/emitter, concrete polynomial reductions, the universal gain-chain bound, global semantic stopping criterion, direct-wire terminal full-carrier bridge, computed terminal quotient/full mode firewall, exhaustive attained projection minima, exact signed four-corner transfer identity, finite terminal saturation closure, executable exact boundary/interface wire completion, arbitrary finite terminal-support extraction, governed proper-positive support search, saturated support-square meet/join closure, governed boundary, interface, and ten-role profile completion for computed square corners, exact governed frontier gluing, governed projection commutation, side-tight four-corner minimum arithmetic, checked structural carrier transport, four-corner optimum carrier compatibility, the coherent-tuple-or-first-failure classifier, conditional side-tight completion, the complete tight-basis maximum under exact local route silence, and computed BN2 structural legitimacy for the explicit finite square; three unearned global milestones, four project axioms, and six blockers |
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current seventy-nine-page non-claiming report; mirrored by this site |
