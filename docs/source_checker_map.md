...
core commit `b9523fe7ea939cd90dba5671aa627986e1f22f18`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the 137-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current 137-page non-claiming report; mirrored by this site |
...
- The key mathematical review targets remain locked-NAND threshold correctness, exact codec/parser/emitter/compiler behavior and reduction composition, the M186 locked-NAND, M187 residual-band, M188 typed PCCPack compatibility/axiom-removal, M189 supplied-total-oracle boundaries, M190 supplied-normalizer/oracle composition boundaries, M191 rank-ordered orchestration boundaries, M192 supplied checked-Packet-table boundaries, M193 checked HB closure, the M194 supplied route-clear-data boundary, and the M195 supplied same-candidate BCEL/Packet boundary. M195 derives constant activation only within that supplied checked boundary. It does not derive the terminal problem, positive premise, checked finite BCEL-ready certificate, grouped family, payload or rank data, route-clear proof, claim or HB tables, supplied stages, blocker semantics, or encoded-size bounds; convert mismatch diagnostics into globally decreasing gains; prove manuscript-wide SaturatePositive or BCELReady or unconditional ZeroSlack; or establish encoded-size polynomial execution. The missing target decider and SAT NP-hardness or CNFSAT NP-completeness transport, polynomial residual-band minimization and promise bounds, no-hidden-minimization discipline, proof-ref soundness, and public theorem boundary discipline remain open.
