...
core commit `ef94583b39f7050953a78a7a6e0ad431cd2eb459`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the eighty-three-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `ef94583b39f7050953a78a7a6e0ad431cd2eb459` (tree `b82aecb1817c83a2b3ec840680aa0f9a9f31870b`) | Exact source tree reviewed and merged through computed BN2 square legitimacy, the canonical positive terminal BCEL anchor nucleus, candidate-derived terminal saturation and finite routing, the fixed residual RankWF, the report-facing concrete locked-NAND threshold reduction, the exact finite candidate-derived BN3 request envelope, and the finite BN4 activation-exact cancellation kernel |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 2,511 reviewed milestone candidates; canonical counts |
...
| Generated status | `public/pnp-status.json` | One hundred and one earned scoped milestones through the finite BN4 activation-exact cancellation kernel; its explicit typed ledger is not derived from the BN3 bases and it does not supply the full historical BN4 theorem, BN5, PkgC, BN6, complete global routing, global ZeroSlack, or polynomial PCCMin; two unearned global milestones, four project axioms, and five blockers |
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current eighty-three-page non-claiming report; mirrored by this site |
