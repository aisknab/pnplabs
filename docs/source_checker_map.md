...
core commit `cc3c004f3498a0f28b8afda688802d322b9e5c21`. Its generated status payload is current
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `cc3c004f3498a0f28b8afda688802d322b9e5c21` | Exact source tree reviewed and merged through concrete CNF-SAT verifier correctness, NP membership, and the four-stage compiler's exact canonical-pair verdict, output, no-timeout, and external polynomial bounds |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 149 reviewed milestone candidates; canonical counts |
