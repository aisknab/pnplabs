...
core commit `385df6cc15cf963a19c2ec5ea96b2e22fcbe76b9`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the 147-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `385df6cc15cf963a19c2ec5ea96b2e22fcbe76b9` (tree `9dc5f189d244ccc08181963a3c94d99d53b7a094`) | Exact source tree reviewed and merged through the concrete and terminal chain, finite Packet/HB and sidecar layers, report-facing compatibility links, typed PCCPack reflection, proof-bearing PCCMin orchestration, checked conditional ZeroSlack bridges, BCEL-derived BN6 skeleton, canonical positive-cell grouping, exact raw cut-ledger conservation, sparse V53 cut basis and activation route, PkgC cancellation-or-cellization over supplied active V54 consumers, source-derived checked-route composition, computed ambient BN4 extraction, exact restoration-coordinate coverage, and family-level restoration-ledger cellization. |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 3,145 reviewed milestone candidates; canonical counts |
...
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current 147-page non-claiming report; mirrored by this site |
