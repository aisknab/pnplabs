...
core commit `5fe3ffec94ad37b0f62321bde9764518d3a4e548`. Its generated status payload is current
publication-status authority. The compiled theorem inventory is the exact evidence mirror, while
the thirty-two-page TeX/PDF report is derived presentation of the same fail-closed gate.
...
| --- | --- | --- |
| Merged formalization | `aisknab/pnp` commit `5fe3ffec94ad37b0f62321bde9764518d3a4e548` | Exact source tree reviewed and merged through concrete CNF-SAT NP membership, raw-machine compilation, Cook-Levin semantic/size/schedule results, both complete fixed clauses, and the remaining clause-two padding run |
| Compiled declaration evidence | `public/pnp-theorem-inventory.json` in that commit | Names, modules, kinds, and axiom closures for all public declarations; raw kernel types for 878 reviewed milestone candidates; canonical counts |
...
| Generated status | `public/pnp-status.json` | Thirty-four earned scoped milestones, three unearned global milestones, four project axioms, and six blockers |
| Generated report | root `canonical_proof_report.tex` and `.pdf` | Current thirty-two-page non-claiming report; mirrored by this site |
