...
> notice are [`status/FORMAL_RECONSTRUCTION_STATUS.json`](https://github.com/aisknab/pnp/blob/3d6af7f46b8dea7b58f5d25076b49842ae2bdb5e/status/FORMAL_RECONSTRUCTION_STATUS.json)
> and [`docs/FORMAL_RECONSTRUCTION.md`](https://github.com/aisknab/pnp/blob/3d6af7f46b8dea7b58f5d25076b49842ae2bdb5e/docs/FORMAL_RECONSTRUCTION.md).
...
| Milestone earning | Check all 100 reviewed theorem kinds, kernel-type fingerprints, empty axiom closures, and the full Lean-source digest. | Same-name type weakening, an added axiom, an absent theorem, or source drift still earns a milestone. |
...
| Non-claim boundary | Confirm nine earned scoped milestones, including `CNFSAT ∈ NP` and bounded internal pipeline-stage bridges, three unearned global milestones, four project axioms, and seven blockers. Confirm that target termination, terminal packing, complete raw refinement, an external input-size polynomial, CNF-SAT in P, and NP-completeness remain false. | A supplied-trace/internal-handoff result is widened into a complete compiler, a local/conditional result is presented as global, or a blocker/axiom is hidden. |
