...
> notice are [`status/FORMAL_RECONSTRUCTION_STATUS.json`](https://github.com/aisknab/pnp/blob/aa888e54beeff5be0162415fa962f80b4b18d113/status/FORMAL_RECONSTRUCTION_STATUS.json)
> and [`docs/FORMAL_RECONSTRUCTION.md`](https://github.com/aisknab/pnp/blob/aa888e54beeff5be0162415fa962f80b4b18d113/docs/FORMAL_RECONSTRUCTION.md).
...
| Milestone earning | Check all 2,145 reviewed theorem kinds, kernel-type fingerprints, permitted Lean-standard axiom closures, absence of project axioms, and the full Lean-source digest. | Same-name type weakening, an unapproved axiom, an absent theorem, or source drift still earns a milestone. |
...
| Non-claim boundary | Confirm seventy-seven earned scoped milestones. The newest scope proves exact signed transfer arithmetic for four supplied terminal-profile corners under one observer and one projection, plus the constant-cut and positive-defect consequences. It does not construct or certify a proper governed support square. Three global milestones, four project axioms, and six blockers remain. Proper or governed supports, arbitrary manuscript quotient construction, saturation, BCEL/BN2–BN6, route completeness, `ZeroSlack`, PCCMin exactness and polynomial runtime, SAT NP-hardness or CNF-SAT NP-completeness, abstract threshold discharge, CNF-SAT in P, and `P = NP` must remain absent. | Supplied four-corner arithmetic is presented as a support-square construction, saturation theorem, polynomial minimizer, complete gain route, CNF-SAT decider, assumption discharge, or final theorem; a local/conditional result is presented as global; or a blocker/axiom is hidden. |
