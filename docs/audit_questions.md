...
> notice are [`status/FORMAL_RECONSTRUCTION_STATUS.json`](https://github.com/aisknab/pnp/blob/e355c176bd0e961b5db41dd11fc5b2ccfe6642fb/status/FORMAL_RECONSTRUCTION_STATUS.json)
> and [`docs/FORMAL_RECONSTRUCTION.md`](https://github.com/aisknab/pnp/blob/e355c176bd0e961b5db41dd11fc5b2ccfe6642fb/docs/FORMAL_RECONSTRUCTION.md).
...
| Milestone earning | Check all 2,152 reviewed theorem kinds, kernel-type fingerprints, permitted Lean-standard axiom closures, absence of project axioms, and the full Lean-source digest. | Same-name type weakening, an unapproved axiom, an absent theorem, or source drift still earns a milestone. |
...
| Non-claim boundary | Confirm seventy-eight earned scoped milestones. The newest scope proves complete closure laws for every finite terminal primitive-record universe under an explicitly supplied rule-tagged dependency relation. It does not derive those dependencies from arbitrary circuits or construct and certify a proper governed support square. Three global milestones, four project axioms, and six blockers remain. Proper or governed support construction, support completion, square legitimacy, BCEL/BN2–BN6, route completeness, `ZeroSlack`, PCCMin exactness and polynomial runtime, SAT NP-hardness or CNF-SAT NP-completeness, abstract threshold discharge, CNF-SAT in P, and `P = NP` must remain absent. | Generic finite closure is presented as an arbitrary-circuit dependency derivation, proper-support or square construction, polynomial minimizer, complete gain route, CNF-SAT decider, assumption discharge, or final theorem; a local/conditional result is presented as global; or a blocker/axiom is hidden. |
