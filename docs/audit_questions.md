...
> notice are [`status/FORMAL_RECONSTRUCTION_STATUS.json`](https://github.com/aisknab/pnp/blob/df4f4d830f6a0fd44af51edb0be178652d1b9417/status/FORMAL_RECONSTRUCTION_STATUS.json)
> and [`docs/FORMAL_RECONSTRUCTION.md`](https://github.com/aisknab/pnp/blob/df4f4d830f6a0fd44af51edb0be178652d1b9417/docs/FORMAL_RECONSTRUCTION.md).
...
| Milestone earning | Check all 2,341 reviewed theorem kinds, kernel-type fingerprints, permitted Lean-standard axiom closures, absence of project axioms, and the full Lean-source digest. | Same-name type weakening, an unapproved axiom, an absent theorem, or source drift still earns a milestone. |
...
| Non-claim boundary | Confirm eighty-eight earned scoped milestones. The newest scope places all four independently attained corner optima on one reversible common carrier, preserving exact semantics, gate counts, reference minima, and a shared observer projection. Three global milestones, four project axioms, and six blockers remain. Coherent transport along the square legs, one coherent four-corner minimum basis, side-tight completion, square legitimacy, complete obstruction routing, global gain completeness, BCEL/BN2-BN6, route completeness, `ZeroSlack`, PCCMin exactness and polynomial runtime, SAT NP-hardness or CNF-SAT NP-completeness, abstract threshold discharge, CNF-SAT in P, and `P = NP` must remain absent. | Independently placed optima are presented as one coherent optimum, manuscript square legitimacy, a global gain-completeness theorem, polynomial minimizer, complete gain route, CNF-SAT decider, assumption discharge, or final theorem; or a blocker/axiom is hidden. |
