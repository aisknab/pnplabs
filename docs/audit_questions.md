...
> notice are [`status/FORMAL_RECONSTRUCTION_STATUS.json`](https://github.com/aisknab/pnp/blob/e4131888da7a1d204fb18b0b4988be022682ab95/status/FORMAL_RECONSTRUCTION_STATUS.json)
> and [`docs/FORMAL_RECONSTRUCTION.md`](https://github.com/aisknab/pnp/blob/e4131888da7a1d204fb18b0b4988be022682ab95/docs/FORMAL_RECONSTRUCTION.md).
...
| Milestone earning | Check all 299 reviewed theorem kinds, kernel-type fingerprints, permitted Lean-standard axiom closures, absence of project axioms, and the full Lean-source digest. | Same-name type weakening, an unapproved axiom, an absent theorem, or source drift still earns a milestone. |
...
| Non-claim boundary | Confirm nineteen earned scoped milestones, including `CNFSAT ∈ NP`, raw-machine compilation, exact Cook-Levin generated-CNF semantics, the actual encoded-formula size polynomial, the answer-independent rectangular schedule, and the direct coordinate cursor with exact fuelled traversal, plus three unearned global milestones, four project axioms, and six blockers. Confirm that constant-time raw slot interpretation, a raw formula builder and construction-runtime polynomial, `FunctionProgram.RawRefinement`, packaged polynomial reduction, CNF-SAT in P, and NP-completeness remain absent. | A specification cursor, schedule, or output-size theorem is widened into a raw construction-runtime or reduction theorem, a local/conditional result is presented as global, or a blocker/axiom is hidden. |
