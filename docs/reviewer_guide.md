...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current seventy-one-page report;
...
the manuscript at the pinned 7072f8d source tag, never to the current seventy-one-page report.
