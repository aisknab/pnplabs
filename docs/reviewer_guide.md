...
The canonical report downloads are now a 157-page, non-claiming report generated from a compiled
Lean theorem inventory. The inventory contains 32,888 public declarations across 338 modules,
including 16,820 theorem-kind declarations, 7,967 assumption-free theorem-kind declarations, and no
project-specific axioms. Exactly 15,713 private compiler auxiliaries are excluded explicitly.
...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current 157-page report;
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `4d5a16953633943eaaea7605aff1ad04f1a65424`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 3,158 reviewed milestone declarations at its exact kernel type.
...
The formal inventory earns 194 scoped milestones: the concrete bitstring/machine/cost kernel,
...
the manuscript at the pinned 7072f8d source tag, never to the current 157-page report.
