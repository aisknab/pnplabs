...
The canonical report downloads are now a 158-page, non-claiming report generated from a compiled
Lean theorem inventory. The inventory contains 32,961 public declarations across 339 modules,
including 16,865 theorem-kind declarations, 7,980 assumption-free theorem-kind declarations, and no
project-specific axioms. Exactly 15,738 private compiler auxiliaries are excluded explicitly.
...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current 158-page report;
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `4ccb40cb06ceeb2c375f072f16826a3fd4ae945f`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 3,159 reviewed milestone declarations at its exact kernel type.
...
The formal inventory earns 195 scoped milestones: the concrete bitstring/machine/cost kernel,
...
the manuscript at the pinned 7072f8d source tag, never to the current 158-page report.
