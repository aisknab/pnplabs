...
The canonical report downloads are now a 154-page, non-claiming report generated from a compiled
Lean theorem inventory. The inventory contains 32,720 public declarations across 334 modules,
including 16,715 theorem-kind declarations, 7,949 assumption-free theorem-kind declarations, and no
project-specific axioms. Exactly 15,690 private compiler auxiliaries are excluded explicitly.
...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current 154-page report;
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `1f749eec50cb57c0595b1fa1e8dfc8ccd497c2e8`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 3,154 reviewed milestone declarations at its exact kernel type.
...
the manuscript at the pinned 7072f8d source tag, never to the current 154-page report.
