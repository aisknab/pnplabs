...
Lean theorem inventory. The inventory contains 27,837 public declarations across 251 modules,
including 14,470 theorem-kind declarations, 7,347 assumption-free theorem-kind declarations, and four
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `d677d7704c29642490b9262b48139f9f3eb097dd`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 2,597 reviewed milestone declarations at its exact kernel type.
...
The formal inventory earns one hundred and ten scoped milestones: the concrete bitstring/machine/cost kernel,
