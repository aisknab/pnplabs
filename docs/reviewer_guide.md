...
The canonical report downloads are now an eighty-seven-page, non-claiming report generated from a compiled
Lean theorem inventory. The inventory contains 27,734 public declarations across 249 modules,
including 14,432 theorem-kind declarations, 7,342 assumption-free theorem-kind declarations, and four
disclosed project axioms. Exactly 15,005 private compiler auxiliaries are excluded explicitly.
...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current eighty-seven-page report;
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `a46bc46175186748592af32661641fc232dae109`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 2,577 reviewed milestone declarations at its exact kernel type.
...
The formal inventory earns one hundred and eight scoped milestones: the concrete bitstring/machine/cost kernel,
...
the manuscript at the pinned 7072f8d source tag, never to the current eighty-seven-page report.
