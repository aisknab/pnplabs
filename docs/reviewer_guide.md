...
The canonical report downloads are now a fifty-seven-page, non-claiming report generated from a compiled
Lean theorem inventory. The inventory contains 11,301 public declarations across 99 modules,
including 6,482 theorem-kind declarations, 3,474 assumption-free theorem-kind declarations, and four
disclosed project axioms. Exactly 4,349 private compiler auxiliaries are excluded explicitly.
...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current fifty-seven-page report;
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `cf0220e7e73b13b5b2639c3b6b0ec1b170090ecf`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 1799 reviewed milestone declarations at its exact kernel type.
...
The formal inventory earns fifty-six scoped milestones: the concrete bitstring/machine/cost kernel,
...
the manuscript at the pinned 7072f8d source tag, never to the current fifty-seven-page report.
