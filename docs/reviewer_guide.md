...
The canonical report downloads are now a 148-page, non-claiming report generated from a compiled
Lean theorem inventory. The inventory contains 31,762 public declarations across 326 modules,
including 16,126 theorem-kind declarations, 7,715 assumption-free theorem-kind declarations, and no
...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current 148-page report;
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `2a2c3bdab876d430f462bd357b76d0f2e21fc023`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 3,146 reviewed milestone declarations at its exact kernel type.
...
the manuscript at the pinned 7072f8d source tag, never to the current 148-page report.
