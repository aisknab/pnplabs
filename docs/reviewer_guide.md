...
The canonical report downloads are now a fifty-six-page, non-claiming report generated from a compiled
Lean theorem inventory. The inventory contains 11,178 public declarations across 98 modules,
including 6,388 theorem-kind declarations, 3,451 assumption-free theorem-kind declarations, and four
disclosed project axioms. Four thousand three hundred eight private compiler auxiliaries are excluded explicitly.
...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current fifty-six-page report;
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `9d2bff977cfc3ad5dbea9da60d46448276eea2cd`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 1764 reviewed milestone declarations at its exact kernel type.
...
The formal inventory earns fifty-five scoped milestones: the concrete bitstring/machine/cost kernel,
...
the manuscript at the pinned 7072f8d source tag, never to the current fifty-six-page report.
