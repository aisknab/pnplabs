...
The canonical report downloads are now a sixty-page, non-claiming report generated from a compiled
Lean theorem inventory. The inventory contains 11,688 public declarations across 102 modules,
including 6,779 theorem-kind declarations, 3,551 assumption-free theorem-kind declarations, and four
disclosed project axioms. Exactly 4,464 private compiler auxiliaries are excluded explicitly.
...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current sixty-page report;
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `59d89b6b07ae16e649cda19dfeb3c78b335397ea`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 1,909 reviewed milestone declarations at its exact kernel type.
...
The formal inventory earns fifty-nine scoped milestones: the concrete bitstring/machine/cost kernel,
...
the manuscript at the pinned 7072f8d source tag, never to the current sixty-page report.
