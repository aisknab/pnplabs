...
The canonical report downloads are now a seventy-six-page, non-claiming report generated from a compiled
Lean theorem inventory. The inventory contains 24,485 public declarations across 224 modules,
including 13,183 theorem-kind declarations, 6,956 assumption-free theorem-kind declarations, and four
disclosed project axioms. Exactly 14,594 private compiler auxiliaries are excluded explicitly.
...
- [`downloads/canonical_proof_report.pdf`](../downloads/canonical_proof_report.pdf): current seventy-six-page report;
...
1. Reproduce the pinned Lean build in `aisknab/pnp` at merged commit
   `23abd2eaf8913ea91dc1cf379878f278b9ee3d10`.
2. Re-export the inventory and compare it byte-for-byte with
   `public/pnp-theorem-inventory.json`.
3. Inspect every one of the 2,279 reviewed milestone declarations at its exact kernel type.
...
The formal inventory earns eighty-five scoped milestones: the concrete bitstring/machine/cost kernel,
...
exact governed frontier gluing; and exact commutation of that governed structure with every forgetful
terminal projection.
...
the manuscript at the pinned 7072f8d source tag, never to the current seventy-six-page report.
