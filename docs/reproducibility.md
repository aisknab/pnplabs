...
| File | Bytes | SHA-256 |
| --- | ---: | --- |
| `downloads/canonical_proof_report.pdf` | 620,539 | `b1e3ee42026828c211d0e333ed3353b698405f773acd812869bdf2898f76463d` |
| `downloads/canonical-proof-report.pdf` | 620,539 | `b1e3ee42026828c211d0e333ed3353b698405f773acd812869bdf2898f76463d` |
| `downloads/canonical_proof_report.tex` | 403,339 | `d78537fb9eb84f9a6571702f9abd1334db2663db3494a4c96f3b2f3e1b48784b` |
| `downloads/canonical-proof-report.tex` | 403,339 | `d78537fb9eb84f9a6571702f9abd1334db2663db3494a4c96f3b2f3e1b48784b` |
| `public/pnp-status.json` | 2,786,860 | `547051bde02ac4b5cddc5a0493c1559bedace7a1631567c345992599f3e41532` |
| `public/pnp-theorem-inventory.json` | 47,801,161 | `5f73c0300fe08e74588706ee2d187182e451403e72322af26327bc529fb016fa` |
| `public/pnp-proof-progress.json` | 123,385 | `e3d450d7d51c7174c0cf4a8358fbaa9f55a13aecfa8bed2857bf63fc943c17ae` |

The PDF must have 160 A4 pages. Both filename styles must be byte-identical.
...
git -C ../pnp checkout 71199826f380c39fa59796f0d9025651e34e1fe0
...
Expected compiled inventory counts are 33,114 public declarations, 16,960 theorem-kind declarations,
8,022 assumption-free theorem-kind declarations, 15,758 excluded private auxiliaries, 341 modules, and
