...
| File | Bytes | SHA-256 |
| --- | ---: | --- |
| `downloads/canonical_proof_report.pdf` | 618,661 | `f6c1d288404404d6552dc738188bb3898954a982d75659be416210657cd05c8a` |
| `downloads/canonical-proof-report.pdf` | 618,661 | `f6c1d288404404d6552dc738188bb3898954a982d75659be416210657cd05c8a` |
| `downloads/canonical_proof_report.tex` | 401,638 | `dc3d9255f0658e9809821ff2115435e78231f47adb2ed55a75120667e7a33947` |
| `downloads/canonical-proof-report.tex` | 401,638 | `dc3d9255f0658e9809821ff2115435e78231f47adb2ed55a75120667e7a33947` |
| `public/pnp-status.json` | 2,781,472 | `610456576f0873e96cb91b0599e0d26f9d3dc1194c2b236c47b247e68a311c72` |
| `public/pnp-theorem-inventory.json` | 47,782,517 | `1dba57fd8f10f12ad8fc814e99beff4b3092b0a9118485265041ab8a8e2b2bf6` |
| `public/pnp-proof-progress.json` | 119,150 | `45dc5fce6cda576cd7db266bfe4c8afc2630ea134de62bfe33061c6e543741dc` |

The PDF must have 159 A4 pages. Both filename styles must be byte-identical.
...
git -C ../pnp checkout c674c21b994284cdf6df40b43bf1a22920d0ec98
...
Expected compiled inventory counts are 33,068 public declarations, 16,928 theorem-kind declarations,
8,017 assumption-free theorem-kind declarations, 15,750 excluded private auxiliaries, 340 modules, and
...
The latest M220 all-coordinate physical Cook-Levin classifier-pipeline milestone has 1 reviewed theorem pin. For every concrete verifier problem, every canonical post-header coordinate and arbitrary protected builder workspace, one fixed collision-free 711-rule machine composes M213's router-to-divider bridge, M211's divider, M214's divider-to-comparator bridge and comparator, and three fixed launch transitions. Three exact physical tape handoffs preserve the workspace suffix, the final raw state agrees with M214's typed body-or-Finish semantics, and exact work, six-for-one compiled execution, one-step-short nonhalting, component decomposition and one source-size polynomial bound are proved. All 63 public declarations are axiom-audited: 44 have empty closure, four use only propext, and 15 use only propext and Quot.sound, with no project axiom or Classical.choice. The endpoint uses only Lean-standard `Quot.sound` and `propext`; its focused 63-declaration audit is free of project-specific axioms and `Classical.choice`. This milestone physically composes the complete suffix-preserving classifier pipeline for every canonical post-header coordinate. It does not derive body-token or padding request symbols, connect the resulting body or Finish classification to M217's request dispatcher, iterate one literal raw-machine schedule loop, construct the complete raw formula builder or its FunctionProgram.RawRefinement, or package the concrete Cook-Levin PolynomialReduction. It does not establish CNFSAT NP-hardness or NP-completeness transport or CNFSAT in P, close a fixed checkpoint or global gate, create the eligible root theorem, or prove P = NP. No fixed weighted checkpoint changes, so the risk-weighted estimate remains 35% while formal artefact coverage becomes 196 of 198. All five global gates remain open.
