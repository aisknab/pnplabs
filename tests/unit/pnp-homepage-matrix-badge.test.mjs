...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'turns an accepted description into the larger comparison circuit',
    'TargetEmitterControllerTotalTrace.allInput_bounded_exact',
    'compiledMachineOutput_eq_targetBytes',
    'strictLockedNANDPolynomialTimeFunction_output',
    '1,387,921 pairwise query-distinct rules',
    'running time and output size are bounded by explicit formulas',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-29-91',
    'About 54% of the known formalisation work',
    ...
    'Packaging their semantic equivalence as a concrete reduction',
