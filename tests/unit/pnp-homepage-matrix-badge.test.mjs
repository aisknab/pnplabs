...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'the machine writes the closing mark that finishes the next item',
    'BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.workRunExact',
    'encodedFormula.take (2 * (FormulaWidth + 43 + if tapeWidth = 1 then 0 else 5))',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-24-81',
    'About 44% of the known formalisation work',
