...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-20-63',
    '9,336 exported public declarations',
    ...
    'separator beginning clause four',
    'following <code>F</code> coordinate',
    ...
    'Current thirty-nine-page report',
    '6 active',
