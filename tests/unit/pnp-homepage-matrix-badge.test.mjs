...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'exact equality-fibre multiplicity coverage',
    ...
    'Lean now materializes finite typed PkgC restorations',
    'updates.html#2026-08-12-residual-terminal-pkgc-typed-restoration',
    'Technical theorem boundary · gate closed · 5 blockers',
    'PNP.DirectWire.classifyTerminalPkgCTypedRestoration_exhaustive',
    'The 92% figure is a revisable editorial estimate',
    'About 92% of the known formalisation work',
    ...
    'Machine checking now realizes explicit finite typed PkgC restorations, but does not construct the restoration operation or complete PkgC.',
