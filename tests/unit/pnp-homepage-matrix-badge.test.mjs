...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'This turns an abstract outline into a concrete family',
    'PNP.DirectWire.LockedNANDGlobalCandidates.fullCandidate_final_semantics',
    'carrier <code>B/B</code>',
    'preserve all <code>B</code> baseline outputs',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-26-85',
    'About 48% of the known formalisation work',
    ...
    'Cross-instance separation, the conditional final-output branch laws',
