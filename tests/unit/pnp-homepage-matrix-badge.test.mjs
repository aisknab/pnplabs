...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-15-42',
    '6,800 exported public declarations',
    ...
    'This remains a Lean specification cursor: constant-time raw slot interpretation',
