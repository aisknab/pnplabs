...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-21-67',
    '9,906 exported public declarations',
    ...
    'traverses the remaining <code>FormulaTokensPerClause - 9</code> clause-four padding slots',
    'blank first slot of the intentionally empty fifth clause rectangle',
    ...
    'Current forty-three-page report',
    '6 active',
