...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'A reduction is a reliable translation from one yes-or-no problem into another.',
    'proves, for every possible input, that the original circuit has a successful input exactly when the translated comparison passes its threshold',
    ...
    'runs within an explicit polynomial limit',
    'not yet ordinary CNF-SAT',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-30-92',
    'About 55% of the known formalisation work',
