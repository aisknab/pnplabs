...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'Every finite NAND circuit now has one checkable trace layout',
    'This is a rule for circuits of any finite size',
    'PNP.DirectWire.LockedNANDTrace.traceEquivalence',
    'inputs + 6 × gates + 1',
    'exactly three distinguished checks per gate',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-25-84',
    'About 47% of the known formalisation work',
    ...
    'The complete exposed locked-NAND candidates, cross-instance separation and output laws',
