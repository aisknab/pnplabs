...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'complete two-anchor, three-anchor, and four-or-more-anchor classification',
    ...
    'Lean now proves finite V53 constant-cut hypergraph rigidity',
    'updates.html#2026-08-11-residual-terminal-constant-cut-hypergraph-rigidity',
    'Technical theorem boundary · gate closed · 5 blockers',
    'PNP.DirectWire.terminalV53_constantCut_hypergraph_rigidity',
    'The 89% figure is a revisable editorial estimate',
    'About 89% of the known formalisation work',
    ...
    'Machine checking now proves the V53 constant-cut classification, but not the construction that would supply it.',
