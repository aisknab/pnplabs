...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-20-61',
    '9,117 exported public declarations',
    ...
    'complete fixed third clause',
    'first directly proved padding slot',
    ...
    'Current thirty-six-page report',
    '6 active',
