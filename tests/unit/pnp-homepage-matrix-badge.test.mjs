...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'In wider layouts it writes the opening mark for the following item',
    'BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.workRunExact',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-24-82',
    'About 45% of the known formalisation work',
