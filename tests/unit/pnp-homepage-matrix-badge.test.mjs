...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'pair, mixed three-anchor, or four-or-more-anchor full-span classification',
    ...
    'Lean now connects grouped V54 survivors to a finite BN6 packet classification',
    'updates.html#2026-08-12-residual-terminal-bn6-hypergraph-packet',
    'Technical theorem boundary · gate closed · 5 blockers',
    'PNP.DirectWire.terminalBN6_hypergraph_packet',
    'The 90% figure is a revisable editorial estimate',
    'About 90% of the known formalisation work',
    ...
    'Machine checking now connects explicit grouped V54 survivors to a finite BN6 packet classification, but does not construct those survivors.',
