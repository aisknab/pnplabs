...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'The proof now handles the case where the original circuit has no satisfying input',
    'the added final check always stays off',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-27-87',
    'About 50% of the known formalisation work',
    ...
    'The successful-solution final-output law',
