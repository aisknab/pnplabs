...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'cross the target size threshold exactly when the original circuit has a solution',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-28-89',
    'About 52% of the known formalisation work',
    ...
    'a concrete polynomial-time reduction',
