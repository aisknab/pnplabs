...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'complete multiplicity coverage or a strict Hall deficit routed to local X1',
    ...
    'Lean now checks one finite BN5 full-shadow localization',
    'updates.html#2026-08-11-residual-terminal-bn5-full-shadow-localization',
    'Technical theorem boundary · gate closed · 5 blockers',
    'PNP.DirectWire.classifyTerminalBN5FullShadowLocalization_exhaustive',
    'The 87% figure is a revisable estimate of known reconstruction work',
    'About 87% of the known formalisation work',
