...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'Lean now defines that process for any finite checklist and any explicitly supplied dependency links.',
    'terminalSaturate_closed',
    'fixed points are exactly the already closed supports',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-08-04-101',
    'About 64% of the known formalisation work',
