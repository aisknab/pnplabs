...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-16-46',
    '7,054 exported public declarations',
    '3,249 theorem-kind declarations',
    '2,636 assumption-free theorem-kind declarations',
    ...
    'BuilderFirstTokenPrefix.workRunExact',
    'first two canonical formula bits',
    '18*n*n + 87*n + 147',
    'remaining width header',
