...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'examine every possible starting selection from a supplied finite dependency system',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-08-05-104',
    'About 67% of the known formalisation work',
