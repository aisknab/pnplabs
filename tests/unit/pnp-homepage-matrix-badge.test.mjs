...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'complete multiplicity coverage or a strict Hall deficit with a deterministic local Q route',
    ...
    'Lean now classifies finite PkgC separating consumers into singletonization or restoration',
    'updates.html#2026-08-12-residual-terminal-pkgc-separating-consumers',
    'Technical theorem boundary · gate closed · 5 blockers',
    'PNP.DirectWire.terminalPkgC_separatingConsumers_restorationDichotomy',
    'The 91% figure is a revisable editorial estimate',
    'About 91% of the known formalisation work',
    ...
    'Machine checking now classifies explicit finite PkgC separating consumers into singletonization or restoration, but does not construct the inputs or complete PkgC.',
