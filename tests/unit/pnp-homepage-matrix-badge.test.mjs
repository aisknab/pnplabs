...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'two-sided cut activation is nonzero exactly when two consumers are disjoint',
    ...
    'Lean now proves one finite V54 consumer-antichain normal form',
    'updates.html#2026-08-11-residual-terminal-consumer-antichain-normal-form',
    'Technical theorem boundary · gate closed · 5 blockers',
    'PNP.DirectWire.terminalV54_consumerAntichain_normal_form',
    'The 88% figure is a revisable estimate of known reconstruction work',
    'About 88% of the known formalisation work',
