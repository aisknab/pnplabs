...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'This update considers four related cases—the common part, two alternatives, and their combined case',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-08-04-100',
    'About 63% of the known formalisation work',
