...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'there is no smaller equivalent circuit anywhere exactly when the current circuit is already as small as possible',
    'only when a separate proof rules out every smaller equivalent circuit',
    'residualSlack_eq_zero_iff_forall_not_strictEquivalentGain',
    'This is a semantic stopping criterion, not a stopping algorithm or finite-search completeness theorem',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-08-03-96',
    'About 59% of the known formalisation work',
