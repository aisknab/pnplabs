...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'select any collection of operations—even a scattered collection—and turn that selection into a smaller circuit of its own',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-08-05-103',
    'About 66% of the known formalisation work',
