...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-15-43',
    '6,849 exported public declarations',
    '3,104 theorem-kind declarations',
    '2,560 assumption-free theorem-kind declarations',
    ...
    '2*n*n + 4*n + 2',
    '12*n*n + 24*n + 12',
    'This stage does not emit formula bits',
    'complete a raw formula builder',
    'A packaged polynomial reduction, CNF-SAT NP-completeness, CNF-SAT in P, and P = NP remain absent',
    'concretePublicationGate.passed = false',
    'Current fourteen-page report',
    '6 active',
