...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-20-60',
    '9,024 exported public declarations',
    ...
    'complete negative literal on variable two in clause three',
    'following directly proved <code>Finish</code> slot',
    ...
    'Current thirty-five-page report',
    '6 active',
