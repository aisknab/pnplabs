...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'the minimum size rises above the baseline exactly when the original circuit has a solution',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-28-88',
    'About 51% of the known formalisation work',
    ...
    'The encoded polynomial-time circuit builder',
