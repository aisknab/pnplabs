...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'it writes the second mark of the next numbered item',
    'BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.workRunExact',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-23-78',
    'About 41% of the known formalisation work',
