...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'A CNF formula is a list of yes-or-no requirements',
    'proves that a solution exists before the translation exactly when one exists afterward',
    'compileEncodedCNFToNAND_correct',
    'compileFormula_gateCount_exact',
    'buildLockedNANDFromCNF_correct',
    'polynomial limit on the output size',
    'not yet a compiled finite work machine',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-31-93',
    'About 56% of the known formalisation work',
