...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'Ignoring details can never make the smallest matching circuit larger.',
    'terminalProjectionDefect_eq_zero_iff_exists_checkedFullLiftAtMinimum',
    'The full and quotient minima are computed by exhaustive finite scans',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-08-04-99',
    'About 62% of the known formalisation work',
