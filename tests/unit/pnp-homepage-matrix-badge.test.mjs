...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'another circuit counts as equivalent only when it gives the same answer for every possible input and every output',
    'any cheaper complete equivalent circuit is genuine progress toward the smallest one',
    'residualSlack_eq_zero_iff_no_wholeSpanResidualWitness',
    'This is the direct-wire full-mode bridge',
    ...
    'About 60% of the known formalisation work',
