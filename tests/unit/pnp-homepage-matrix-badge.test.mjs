...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-15-44',
    '6,901 exported public declarations',
    ...
    'totalInputFramerWorkSteps(input) + 1 + 2*n*n + 4*n + 2',
    '18*n*n + 63*n + 93',
    'This prefix does not emit formula bits',
