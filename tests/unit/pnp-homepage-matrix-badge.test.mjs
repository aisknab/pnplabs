...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'one canonical duplicate-free list of request identities across every proper cut',
    ...
    'Lean now constructs one finite BN3 request envelope',
    'updates.html#2026-08-10-residual-terminal-bn3-request-envelope',
    'Technical theorem boundary · gate closed · 5 blockers',
    'PNP.DirectWire.classifyTerminalBN3RequestEnvelope_exhaustive',
    'The 85% figure is a revisable estimate of known reconstruction work',
    'About 85% of the known formalisation work',
