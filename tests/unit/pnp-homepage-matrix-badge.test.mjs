...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'when every step is independently checked to keep all answers the same and to use fewer operations',
    'that starting gap is at most four',
    'does not find the next smaller circuit',
    'StrictGainChain.end_residualSlack_add_length_le',
    'does not generate gains, prove search completeness, justify early stopping, construct ZeroSlack',
