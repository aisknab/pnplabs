...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'Starting from any two finite selections and a supplied dependency rulebook',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-08-06-105',
    'About 68% of the known formalisation work',
