...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'it writes the first mark of the next numbered item',
    'BuilderSecondConstraintPaddingOrUnaryOpportunityStep.workRunExact',
    'encodedFormula.take (2 * (FormulaWidth + 43 + if tapeWidth = 1 then 0 else 1))',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-23-77',
    'About 40% of the known formalisation work',
