...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-18-54',
    '8,229 exported public declarations',
    ...
    'Earlier stages retain the exact Cook-Levin schedule',
    'BuilderSecondClauseFirstLiteralPrefix.workRunExact',
    'encodedFormula.take (2 * (FormulaWidth + 15))',
    'secondClauseStart + 3',
    'complete negative literal on variable zero',
    ...
    'Current twenty-eight-page report',
    '6 active',
