...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'it writes the third mark of the next numbered item',
    'BuilderSecondConstraintThirdPaddingOrUnaryOpportunityStep.workRunExact',
    'encodedFormula.take (2 * (FormulaWidth + 43 + if tapeWidth = 1 then 0 else 3))',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-24-79',
    'About 42% of the known formalisation work',
