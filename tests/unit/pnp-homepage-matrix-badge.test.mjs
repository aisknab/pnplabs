...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-21-64',
    '9,474 exported public declarations',
    ...
    'complete first negative literal <code>F T F</code> in clause four',
    'direct lookup is the next <code>F</code>',
