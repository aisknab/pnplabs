...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-22-68',
    '10,049 exported public declarations',
    ...
    'traverses the entire intentionally empty fifth clause rectangle without emitting a token',
    'padding in the intentionally empty sixth clause rectangle',
    ...
    'Current forty-four-page report',
    '6 active',
