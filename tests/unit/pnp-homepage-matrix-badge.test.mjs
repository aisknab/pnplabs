...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'it writes the fourth and final number mark of the next item',
    'BuilderSecondConstraintFourthPaddingOrUnaryOpportunityStep.workRunExact',
    'encodedFormula.take (2 * (FormulaWidth + 43 + if tapeWidth = 1 then 0 else 4))',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-24-80',
    'About 43% of the known formalisation work',
