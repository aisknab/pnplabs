...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'identify every wire that brings a value into the group or carries a result out',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-08-05-102',
    'About 65% of the known formalisation work',
