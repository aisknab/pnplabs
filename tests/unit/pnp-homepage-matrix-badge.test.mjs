...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'Only that closing mark is added.',
    'BuilderSecondConstraintFirstLiteralTerminatorStep.workRunExact',
    'encodedFormula.take (2 * (FormulaWidth + 42))',
    'direct next token is <code>Finish</code>',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-23-75',
    'About 38% of the known formalisation work',
