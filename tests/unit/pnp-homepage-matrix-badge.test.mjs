...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    '228 states and 2,052 pairwise query-distinct rules',
    '6 × 4096 × (n+1)^3',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-29-90',
    'About 53% of the known formalisation work',
    ...
    'composed polynomial-time reduction',
