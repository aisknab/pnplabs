...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'It does not write the next item&#39;s number',
    'BuilderSecondConstraintFirstLiteralSuccessorTokenStep.workRunExact',
    'encodedFormula.take (2 * (FormulaWidth + 43))',
    'emits exactly <code>Finish</code> at width one or <code>T</code> at wider widths',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-23-76',
    'About 39% of the known formalisation work',
