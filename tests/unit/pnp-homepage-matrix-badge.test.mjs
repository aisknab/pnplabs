...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'exact singleton activation codes and compares complete typed cancellation keys',
    ...
    'Lean now checks one finite BN4 cancellation ledger',
    'updates.html#2026-08-11-residual-terminal-bn4-activation-cancellation',
    'Technical theorem boundary · gate closed · 5 blockers',
    'PNP.DirectWire.classifyTerminalBN4ActivationCancellation_exhaustive',
    'The 86% figure is a revisable estimate of known reconstruction work',
    'About 86% of the known formalisation work',
