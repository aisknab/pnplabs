...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-21-65',
    '9,661 exported public declarations',
    ...
    'complete second negative literal <code>F T T F</code> in clause four',
    'direct lookup is the next <code>Finish</code>',
