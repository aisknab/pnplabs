...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'The proposed route compares four related smallest circuit views',
    'fixed checklist',
    'first local mismatch',
    'sideTightCompletionExists',
    'sideTightCompletionOrFirstRoute',
    'exact minimum incidence result',
    'has not proved that this happens for every square',
    'complete obstruction route',
    ...
    'About 75% of the known formalisation work',
