...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'Only that final number mark is added.',
    'BuilderSecondConstraintFirstLiteralThirdUnaryUnitStep.workRunExact',
    'encodedFormula.take (2 * (FormulaWidth + 41))',
    'whose direct token is the terminating <code>F</code>',
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-23-74',
    'About 37% of the known formalisation work',
