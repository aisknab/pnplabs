...
test('homepage leads with a plain, conservative result and the latest milestone', async () => {
  ...
  for (const fragment of [
    ...
    'Each view can have several different designs tied for the smallest size',
    'every possible four-way combination',
    'tightBasisMaximum?_eq_delta',
    'mem_minimumImplementationBases_iff',
    'mem_tightBasisFamily_iff',
    'signed maximum equals the selected delta',
    'has not proved that every square passes the local check',
    'complete global obstruction system',
    ...
    'About 76% of the known formalisation work',
