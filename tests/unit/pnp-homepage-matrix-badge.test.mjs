...
test('homepage publishes the conservative current theorem boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-17-49',
    '7,626 exported public declarations',
    ...
    'firstLiteralTokens_eq_canonical_formula_prefix',
    ...
    'Current twenty-one-page report',
    '6 active',
