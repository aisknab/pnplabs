...
test('M223 remains a versioned historical publication card after M224', () => {
  ...
  assert.match(card, /reflected Finish dispatch/i);
  assert.match(card, /formal artefact coverage becomes 199 of 201/i);
