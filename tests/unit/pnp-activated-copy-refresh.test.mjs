...
test('shared site script applies the compiled-inventory publication boundary', async () => {
  ...
  for (const fragment of [
    ...
    'Per-cut BN2 basis existence does not construct the cross-cut-stable BN3 request envelope.',
    'The BN3 joint-realizability gap is now pinned by a kernel-checkable logical boundary witness',
