...
test('shared site script applies conservative formal-reconstruction copy', async () => {
  ...
  for (const fragment of [
    ...
    'conditional threshold deduction checked',
    'six global premises uninstantiated',
    'the new theorem is proof-bearing but conditional',
    'answer-independent polynomial builder',
