...
test('shared site script applies the compiled-inventory publication boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-17-51',
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-17-51',
    '55bdc78e21d82d345abbf26abce55450192867bda294a7a6c6ca0548e1e41fc3',
    'declarations: 7845',
    'theorems: 3788',
