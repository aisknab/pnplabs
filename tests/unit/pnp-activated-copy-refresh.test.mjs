...
test('shared site script applies conservative formal-reconstruction copy', async () => {
  ...
  for (const fragment of [
    ...
    'five local locked-NAND square minima checked',
    'Counts are source-derived and the report word remains multi-output.',
    'Global cross-instance <code>BaselineDistinct</code>',
