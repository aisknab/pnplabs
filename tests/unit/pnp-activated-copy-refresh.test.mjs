...
test('shared site script applies the compiled-inventory publication boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-17-50',
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-17-50',
    'b8ea4ad0e08985129ef460b626e6822346907b0f90b789b51102757d80aa4a7e',
    'declarations: 7746',
    'theorems: 3725',
