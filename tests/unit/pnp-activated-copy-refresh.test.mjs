...
test('shared site script applies the compiled-inventory publication boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-14-39',
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-14-39',
    'e21338308fd667866efa3d003164b7fc1a454be160be384f24d23096c5c3350e',
    'declarations: 6306',
    'theorems: 2747',
