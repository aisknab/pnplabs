...
test('shared site script applies the compiled-inventory publication boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-12-23',
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-12-23',
    '6f5d04356e86d2c775f7913d5e8e8a891a59559a9dbc533f34ebfa18b619d1fc',
    'declarations: 5023',
    'theorems: 2081',
