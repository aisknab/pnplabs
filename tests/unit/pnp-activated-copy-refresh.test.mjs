...
test('shared site script applies the compiled-inventory publication boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-12-24',
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-12-24',
    '305398f65fe313a765351da012c2d167433591f114856422a62866918f3abdf6',
    'declarations: 5076',
    'theorems: 2125',
