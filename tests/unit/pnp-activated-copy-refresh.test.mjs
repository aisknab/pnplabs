...
test('shared site script applies the compiled-inventory publication boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-10-12',
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-10-12',
    'a38aac54fc7a117f46d42d2d45414d9bf3bbd301dd74a34cbbd0b61539229b4d',
    'declarations: 4419',
    'theorems: 1826',
