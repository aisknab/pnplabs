...
test('shared site script applies the compiled-inventory publication boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-10-11',
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-10-11',
    '2636c9dc883d307304fafc7efcc4bfd02912cb3587ed762a13fd0758d603c966',
    'declarations: 2168',
    'theorems: 789',
