...
test('shared site script applies the compiled-inventory publication boundary', async () => {
  ...
  for (const fragment of [
    ...
    'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-14-32',
    'PNP-LEAN-THEOREM-INVENTORY-2026-07-14-32',
    'f9bbb4c9aa21a72221d20e9327b900dd37a6cc62ea2919b5fc1a20dee1776921',
    'declarations: 5323',
    'theorems: 2282',
