...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 8094,
    theoremCount: 3974,
    assumptionFreeTheoremCount: 2939,
    excludedPrivateDeclarationCount: 2502,
    sourceClosureModuleCount: 73,
    axiomCount: 4,
    milestoneCandidates: [{
