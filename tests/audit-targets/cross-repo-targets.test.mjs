...
function makeProject(t) {
  ...
  const inventoryPayload = {
    ...
    declarationCount: 24675,
    theoremCount: 13260,
    assumptionFreeTheoremCount: 6984,
    excludedPrivateDeclarationCount: 14607,
    sourceClosureModuleCount: 226,
    axiomCount: 4,
    milestoneCandidates: [{
  ...
  assert.equal(inventoryPayload.milestoneCandidates.length, 2316, "synthetic inventory must match the published reviewed-candidate count");
