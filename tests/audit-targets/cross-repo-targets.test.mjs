...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 23671,
    theoremCount: 12853,
    assumptionFreeTheoremCount: 6809,
    excludedPrivateDeclarationCount: 14273,
    sourceClosureModuleCount: 212,
    axiomCount: 4,
    milestoneCandidates: [{
