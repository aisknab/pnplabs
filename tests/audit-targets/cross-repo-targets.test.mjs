...
const milestoneFieldParts = Object.freeze({ bn4: "BN4", bn5: "BN5", hb: "HB", hn: "HN" });
...
const BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_HASHES =
  publishedRelease.earnedBoundary.cookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStepTheoremKernelTypeSha256;
const BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES = Object.keys(BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_HASHES);
const BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES.includes(candidate.name)
);
const BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_NEW_CANDIDATES = BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_CANDIDATES.filter(
  (candidate) => !BUILDER_SECOND_CONSTRAINT_THIRD_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES.length, 40);
assert.equal(BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_CANDIDATES.length, 40);
assert.equal(BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_NEW_CANDIDATES.length, 35);
const PUBLISHED_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE = publishedStatus.formalPublicationMilestones.find(
  (row) => row.id === 'concrete-cook-levin-builder-second-constraint-fourth-padding-or-unary-opportunity-step'
);
assert.ok(PUBLISHED_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE);
const BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_THEOREM_HASHES =
  publishedRelease.earnedBoundary.cookLevinBuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStepTheoremKernelTypeSha256;
const BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_THEOREM_NAMES = Object.keys(BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_THEOREM_HASHES);
const BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_THEOREM_NAMES.includes(candidate.name)
);
const BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_NEW_CANDIDATES = BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_CANDIDATES.filter(
  (candidate) => !BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_THEOREM_NAMES.length, 40);
assert.equal(BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_CANDIDATES.length, 40);
assert.equal(BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_NEW_CANDIDATES.length, 40);
const PUBLISHED_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_MILESTONE = publishedStatus.formalPublicationMilestones.find(
  (row) => row.id === 'concrete-cook-levin-builder-second-constraint-fifth-padding-or-terminator-opportunity-step'
);
assert.ok(PUBLISHED_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_MILESTONE);
const BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_THEOREM_HASHES =
  publishedRelease.earnedBoundary.cookLevinBuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStepTheoremKernelTypeSha256;
const BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES = Object.keys(BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_THEOREM_HASHES);
const BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES.includes(candidate.name)
);
const BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_NEW_CANDIDATES = BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_CANDIDATES.filter(
  (candidate) => !BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES.length, 40);
assert.equal(BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_CANDIDATES.length, 40);
assert.equal(BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_NEW_CANDIDATES.length, 40);
const PUBLISHED_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_MILESTONE = publishedStatus.formalPublicationMilestones.find(
  (row) => row.id === 'concrete-cook-levin-builder-second-constraint-sixth-padding-or-opening-unary-opportunity-step'
);
assert.ok(PUBLISHED_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_MILESTONE);
const BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_HASHES =
  publishedRelease.earnedBoundary.cookLevinBuilderSecondConstraintSeventhPaddingOrUnaryOpportunityStepTheoremKernelTypeSha256;
const BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES = Object.keys(BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_HASHES);
const BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES.includes(candidate.name)
);
const BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_NEW_CANDIDATES = BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_CANDIDATES.filter(
  (candidate) => !BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES.length, 40);
assert.equal(BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_CANDIDATES.length, 40);
assert.equal(BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_NEW_CANDIDATES.length, 35);
const PUBLISHED_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE = publishedStatus.formalPublicationMilestones.find(
  (row) => row.id === 'concrete-cook-levin-builder-second-constraint-seventh-padding-or-unary-opportunity-step'
);
assert.ok(PUBLISHED_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE);
const LOCKED_NAND_CARRIER_TRACE_THEOREM_HASHES =
  publishedRelease.earnedBoundary.lockedNANDCarrierTraceTheoremKernelTypeSha256;
const LOCKED_NAND_CARRIER_TRACE_THEOREM_NAMES = Object.keys(LOCKED_NAND_CARRIER_TRACE_THEOREM_HASHES);
const LOCKED_NAND_CARRIER_TRACE_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => LOCKED_NAND_CARRIER_TRACE_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(LOCKED_NAND_CARRIER_TRACE_THEOREM_NAMES.length, 8);
assert.equal(LOCKED_NAND_CARRIER_TRACE_CANDIDATES.length, 8);
const PUBLISHED_LOCKED_NAND_CARRIER_TRACE_MILESTONE = publishedStatus.formalPublicationMilestones.find(
  (row) => row.id === 'locked-nand-global-carrier-trace-equivalence'
);
assert.ok(PUBLISHED_LOCKED_NAND_CARRIER_TRACE_MILESTONE);
const LOCKED_NAND_GLOBAL_CANDIDATE_THEOREM_HASHES =
  publishedRelease.earnedBoundary.lockedNANDGlobalCandidateTheoremKernelTypeSha256;
const LOCKED_NAND_GLOBAL_CANDIDATE_THEOREM_NAMES = Object.keys(LOCKED_NAND_GLOBAL_CANDIDATE_THEOREM_HASHES);
const LOCKED_NAND_GLOBAL_CANDIDATE_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => LOCKED_NAND_GLOBAL_CANDIDATE_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(LOCKED_NAND_GLOBAL_CANDIDATE_THEOREM_NAMES.length, 11);
assert.equal(LOCKED_NAND_GLOBAL_CANDIDATE_CANDIDATES.length, 11);
const PUBLISHED_LOCKED_NAND_GLOBAL_CANDIDATE_MILESTONE = publishedStatus.formalPublicationMilestones.find(
  (row) => row.id === 'locked-nand-global-candidate-assembly'
);
assert.ok(PUBLISHED_LOCKED_NAND_GLOBAL_CANDIDATE_MILESTONE);
const LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_THEOREM_HASHES =
  publishedRelease.earnedBoundary.lockedNANDGlobalBaselineDistinctTheoremKernelTypeSha256;
const LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_THEOREM_NAMES = Object.keys(LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_THEOREM_HASHES);
const LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_THEOREM_NAMES.length, 5);
assert.equal(LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_CANDIDATES.length, 5);
const PUBLISHED_LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_MILESTONE = publishedStatus.formalPublicationMilestones.find(
  (row) => row.id === 'locked-nand-global-baseline-distinct'
);
assert.ok(PUBLISHED_LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_MILESTONE);
const LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_THEOREM_HASHES =
  publishedRelease.earnedBoundary.lockedNANDUnsatisfiableFinalZeroTheoremKernelTypeSha256;
const LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_THEOREM_NAMES = Object.keys(LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_THEOREM_HASHES);
const LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_THEOREM_NAMES.length, 2);
assert.equal(LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_CANDIDATES.length, 2);
const PUBLISHED_LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_MILESTONE = publishedStatus.formalPublicationMilestones.find(
  (row) => row.id === 'locked-nand-global-unsatisfiable-final-zero'
);
assert.ok(PUBLISHED_LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_MILESTONE);
const LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_THEOREM_HASHES =
  publishedRelease.earnedBoundary.lockedNANDGlobalSemanticThresholdTheoremKernelTypeSha256;
const LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_THEOREM_NAMES = Object.keys(
  LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_THEOREM_HASHES
);
const LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_THEOREM_NAMES.includes(candidate.name)
);
const LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_NEW_CANDIDATES =
  LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_CANDIDATES.filter(
    (candidate) => !LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_THEOREM_NAMES.includes(candidate.name)
  );
assert.equal(LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_THEOREM_NAMES.length, 8);
assert.equal(LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_CANDIDATES.length, 8);
assert.equal(LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_NEW_CANDIDATES.length, 7);
const PUBLISHED_LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === 'locked-nand-global-semantic-threshold'
  );
assert.ok(PUBLISHED_LOCKED_NAND_GLOBAL_SEMANTIC_THRESHOLD_MILESTONE);
const LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_THEOREM_HASHES =
  publishedRelease.earnedBoundary.lockedNANDEncodedSemanticReductionTheoremKernelTypeSha256;
const LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_THEOREM_NAMES = Object.keys(
  LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_THEOREM_HASHES
);
const LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_THEOREM_NAMES.includes(candidate.name)
  );
assert.equal(LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_THEOREM_NAMES.length, 11);
assert.equal(LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_CANDIDATES.length, 11);
const PUBLISHED_LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
...
const LOCKED_NAND_TARGET_EMITTER_THEOREM_HASHES =
  publishedRelease.earnedBoundary.lockedNANDTargetEmitterTheoremKernelTypeSha256;
const LOCKED_NAND_TARGET_EMITTER_THEOREM_NAMES = Object.keys(
  LOCKED_NAND_TARGET_EMITTER_THEOREM_HASHES
);
const LOCKED_NAND_TARGET_EMITTER_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => LOCKED_NAND_TARGET_EMITTER_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(LOCKED_NAND_TARGET_EMITTER_THEOREM_NAMES.length, 22);
assert.equal(LOCKED_NAND_TARGET_EMITTER_CANDIDATES.length, 22);
const PUBLISHED_LOCKED_NAND_TARGET_EMITTER_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
...
const LOCKED_NAND_ENCODED_SEMANTIC_REDUCTION_STATUS_KEYS = [
  ...
  'leanConcreteLockedNANDEncodedSemanticReductionAuditedDeclarationCount',
...
const LOCKED_NAND_TARGET_EMITTER_STATUS_KEYS = [
  'leanConcreteLockedNANDEmitterMachineFormalized',
  'leanConcreteLockedNANDEmitterAxiomAuditPassed',
  'leanConcreteLockedNANDEmitterAuditedDeclarationCount',
...
const LOCKED_NAND_TARGET_EMITTER_STATUS_FIELDS = Object.fromEntries(
  LOCKED_NAND_TARGET_EMITTER_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
...
const CNF_TO_NAND_SEMANTIC_COMPILER_THEOREM_HASHES =
  publishedRelease.earnedBoundary.cnfToNANDSemanticCompilerTheoremKernelTypeSha256;
const CNF_TO_NAND_SEMANTIC_COMPILER_THEOREM_NAMES = Object.keys(
  CNF_TO_NAND_SEMANTIC_COMPILER_THEOREM_HASHES
);
const CNF_TO_NAND_SEMANTIC_COMPILER_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => CNF_TO_NAND_SEMANTIC_COMPILER_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(CNF_TO_NAND_SEMANTIC_COMPILER_THEOREM_NAMES.length, 18);
assert.equal(CNF_TO_NAND_SEMANTIC_COMPILER_CANDIDATES.length, 18);
const PUBLISHED_CNF_TO_NAND_SEMANTIC_COMPILER_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "concrete-cnf-to-nand-semantic-compiler"
  );
assert.ok(PUBLISHED_CNF_TO_NAND_SEMANTIC_COMPILER_MILESTONE);
const CNF_TO_NAND_SEMANTIC_COMPILER_STATUS_KEYS = [
  "leanConcreteCNFToNANDSemanticCompilerFormalized",
  "leanConcreteCNFToNANDSemanticCompilerAxiomAuditPassed",
  "leanConcreteCNFToNANDSemanticCompilerAuditedDeclarationCount",
...
const CNF_TO_NAND_SEMANTIC_COMPILER_STATUS_FIELDS = Object.fromEntries(
  CNF_TO_NAND_SEMANTIC_COMPILER_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
const CNF_TO_NAND_POLYNOMIAL_REDUCTION_THEOREM_HASHES =
  publishedRelease.earnedBoundary.cnfToNANDPolynomialReductionTheoremKernelTypeSha256;
const CNF_TO_NAND_POLYNOMIAL_REDUCTION_THEOREM_NAMES = Object.keys(
  CNF_TO_NAND_POLYNOMIAL_REDUCTION_THEOREM_HASHES
);
const CNF_TO_NAND_POLYNOMIAL_REDUCTION_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => CNF_TO_NAND_POLYNOMIAL_REDUCTION_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(CNF_TO_NAND_POLYNOMIAL_REDUCTION_THEOREM_NAMES.length, 28);
assert.equal(CNF_TO_NAND_POLYNOMIAL_REDUCTION_CANDIDATES.length, 28);
const PUBLISHED_CNF_TO_NAND_POLYNOMIAL_REDUCTION_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "concrete-cnf-to-nand-polynomial-reduction"
  );
assert.ok(PUBLISHED_CNF_TO_NAND_POLYNOMIAL_REDUCTION_MILESTONE);
const CNF_TO_NAND_POLYNOMIAL_REDUCTION_STATUS_KEYS = [
  "leanConcreteCNFToNANDPolynomialReductionFormalized",
  "leanConcreteCNFToNANDPolynomialReductionAxiomAuditPassed",
  "leanConcreteCNFToNANDPolynomialReductionAuditedDeclarationCount",
...
const CNF_TO_NAND_POLYNOMIAL_REDUCTION_STATUS_FIELDS = Object.fromEntries(
  CNF_TO_NAND_POLYNOMIAL_REDUCTION_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_GAIN_CHAIN_THEOREM_HASHES =
  publishedRelease.earnedBoundary.residualGainChainTheoremKernelTypeSha256;
const RESIDUAL_GAIN_CHAIN_THEOREM_NAMES = Object.keys(RESIDUAL_GAIN_CHAIN_THEOREM_HASHES);
const RESIDUAL_GAIN_CHAIN_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_GAIN_CHAIN_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(RESIDUAL_GAIN_CHAIN_THEOREM_NAMES.length, 14);
assert.equal(RESIDUAL_GAIN_CHAIN_CANDIDATES.length, 14);
const PUBLISHED_RESIDUAL_GAIN_CHAIN_MILESTONE = publishedStatus.formalPublicationMilestones.find(
  (row) => row.id === "residual-gain-chain-bound"
);
assert.ok(PUBLISHED_RESIDUAL_GAIN_CHAIN_MILESTONE);
const RESIDUAL_GAIN_CHAIN_STATUS_KEYS = [
...
const RESIDUAL_GAIN_CHAIN_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_GAIN_CHAIN_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_GAIN_CHAIN_RELEASE_FIELDS = Object.fromEntries(
  Object.entries(publishedRelease.earnedBoundary).filter(([key]) =>
    key.startsWith("residualGainChain")
    || key === "lockedNANDGainIterationsAtMostFourFormalized"
    || key === "lockedNANDFullCandidateImplementationResidualSlackLeFourTheorem"
    || key === "lockedNANDStrictGainChainLengthLeFourTheorem"
...
const RESIDUAL_TERMINAL_FULL_BRIDGE_THEOREM_HASHES =
  publishedRelease.earnedBoundary.residualTerminalFullBridgeTheoremKernelTypeSha256;
const RESIDUAL_TERMINAL_FULL_BRIDGE_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_FULL_BRIDGE_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_FULL_BRIDGE_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_TERMINAL_FULL_BRIDGE_THEOREM_NAMES.includes(candidate.name)
);
const RESIDUAL_TERMINAL_FULL_BRIDGE_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_FULL_BRIDGE_CANDIDATES.filter(
    (candidate) => !RESIDUAL_GAIN_CHAIN_THEOREM_NAMES.includes(candidate.name)
      && !RESIDUAL_GAIN_STOPPING_THEOREM_NAMES.includes(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_FULL_BRIDGE_THEOREM_NAMES.length, 13);
assert.equal(RESIDUAL_TERMINAL_FULL_BRIDGE_CANDIDATES.length, 13);
assert.equal(RESIDUAL_TERMINAL_FULL_BRIDGE_NEW_CANDIDATES.length, 12);
const PUBLISHED_RESIDUAL_TERMINAL_FULL_BRIDGE_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-full-carrier-bridge"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_FULL_BRIDGE_MILESTONE);
const RESIDUAL_TERMINAL_FULL_BRIDGE_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_FULL_BRIDGE_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_FULL_BRIDGE_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_TERMINAL_FULL_BRIDGE_RELEASE_FIELDS = Object.fromEntries(
  Object.entries(publishedRelease.earnedBoundary).filter(([key]) =>
    key.startsWith("residualTerminal") || key.startsWith("residualWholeSpan")
  )
);
const RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREM_HASHES =
  publishedRelease.earnedBoundary.residualTerminalModeFirewallTheoremKernelTypeSha256;
const RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_MODE_FIREWALL_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(RESIDUAL_TERMINAL_MODE_FIREWALL_THEOREM_NAMES.length, 12);
assert.equal(RESIDUAL_TERMINAL_MODE_FIREWALL_CANDIDATES.length, 12);
const PUBLISHED_RESIDUAL_TERMINAL_MODE_FIREWALL_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-mode-firewall"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_MODE_FIREWALL_MILESTONE);
const RESIDUAL_TERMINAL_MODE_FIREWALL_STATUS_KEYS = [
  "leanResidualTerminalQuotientCarrierFormalized",
...
const RESIDUAL_TERMINAL_MODE_FIREWALL_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_MODE_FIREWALL_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_TERMINAL_MODE_FIREWALL_RELEASE_FIELDS = Object.fromEntries(
  Object.entries(publishedRelease.earnedBoundary).filter(([key]) =>
    key.startsWith("residualTerminalMode")
      || key.startsWith("residualTerminalProfileProjection")
      || key.startsWith("residualTerminalChecked")
      || key.startsWith("residualTerminalQuotientEquality")
      || key.startsWith("residualTerminalObligationDischarge")
  )
);
const RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREM_HASHES =
  publishedRelease.earnedBoundary.residualProjectionMinimumTheoremKernelTypeSha256;
const RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_PROJECTION_MINIMUM_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(RESIDUAL_TERMINAL_PROJECTION_MINIMUM_THEOREM_NAMES.length, 14);
assert.equal(RESIDUAL_TERMINAL_PROJECTION_MINIMUM_CANDIDATES.length, 14);
const PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_MINIMUM_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-projection-minimum"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_MINIMUM_MILESTONE);
const RESIDUAL_TERMINAL_PROJECTION_MINIMUM_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_PROJECTION_MINIMUM_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_PROJECTION_MINIMUM_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_TERMINAL_PROJECTION_MINIMUM_RELEASE_FIELDS = Object.fromEntries(
  Object.entries(publishedRelease.earnedBoundary).filter(([key]) =>
    (key.startsWith("residualProjection") && !key.startsWith("residualProjectionTransfer"))
      || key === "pccMinPolynomialRuntimeFormalized"
  )
);
const PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_TRANSFER_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-projection-transfer"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_TRANSFER_MILESTONE);
const RESIDUAL_TERMINAL_PROJECTION_TRANSFER_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_TRANSFER_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_PROJECTION_TRANSFER_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_PROJECTION_TRANSFER_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_PROJECTION_TRANSFER_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_TERMINAL_PROJECTION_TRANSFER_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(RESIDUAL_TERMINAL_PROJECTION_TRANSFER_THEOREM_NAMES.length, 4);
assert.equal(RESIDUAL_TERMINAL_PROJECTION_TRANSFER_CANDIDATES.length, 4);
const RESIDUAL_TERMINAL_PROJECTION_TRANSFER_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_PROJECTION_TRANSFER_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_PROJECTION_TRANSFER_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_TERMINAL_PROJECTION_TRANSFER_RELEASE_FIELDS = Object.fromEntries(
  Object.entries(publishedRelease.earnedBoundary).filter(([key]) =>
    key.startsWith("residualProjectionTransfer")
  )
);

const PUBLISHED_RESIDUAL_TERMINAL_SATURATION_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-saturation-closure"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_SATURATION_MILESTONE);
const RESIDUAL_TERMINAL_SATURATION_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_SATURATION_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_SATURATION_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_SATURATION_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_SATURATION_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_TERMINAL_SATURATION_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(RESIDUAL_TERMINAL_SATURATION_THEOREM_NAMES.length, 7);
assert.equal(RESIDUAL_TERMINAL_SATURATION_CANDIDATES.length, 7);
const RESIDUAL_TERMINAL_SATURATION_STATUS_KEYS = [
  "leanResidualTerminalSaturationFormalized",
...
const RESIDUAL_TERMINAL_SATURATION_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_SATURATION_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-physical-support-completion"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_MILESTONE);
const RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_THEOREM_NAMES.includes(candidate.name)
);
assert.equal(RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_THEOREM_NAMES.length, 14);
assert.equal(RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_CANDIDATES.length, 14);
const RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_PHYSICAL_SUPPORT_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
...
const PUBLISHED_RESIDUAL_TERMINAL_PROPER_SUPPORT_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-proper-positive-support-search"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_PROPER_SUPPORT_MILESTONE);
const RESIDUAL_TERMINAL_PROPER_SUPPORT_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_PROPER_SUPPORT_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_PROPER_SUPPORT_THEOREM_NAMES = Object.keys(
...
assert.equal(RESIDUAL_TERMINAL_PROPER_SUPPORT_THEOREM_NAMES.length, 22);
assert.equal(RESIDUAL_TERMINAL_PROPER_SUPPORT_CANDIDATES.length, 22);
assert.equal(RESIDUAL_TERMINAL_PROPER_SUPPORT_NEW_CANDIDATES.length, 17);
const RESIDUAL_TERMINAL_PROPER_SUPPORT_STATUS_KEYS = [
  "leanResidualTerminalProperSupportFormalized",
...
const RESIDUAL_TERMINAL_PROPER_SUPPORT_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_PROPER_SUPPORT_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_SUPPORT_SQUARE_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-saturated-support-square-closure"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_SUPPORT_SQUARE_MILESTONE);
const RESIDUAL_TERMINAL_SUPPORT_SQUARE_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_SUPPORT_SQUARE_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_SUPPORT_SQUARE_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_SUPPORT_SQUARE_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_SUPPORT_SQUARE_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_TERMINAL_SUPPORT_SQUARE_THEOREM_NAMES.includes(candidate.name)
);
const RESIDUAL_TERMINAL_SUPPORT_SQUARE_NEW_CANDIDATES = RESIDUAL_TERMINAL_SUPPORT_SQUARE_CANDIDATES.filter(
  (candidate) => candidate.module === "PNP.ResidualTerminalSupportSquareClosure"
);
assert.equal(RESIDUAL_TERMINAL_SUPPORT_SQUARE_THEOREM_NAMES.length, 23);
assert.equal(RESIDUAL_TERMINAL_SUPPORT_SQUARE_CANDIDATES.length, 23);
assert.equal(RESIDUAL_TERMINAL_SUPPORT_SQUARE_NEW_CANDIDATES.length, 19);
const RESIDUAL_TERMINAL_SUPPORT_SQUARE_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_SUPPORT_SQUARE_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_SUPPORT_SQUARE_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_GOVERNED_SUPPORT_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-governed-support-completion"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_GOVERNED_SUPPORT_MILESTONE);
const RESIDUAL_TERMINAL_GOVERNED_SUPPORT_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_GOVERNED_SUPPORT_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_GOVERNED_SUPPORT_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_GOVERNED_SUPPORT_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_GOVERNED_SUPPORT_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_TERMINAL_GOVERNED_SUPPORT_THEOREM_NAMES.includes(candidate.name)
);
const RESIDUAL_TERMINAL_GOVERNED_SUPPORT_NEW_CANDIDATES = RESIDUAL_TERMINAL_GOVERNED_SUPPORT_CANDIDATES.filter(
  (candidate) => candidate.module === "PNP.ResidualTerminalGovernedSupportCompletion"
);
assert.equal(RESIDUAL_TERMINAL_GOVERNED_SUPPORT_THEOREM_NAMES.length, 26);
assert.equal(RESIDUAL_TERMINAL_GOVERNED_SUPPORT_CANDIDATES.length, 26);
assert.equal(RESIDUAL_TERMINAL_GOVERNED_SUPPORT_NEW_CANDIDATES.length, 21);
const RESIDUAL_TERMINAL_GOVERNED_SUPPORT_STATUS_KEYS = [
  "leanResidualTerminalSupportCompletionFormalized",
...
const RESIDUAL_TERMINAL_GOVERNED_SUPPORT_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_GOVERNED_SUPPORT_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-governed-frontier-pushout"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_MILESTONE);
const RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_THEOREM_HASHES
);
...
assert.equal(RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_THEOREM_NAMES.length, 28);
assert.equal(RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_CANDIDATES.length, 28);
assert.equal(RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_NEW_CANDIDATES.length, 23);
const RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_SQUARE_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-governed-projection-square"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_SQUARE_MILESTONE);
const RESIDUAL_TERMINAL_PROJECTION_SQUARE_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_SQUARE_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_PROJECTION_SQUARE_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_PROJECTION_SQUARE_THEOREM_HASHES
);
...
assert.equal(RESIDUAL_TERMINAL_PROJECTION_SQUARE_THEOREM_NAMES.length, 23);
assert.equal(RESIDUAL_TERMINAL_PROJECTION_SQUARE_CANDIDATES.length, 23);
assert.equal(RESIDUAL_TERMINAL_PROJECTION_SQUARE_NEW_CANDIDATES.length, 16);
const RESIDUAL_TERMINAL_PROJECTION_SQUARE_STATUS_KEYS = [
  "leanResidualTerminalProjectionSquareFormalized",
...
const RESIDUAL_TERMINAL_PROJECTION_SQUARE_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_PROJECTION_SQUARE_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-side-tight-minimum-arithmetic"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_MILESTONE);
const RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_THEOREM_HASHES
);
...
const RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_THEOREM_NAMES.length, 24);
assert.equal(RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_CANDIDATES.length, 24);
assert.equal(RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_NEW_CANDIDATES.length, 20);
const RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-four-corner-carrier-transport"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_MILESTONE);
const RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_THEOREM_HASHES
);
...
const RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_THEOREM_NAMES.length, 27);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_CANDIDATES.length, 27);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_NEW_CANDIDATES.length, 17);
const RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-four-corner-optimum-carrier-compatibility"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_MILESTONE);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_CANDIDATES = publishedInventory.milestoneCandidates.filter(
  (candidate) => RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_THEOREM_NAMES.includes(candidate.name)
);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_PREVIOUS_THEOREM_NAMES = earnedTheoremNamesBefore(
  "residual-terminal-four-corner-optimum-carrier-compatibility"
);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_THEOREM_NAMES.length, 30);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_CANDIDATES.length, 30);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_NEW_CANDIDATES.length, 25);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-four-corner-optimum-coherence-dichotomy"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_MILESTONE);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-four-corner-optimum-coherence-dichotomy");
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_THEOREM_NAMES.length, 19);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_CANDIDATES.length, 19);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_NEW_CANDIDATES.length, 11);
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, `missing published status field: ${key}`);
    return [key, publishedStatus[key]];
  })
);
const PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-four-corner-side-tight-completion"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_MILESTONE);
const RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-four-corner-side-tight-completion");
const RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_THEOREM_NAMES.length, 20);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_CANDIDATES.length, 20);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_NEW_CANDIDATES.length, 12);
const RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-four-corner-tight-basis-maximum"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_MILESTONE);
const RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-four-corner-tight-basis-maximum");
const RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_THEOREM_NAMES.length, 28);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_CANDIDATES.length, 28);
assert.equal(RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_NEW_CANDIDATES.length, 21);
const RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-computed-bn2-square-legitimacy"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_MILESTONE);
const RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-computed-bn2-square-legitimacy");
const RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_THEOREM_NAMES.length, 20);
assert.equal(RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_CANDIDATES.length, 20);
assert.equal(RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_NEW_CANDIDATES.length, 12);
const RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_STATUS_KEYS = [
  "leanResidualTerminalSquareLegitimacyFormalized",
...
const RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-computed-bcel-anchor-nucleus"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_MILESTONE);
const RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-computed-bcel-anchor-nucleus");
const RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_THEOREM_NAMES.length, 36);
assert.equal(RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_CANDIDATES.length, 36);
assert.equal(RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_NEW_CANDIDATES.length, 29);
const RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-saturation-positivity-firewall"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_MILESTONE);
const RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-saturation-positivity-firewall");
const RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_THEOREM_NAMES.length, 12);
assert.equal(RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_CANDIDATES.length, 12);
assert.equal(RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_NEW_CANDIDATES.length, 6);
const RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-candidate-saturation-cost-balance"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_MILESTONE);
const RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-candidate-saturation-cost-balance");
const RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_THEOREM_NAMES.length, 17);
assert.equal(RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_CANDIDATES.length, 17);
assert.equal(RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_NEW_CANDIDATES.length, 17);
const RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-interface-exposure-routing"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_MILESTONE);
const RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-interface-exposure-routing");
const RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_THEOREM_NAMES.length, 10);
assert.equal(RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_CANDIDATES.length, 10);
assert.equal(RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_NEW_CANDIDATES.length, 10);
const RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-finite-saturate-positive-composition"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_MILESTONE);
const RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-finite-saturate-positive-composition");
const RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_THEOREM_NAMES.length, 9);
assert.equal(RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_CANDIDATES.length, 9);
assert.equal(RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_NEW_CANDIDATES.length, 9);
const RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);

const PUBLISHED_RESIDUAL_TERMINAL_RANK_WF_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-rank-wf"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_RANK_WF_MILESTONE);
const RESIDUAL_TERMINAL_RANK_WF_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_RANK_WF_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_RANK_WF_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_RANK_WF_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_RANK_WF_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_RANK_WF_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_RANK_WF_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-rank-wf");
const RESIDUAL_TERMINAL_RANK_WF_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_RANK_WF_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_RANK_WF_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_RANK_WF_THEOREM_NAMES.length, 18);
assert.equal(RESIDUAL_TERMINAL_RANK_WF_CANDIDATES.length, 18);
assert.equal(RESIDUAL_TERMINAL_RANK_WF_NEW_CANDIDATES.length, 18);
const PUBLISHED_RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-bn3-request-envelope"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_MILESTONE);
const RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-bn3-request-envelope");
const RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_THEOREM_NAMES.length, 11);
assert.equal(RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_CANDIDATES.length, 11);
assert.equal(RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_NEW_CANDIDATES.length, 11);
const PUBLISHED_RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-bn4-activation-cancellation"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_MILESTONE);
const RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-bn4-activation-cancellation");
const RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
...
const PUBLISHED_RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-pkgc-typed-restoration"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_MILESTONE);
const RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-pkgc-typed-restoration");
const RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_THEOREM_NAMES.length, 9);
assert.equal(RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_CANDIDATES.length, 9);
assert.equal(RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_NEW_CANDIDATES.length, 9);
const PUBLISHED_RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-pkgc-same-key-cancellation"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_MILESTONE);
const RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-pkgc-same-key-cancellation");
const RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_THEOREM_NAMES.length, 11);
assert.equal(RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_CANDIDATES.length, 11);
assert.equal(RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_NEW_CANDIDATES.length, 11);
const PUBLISHED_RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-pkgc-ambient-bn4-ledger"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_MILESTONE);
const RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-pkgc-ambient-bn4-ledger");
const RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
...
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_MILESTONE);
const RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-consumer-antichain-normal-form");
const RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
assert.equal(RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_THEOREM_NAMES.length, 7);
assert.equal(RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_CANDIDATES.length, 7);
assert.equal(RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_NEW_CANDIDATES.length, 7);
const PUBLISHED_RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_MILESTONE =
  publishedStatus.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-constant-cut-hypergraph-rigidity"
  );
assert.ok(PUBLISHED_RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_MILESTONE);
const RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_THEOREM_NAMES = Object.keys(
  RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_THEOREM_HASHES
);
const RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_THEOREM_NAMES.includes(candidate.name)
  );
const RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_PREVIOUS_THEOREM_NAMES =
  earnedTheoremNamesBefore("residual-terminal-constant-cut-hypergraph-rigidity");
const RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_NEW_CANDIDATES =
  RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_CANDIDATES.filter(
    (candidate) => !RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_PREVIOUS_THEOREM_NAMES.has(candidate.name)
  );
...
assert.ok(PUBLISHED_LOCKED_NAND_THRESHOLD_PUBLICATION_MILESTONE);
const LOCKED_NAND_THRESHOLD_PUBLICATION_THEOREM_HASHES = Object.fromEntries(
  PUBLISHED_LOCKED_NAND_THRESHOLD_PUBLICATION_MILESTONE.theoremRows.map(
    (row) => [row.name, row.expectedKernelTypeSha256]
  )
);
const LOCKED_NAND_THRESHOLD_PUBLICATION_CANDIDATES =
  publishedInventory.milestoneCandidates.filter(
    (candidate) => Object.hasOwn(LOCKED_NAND_THRESHOLD_PUBLICATION_THEOREM_HASHES, candidate.name)
  );
assert.equal(LOCKED_NAND_THRESHOLD_PUBLICATION_CANDIDATES.length, 1);
const RESIDUAL_TERMINAL_RANK_WF_STATUS_KEYS = [
  "leanResidualTerminalRankWFFormalized",
  "leanResidualTerminalRankWFAxiomAuditPassed",
  "leanResidualTerminalRankWFScope"
];
const RESIDUAL_TERMINAL_RANK_WF_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_RANK_WF_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_BN3_REQUEST_ENVELOPE_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_BN4_ACTIVATION_CANCELLATION_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);
...
const RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_PKGC_SAME_KEY_CANCELLATION_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_PKGC_AMBIENT_BN4_LEDGER_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);
...
const RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_V54_CONSUMER_ANTICHAIN_NORMAL_FORM_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);
const RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_STATUS_KEYS = [
...
const RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_STATUS_FIELDS = Object.fromEntries(
  RESIDUAL_TERMINAL_V53_CONSTANT_CUT_HYPERGRAPH_RIGIDITY_STATUS_KEYS.map((key) => {
    assert.notEqual(publishedStatus[key], undefined, "missing published status field: " + key);
    return [key, publishedStatus[key]];
  })
);
...
const RESIDUAL_TERMINAL_NEW_RELEASE_FIELDS = Object.fromEntries(
  Object.entries(publishedRelease.earnedBoundary).filter(([key]) => [
    "residualTerminalSaturation",
    "residualTerminalCandidate",
    "residualTerminalFirstNontransparent",
    "residualTerminalInterfaceExposure",
    "residualTerminalFiniteInterfaceExposure",
    "residualTerminalFirstInterfaceExposure",
    "residualTerminalOriginKernel",
    "residualTerminalFiniteOriginKernel",
    "residualTerminalFirstOriginKernel",
    "residualTerminalFiniteSaturatePositive",
    ...
    "residualTerminalSupportExtraction",
    "residualTerminalOpen",
    "residualTerminalInduced",
    "residualTerminalSelected",
    "residualTerminalExtract",
    "residualTerminalSaturated",
    "residualTerminalProper",
    "residualTerminalSupportSquare",
    "residualTerminalGoverned",
    "residualTerminalFrontier",
    "residualTerminalProjection",
    "residualTerminalProjected",
    "residualTerminalSquare",
    "residualTerminalSquareProjected",
    "residualTerminalSquareForgotten",
    "residualTerminalSquareProjection",
    "residualTerminalSideTight",
    "residualTerminalFourCorner"
  ].some((prefix) => key.startsWith(prefix)) || [
    "residualTerminalCoherentFourCornerBasisFormalized",
    "residualTerminalCoherentFourCornerBasisScope",
    "residualTerminalSquareLegitimacyFormalized",
...
function makeProject(t) {
  ...
  const statusPayload = {
    ...
    coordinate: publishedStatus.coordinate,
    publicSurfaceBaselineCoordinate: publishedStatus.publicSurfaceBaselineCoordinate,
    ...
    ...RESIDUAL_TERMINAL_FULL_BRIDGE_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_MODE_FIREWALL_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_PROJECTION_MINIMUM_STATUS_FIELDS,
    ...
    ...RESIDUAL_TERMINAL_PROPER_SUPPORT_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_SUPPORT_SQUARE_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_GOVERNED_SUPPORT_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_PROJECTION_SQUARE_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_STATUS_FIELDS,
    ...RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_STATUS_FIELDS,
    ...
    ...structuredClone(Object.fromEntries(Object.entries(publishedStatus).filter(
      ([name]) => name.startsWith("leanConcreteCookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStep")
    ))),
    ...structuredClone(Object.fromEntries(Object.entries(publishedStatus).filter(
      ([name]) => name.startsWith("leanConcreteCookLevinBuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep")
    ))),
    ...structuredClone(Object.fromEntries(Object.entries(publishedStatus).filter(
      ([name]) => name.startsWith("leanConcreteCookLevinBuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep")
    ))),
    ...structuredClone(Object.fromEntries(Object.entries(publishedStatus).filter(
      ([name]) => name.startsWith("leanConcreteCookLevinBuilderSecondConstraintSeventhPaddingOrUnaryOpportunityStep")
    ))),
    ...structuredClone(Object.fromEntries(Object.entries(publishedStatus).filter(
    ...
    formalPublicationMilestones: [{
      ...
      ...structuredClone(PUBLISHED_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_LOCKED_NAND_CARRIER_TRACE_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_LOCKED_NAND_GLOBAL_CANDIDATE_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_MILESTONE)
    }, {
      ...
      ...structuredClone(PUBLISHED_CNF_TO_NAND_SEMANTIC_COMPILER_MILESTONE)
    }, {
      ...
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_FULL_BRIDGE_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_MODE_FIREWALL_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_MINIMUM_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_TRANSFER_MILESTONE)
    }, {
      ...
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_PROPER_SUPPORT_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_SUPPORT_SQUARE_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_GOVERNED_SUPPORT_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_FRONTIER_PUSHOUT_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_PROJECTION_SQUARE_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_SIDE_TIGHT_MINIMUM_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_CARRIER_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMA_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_OPTIMUM_COHERENCE_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_SIDE_TIGHT_COMPLETION_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_FOUR_CORNER_TIGHT_BASIS_MAXIMUM_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_COMPUTED_BN2_SQUARE_LEGITIMACY_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_COMPUTED_BCEL_ANCHOR_NUCLEUS_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_SATURATION_POSITIVITY_FIREWALL_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_CANDIDATE_SATURATION_COST_BALANCE_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_INTERFACE_EXPOSURE_ROUTING_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_FINITE_SATURATE_POSITIVE_COMPOSITION_MILESTONE)
    }, {
      ...structuredClone(PUBLISHED_RESIDUAL_TERMINAL_RANK_WF_MILESTONE)
    }, {
  ...
  assert.equal(
    explicitStatusMilestones.size,
    statusPayload.formalPublicationMilestones.length,
    "synthetic status milestone ids must be unique"
  );
  const publishedStatusMilestoneIds = new Set(
    publishedStatus.formalPublicationMilestones.map((row) => row.id)
  );
  assert.ok(
  ...
  const inventoryPayload = {
    ...
    declarationCount: publishedInventory.declarationCount,
    theoremCount: publishedInventory.theoremCount,
  ...
  inventoryPayload.milestoneCandidates.push(
    ...
    ...RESIDUAL_TERMINAL_PKGC_TYPED_RESTORATION_NEW_CANDIDATES,
  ...
  const publicationMapPayload = {
    ...
    earnedMilestoneTheoremKernelTypeSha256: {
      ...
      ...BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_HASHES,
      ...BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_THEOREM_HASHES,
      ...BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_THEOREM_HASHES,
      ...BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_HASHES,
      ...LOCKED_NAND_CARRIER_TRACE_THEOREM_HASHES,
      ...LOCKED_NAND_GLOBAL_CANDIDATE_THEOREM_HASHES,
    ...
    milestones: [{
      ...
      id: PUBLISHED_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE.id,
      classification: PUBLISHED_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE.classification,
      requiredTheorems: BUILDER_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES,
      nonClaim: PUBLISHED_SECOND_CONSTRAINT_FOURTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE.nonClaim
    }, {
      id: PUBLISHED_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_MILESTONE.id,
      classification: PUBLISHED_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_MILESTONE.classification,
      requiredTheorems: BUILDER_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_THEOREM_NAMES,
      nonClaim: PUBLISHED_SECOND_CONSTRAINT_FIFTH_PADDING_OR_TERMINATOR_OPPORTUNITY_STEP_MILESTONE.nonClaim
    }, {
      id: PUBLISHED_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_MILESTONE.id,
      classification: PUBLISHED_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_MILESTONE.classification,
      requiredTheorems: BUILDER_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES,
      nonClaim: PUBLISHED_SECOND_CONSTRAINT_SIXTH_PADDING_OR_OPENING_UNARY_OPPORTUNITY_STEP_MILESTONE.nonClaim
    }, {
      id: PUBLISHED_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE.id,
      classification: PUBLISHED_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE.classification,
      requiredTheorems: BUILDER_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_THEOREM_NAMES,
      nonClaim: PUBLISHED_SECOND_CONSTRAINT_SEVENTH_PADDING_OR_UNARY_OPPORTUNITY_STEP_MILESTONE.nonClaim
    }, {
      id: PUBLISHED_LOCKED_NAND_CARRIER_TRACE_MILESTONE.id,
      classification: PUBLISHED_LOCKED_NAND_CARRIER_TRACE_MILESTONE.classification,
      scope: PUBLISHED_LOCKED_NAND_CARRIER_TRACE_MILESTONE.scope,
      requiredTheorems: LOCKED_NAND_CARRIER_TRACE_THEOREM_NAMES,
      nonClaim: PUBLISHED_LOCKED_NAND_CARRIER_TRACE_MILESTONE.nonClaim
    }, {
      id: PUBLISHED_LOCKED_NAND_GLOBAL_CANDIDATE_MILESTONE.id,
      classification: PUBLISHED_LOCKED_NAND_GLOBAL_CANDIDATE_MILESTONE.classification,
      scope: PUBLISHED_LOCKED_NAND_GLOBAL_CANDIDATE_MILESTONE.scope,
      requiredTheorems: LOCKED_NAND_GLOBAL_CANDIDATE_THEOREM_NAMES,
      nonClaim: PUBLISHED_LOCKED_NAND_GLOBAL_CANDIDATE_MILESTONE.nonClaim
    }, {
      id: PUBLISHED_LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_MILESTONE.id,
      classification: PUBLISHED_LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_MILESTONE.classification,
      scope: PUBLISHED_LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_MILESTONE.scope,
      requiredTheorems: LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_THEOREM_NAMES,
      nonClaim: PUBLISHED_LOCKED_NAND_GLOBAL_BASELINE_DISTINCT_MILESTONE.nonClaim
    }, {
      id: PUBLISHED_LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_MILESTONE.id,
      classification: PUBLISHED_LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_MILESTONE.classification,
      scope: PUBLISHED_LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_MILESTONE.scope,
      requiredTheorems: LOCKED_NAND_UNSATISFIABLE_FINAL_ZERO_THEOREM_NAMES,
  ...
  const release = {
    ...
    earnedBoundary: {
      ...
      ...structuredClone(RESIDUAL_TERMINAL_FULL_BRIDGE_RELEASE_FIELDS),
      ...structuredClone(RESIDUAL_TERMINAL_MODE_FIREWALL_RELEASE_FIELDS),
      ...structuredClone(RESIDUAL_TERMINAL_PROJECTION_MINIMUM_RELEASE_FIELDS),
      ...structuredClone(RESIDUAL_TERMINAL_PROJECTION_TRANSFER_RELEASE_FIELDS),
      ...structuredClone(RESIDUAL_TERMINAL_NEW_RELEASE_FIELDS),
...
test("rejects second-constraint-fourth-padding-or-unary-opportunity release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.cookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStepFourthPaddingOrUnaryOpportunityFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.cookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStepTheoremKernelTypeSha256[
  ...
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.cookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStepProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step axiom closure mismatch/);

  const releaseCost = makeProject(t);
  releaseCost.release.earnedBoundary.cookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStepRuleCount = "0";
  write(releaseCost.root, "downloads/formal-publication-release.json", json(releaseCost.release));
  expectFailure(releaseCost, /formal-publication Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step cost mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.cookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStepFollowingTokenTheorem =
    "PNP.Concrete.CookLevin.BuilderSecondConstraintFourthPaddingOrUnaryOpportunityStep.forged";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /formal-publication Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanConcreteCookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStepExactFormulaBitsFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.CookLevin.BuilderSecondConstraintFourthPaddingOrUnaryOpportunityStep.specification_opportunity_step"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step theorem mismatch/);

  const reusedModule = makeProject(t);
  const reusedModulePayload = JSON.parse(readFileSync(path.join(reusedModule.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  reusedModulePayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.CookLevin.BuilderSecondConstraintFirstLiteralTerminatorStep.encodeCNFTokens_eq_terminator_then_successor_and_four_optional_unary"
  ).module = "PNP.ForgedModule";
  rewriteCorePayload(reusedModule, "public/pnp-theorem-inventory.json", reusedModulePayload);
  expectFailure(reusedModule, /public inventory Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step theorem mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.CookLevin.BuilderSecondConstraintFourthPaddingOrUnaryOpportunityStep.finalTokenBits_eq_encodedFormula_secondConstraintFourthPaddingOrUnary"
  ).kernelType += " ";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /public inventory Cook-Levin builder second-constraint-fourth-padding-or-unary-opportunity-step fingerprint mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map builder second-constraint-fourth-padding-or-unary-opportunity-step milestone mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map builder second-constraint-fourth-padding-or-unary-opportunity-step milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map builder second-constraint-fourth-padding-or-unary-opportunity-step fingerprint mismatch/);
});

test("rejects second-constraint-fifth-padding-or-terminator-opportunity release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.cookLevinBuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStepFifthPaddingOrTerminatorOpportunityFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.cookLevinBuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStepTheoremKernelTypeSha256[
  ...
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.cookLevinBuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStepProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step axiom closure mismatch/);

  const releaseCost = makeProject(t);
  releaseCost.release.earnedBoundary.cookLevinBuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStepRuleCount = "0";
  write(releaseCost.root, "downloads/formal-publication-release.json", json(releaseCost.release));
  expectFailure(releaseCost, /formal-publication Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step cost mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.cookLevinBuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStepFollowingTokenTheorem =
    "PNP.Concrete.CookLevin.BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.forged";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /formal-publication Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanConcreteCookLevinBuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStepExactFormulaBitsFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.CookLevin.BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.specification_opportunity_step"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step mismatch/);

  const reusedModule = makeProject(t);
  const reusedModulePayload = JSON.parse(readFileSync(path.join(reusedModule.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  reusedModulePayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.CookLevin.BuilderSecondConstraintFirstLiteralTerminatorStep.encodeCNFTokens_eq_terminator_then_successor_and_four_optional_unary_and_optional_terminator"
  ).module = "PNP.ForgedModule";
  rewriteCorePayload(reusedModule, "public/pnp-theorem-inventory.json", reusedModulePayload);
  expectFailure(reusedModule, /public inventory Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.CookLevin.BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.finalTokenBits_eq_encodedFormula_secondConstraintFifthPaddingOrTerminator"
  ).kernelType += " ";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /public inventory Cook-Levin builder second-constraint-fifth-padding-or-terminator-opportunity-step fingerprint mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map builder second-constraint-fifth-padding-or-terminator-opportunity-step milestone mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map builder second-constraint-fifth-padding-or-terminator-opportunity-step milestone mismatch/);
...
test("rejects locked-NAND carrier-trace release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.lockedNANDCarrierLayoutFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication locked-NAND carrier-trace boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.lockedNANDCarrierTraceTheoremKernelTypeSha256[
    "PNP.DirectWire.LockedNANDTrace.traceEquivalence"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication locked-NAND carrier-trace fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.lockedNANDCarrierTraceProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication locked-NAND carrier-trace axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.lockedNANDTraceEquivalenceTheorem =
    "PNP.DirectWire.LockedNANDTrace.forged";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /formal-publication locked-NAND carrier-trace theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanLockedNANDCarrierTraceAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status locked-NAND carrier-trace evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status locked-NAND carrier-trace milestone mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDTrace.tracePredicate_coherentExtension"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory locked-NAND carrier-trace theorem mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDTrace.satisfiable_iff_trace_extension"
  ).kernelType += " ";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /public inventory locked-NAND carrier-trace fingerprint mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map locked-NAND carrier-trace milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map locked-NAND carrier-trace fingerprint mismatch/);
});

test("rejects locked-NAND global-candidate release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.lockedNANDGlobalCandidateAssemblyFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication locked-NAND global-candidate boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.lockedNANDGlobalCandidateTheoremKernelTypeSha256[
    "PNP.DirectWire.LockedNANDGlobalCandidates.fullCandidate_final_semantics"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication locked-NAND global-candidate fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.lockedNANDGlobalCandidateProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication locked-NAND global-candidate axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.lockedNANDBaselineCandidateSizeTheorem =
    "PNP.DirectWire.LockedNANDGlobalCandidates.forged";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /formal-publication locked-NAND global-candidate theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanLockedNANDGlobalCandidateAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status locked-NAND global-candidate evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status locked-NAND global-candidate milestone mismatch/);
  ...
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDGlobalCandidates.baselineCandidate_no_internal_constants"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory locked-NAND global-candidate theorem mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDGlobalCandidates.baselineCandidate_finalLock_irrelevant"
  ).kernelType += " ";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /public inventory locked-NAND global-candidate fingerprint mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map locked-NAND global-candidate milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map locked-NAND global-candidate fingerprint mismatch/);
});

test("rejects locked-NAND global BaselineDistinct release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.lockedNANDGlobalBaselineDistinctFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication locked-NAND global BaselineDistinct boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.lockedNANDGlobalBaselineDistinctTheoremKernelTypeSha256[
    "PNP.DirectWire.LockedNANDGlobalCandidates.baselineCandidate_referenceMinimum"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication locked-NAND global BaselineDistinct fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.lockedNANDGlobalBaselineDistinctProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication locked-NAND global BaselineDistinct axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.lockedNANDBaselineReferenceMinimumTheorem =
    "PNP.DirectWire.LockedNANDGlobalCandidates.forged";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /formal-publication locked-NAND global BaselineDistinct theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanLockedNANDGlobalBaselineDistinctAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status locked-NAND global BaselineDistinct evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status locked-NAND global BaselineDistinct milestone mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDGlobalCandidates.baselineCandidate_outputConditions"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory locked-NAND global BaselineDistinct theorem mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDGlobalCandidates.baselineCandidate_outputPairwiseDistinct"
  ).kernelType += " ";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /public inventory locked-NAND global BaselineDistinct fingerprint mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map locked-NAND global BaselineDistinct milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map locked-NAND global BaselineDistinct fingerprint mismatch/);
});

test("rejects locked-NAND unsatisfiable final-zero release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.lockedNANDUnsatisfiableFinalZeroFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication locked-NAND unsatisfiable final-zero boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.lockedNANDUnsatisfiableFinalZeroTheoremKernelTypeSha256[
    "PNP.DirectWire.LockedNANDGlobalCandidates.fullCandidate_final_eq_false_of_unsatisfiable"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication locked-NAND unsatisfiable final-zero fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.lockedNANDUnsatisfiableFinalZeroProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication locked-NAND unsatisfiable final-zero axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.lockedNANDUnsatisfiableFinalZeroTheorem =
    "PNP.DirectWire.LockedNANDGlobalCandidates.forged";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /formal-publication locked-NAND unsatisfiable final-zero theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanLockedNANDUnsatisfiableFinalZeroAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status locked-NAND unsatisfiable final-zero evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status locked-NAND unsatisfiable final-zero milestone mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDGlobalCandidates.fullCandidate_referenceMinimum_eq_baseline_of_unsatisfiable"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory locked-NAND unsatisfiable final-zero theorem mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDGlobalCandidates.fullCandidate_final_eq_false_of_unsatisfiable"
  ).kernelType += " ";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /public inventory locked-NAND unsatisfiable final-zero fingerprint mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map locked-NAND unsatisfiable final-zero milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map locked-NAND unsatisfiable final-zero fingerprint mismatch/);
});

test("rejects locked-NAND global semantic-threshold release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.lockedNANDGlobalSemanticThresholdFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication locked-NAND global semantic-threshold boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.lockedNANDGlobalSemanticThresholdTheoremKernelTypeSha256[
    "PNP.DirectWire.LockedNANDGlobalCandidates.fullCandidate_satisfiable_iff_referenceMinimum_ge_succ"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication locked-NAND global semantic-threshold fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.lockedNANDGlobalSemanticThresholdProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication locked-NAND global semantic-threshold axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.lockedNANDResidualSlackLeFourTheorem =
    "PNP.DirectWire.LockedNANDGlobalCandidates.forged";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /formal-publication locked-NAND global semantic-threshold theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanLockedNANDGlobalSemanticThresholdAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status locked-NAND global semantic-threshold evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status locked-NAND global semantic-threshold milestone mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDGlobalCandidates.fullCandidate_residualSlack_le_four"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory locked-NAND global semantic-threshold theorem mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.LockedNANDGlobalCandidates.fullCandidate_satisfiableFinalConditions"
  ).kernelType += " ";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /public inventory locked-NAND global semantic-threshold fingerprint mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map locked-NAND global semantic-threshold milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map locked-NAND global semantic-threshold fingerprint mismatch/);
});

test("rejects encoded locked-NAND semantic-reduction release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.lockedNANDEncodedSemanticReductionFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication locked-NAND encoded semantic-reduction boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.lockedNANDEncodedSemanticReductionTheoremKernelTypeSha256[
    "PNP.Concrete.LockedNAND.buildLockedNANDInstance_correct"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication locked-NAND encoded semantic-reduction fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.lockedNANDEncodedSemanticReductionProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication locked-NAND encoded semantic-reduction axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.lockedNANDEncodedThresholdTheorem =
    "PNP.Concrete.LockedNAND.forged";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /formal-publication locked-NAND encoded semantic-reduction theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanConcreteLockedNANDEmitterMachineFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status locked-NAND encoded semantic-reduction milestone mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.LockedNAND.RawCircuit.normalize_eval"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory locked-NAND encoded semantic-reduction theorem mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.LockedNAND.buildLockedNANDInstance_correct"
  ).kernelType += " ";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /public inventory locked-NAND encoded semantic-reduction fingerprint mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map locked-NAND encoded semantic-reduction milestone mismatch/);
...
test("rejects locked-NAND target-emitter release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.lockedNANDTargetEmitterFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication locked-NAND target-emitter boundary mismatch/);

  const releaseCount = makeProject(t);
  releaseCount.release.earnedBoundary.lockedNANDTargetEmitterAuditedDeclarationCount = 3294;
  write(releaseCount.root, "downloads/formal-publication-release.json", json(releaseCount.release));
  expectFailure(releaseCount, /formal-publication locked-NAND target-emitter boundary mismatch/);

  const releaseSplit = makeProject(t);
  releaseSplit.release.earnedBoundary.lockedNANDTargetEmitterEmptyAxiomDeclarationCount = 2223;
  write(releaseSplit.root, "downloads/formal-publication-release.json", json(releaseSplit.release));
  expectFailure(releaseSplit, /formal-publication locked-NAND target-emitter boundary mismatch/);

  const releaseRuleCount = makeProject(t);
  releaseRuleCount.release.earnedBoundary.lockedNANDTargetEmitterRuleCount = 1387920;
  write(releaseRuleCount.root, "downloads/formal-publication-release.json", json(releaseRuleCount.release));
  expectFailure(releaseRuleCount, /formal-publication locked-NAND target-emitter boundary mismatch/);

  const releaseOutputBound = makeProject(t);
  releaseOutputBound.release.earnedBoundary.lockedNANDTargetEmitterOutputSizeBound = "0";
  write(releaseOutputBound.root, "downloads/formal-publication-release.json", json(releaseOutputBound.release));
  expectFailure(releaseOutputBound, /formal-publication locked-NAND target-emitter boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.lockedNANDTargetEmitterTheoremKernelTypeSha256[
    "PNP.Concrete.LockedNAND.TargetEmitterControllerTotalTrace.allInput_bounded_exact"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication locked-NAND target-emitter fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.lockedNANDTargetEmitterProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication locked-NAND target-emitter axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.lockedNANDTargetEmitterOutputTheorem =
    "PNP.Concrete.LockedNAND.TargetEmitterControllerCompiled.forged";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /formal-publication locked-NAND target-emitter theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanConcreteLockedNANDEmitterCompiledNonTimeoutFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status locked-NAND target-emitter evidence mismatch/);

  const statusCount = makeProject(t);
  const statusCountPayload = JSON.parse(readFileSync(path.join(statusCount.sourceDir, "public/pnp-status.json"), "utf8"));
  statusCountPayload.leanConcreteLockedNANDEmitterAuditedDeclarationCount = 3294;
  rewriteCorePayload(statusCount, "public/pnp-status.json", statusCountPayload);
  expectFailure(statusCount, /public status locked-NAND target-emitter evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status locked-NAND target-emitter milestone mismatch/);

  const inventoryModule = makeProject(t);
  const inventoryModulePayload = JSON.parse(readFileSync(path.join(inventoryModule.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryModulePayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.LockedNAND.TargetEmitterControllerTotalTrace.allInput_bounded_exact"
  ).module = "PNP.Concrete.LockedNANDTargetEmitterForged";
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /public inventory locked-NAND target-emitter theorem mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.LockedNAND.TargetEmitterController.rules_length_literal"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory locked-NAND target-emitter theorem mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.LockedNAND.TargetEmitterControllerCompiled.compiledMachineOutput_eq_targetBytes"
  ).kernelType += " ";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /public inventory locked-NAND target-emitter fingerprint mismatch/);
  ...
  rewriteCorePayload(mapScope, "publication/FORMAL_PUBLICATION_MAP.json", mapScopePayload);
  expectFailure(mapScope, /core publication map locked-NAND target-emitter milestone mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map locked-NAND target-emitter milestone mismatch/);
  ...
  rewriteCorePayload(mapPinSet, "publication/FORMAL_PUBLICATION_MAP.json", mapPinSetPayload);
  expectFailure(mapPinSet, /core publication map locked-NAND target-emitter milestone mismatch/);
...
test("rejects CNF-to-NAND semantic-compiler release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.cnfToNANDSemanticCompilerFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication CNF-to-NAND semantic-compiler boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.cnfToNANDSemanticCompilerTheoremKernelTypeSha256[
    "PNP.Concrete.CNFToNAND.compileEncodedCNFToNAND_correct"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication CNF-to-NAND semantic-compiler fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.cnfToNANDSemanticCompilerProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication CNF-to-NAND semantic-compiler axiom closure mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanConcreteCNFToNANDAllBitstringFailClosedFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status CNF-to-NAND semantic-compiler evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status CNF-to-NAND semantic-compiler publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.CNFToNAND.compileFormula_wellFormed"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory CNF-to-NAND semantic-compiler theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map CNF-to-NAND semantic-compiler milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map CNF-to-NAND semantic-compiler fingerprint mismatch/);
});

test("rejects CNF-to-NAND polynomial-reduction release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.cnfToNANDPolynomialReductionFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /formal-publication CNF-to-NAND polynomial-reduction boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.cnfToNANDPolynomialReductionTheoremKernelTypeSha256[
    "PNP.Concrete.CNFToNANDCompilerCompiled.compiledMachineOutput_eq_compileEncodedCNFToNAND"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /formal-publication CNF-to-NAND polynomial-reduction fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.cnfToNANDPolynomialReductionProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /formal-publication CNF-to-NAND polynomial-reduction axiom closure mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanConcreteCNFToNANDExactMachineOutputFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /public status CNF-to-NAND polynomial-reduction evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /public status CNF-to-NAND polynomial-reduction publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.Concrete.CNFToNAND.cnfToNANDPolynomialReduction_correct"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /public inventory CNF-to-NAND polynomial-reduction theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map CNF-to-NAND polynomial-reduction milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map CNF-to-NAND polynomial-reduction fingerprint mismatch/);
});

test("rejects residual-gain chain release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualGainChainSlackIterationBoundFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual-gain chain boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualGainChainTheoremKernelTypeSha256[
    "PNP.DirectWire.StrictGainChain.end_residualSlack_add_length_le"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual-gain chain fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualGainChainProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual-gain chain axiom closure mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualGainChainSlackIterationBoundFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual-gain chain evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual-gain chain publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.StrictGainChain.length_le_residualSlack"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual-gain chain theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map residual-gain chain milestone mismatch/);
...
test("rejects terminal full-carrier bridge release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualWholeSpanZeroAbsenceIffFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal full-carrier bridge boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalFullBridgeTheoremKernelTypeSha256[
    "PNP.DirectWire.residualSlack_eq_zero_iff_no_wholeSpanResidualWitness"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal full-carrier bridge fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalFullBridgeProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal full-carrier bridge axiom closure mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualWholeSpanZeroAbsenceIffFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal full-carrier bridge evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal full-carrier bridge publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.residualSlack_eq_zero_iff_no_wholeSpanResidualWitness"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal full-carrier bridge theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal full-carrier bridge theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map residual terminal full-carrier bridge milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal full-carrier bridge fingerprint mismatch/);
});

test("rejects terminal mode-firewall release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalCheckedFullLiftFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal mode-firewall boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalModeFirewallTheoremKernelTypeSha256[
    "PNP.DirectWire.terminalCheckedFullLift_iff_fullProfileEqual"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal mode-firewall fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalModeFirewallProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal mode-firewall axiom closure mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalCheckedFullLiftFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal mode-firewall evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal mode-firewall publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.terminalCheckedFullLift_iff_fullProfileEqual"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal mode-firewall theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal mode-firewall theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map residual terminal mode-firewall milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal mode-firewall fingerprint mismatch/);
});

test("rejects terminal projection-minimum release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualProjectionMinimumFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal projection-minimum boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualProjectionMinimumTheoremKernelTypeSha256[
    "PNP.DirectWire.terminalProjectionMinimum_mono"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal projection-minimum fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualProjectionMinimumProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal projection-minimum axiom closure mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualProjectionMinimumMonotonicityFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal projection-minimum evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal projection-minimum publication boundary mismatch/);
  ...
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal projection-minimum theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal projection-minimum theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map residual terminal projection-minimum milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal projection-minimum fingerprint mismatch/);
});

test("rejects terminal projection-transfer release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualProjectionTransferIdentityFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal projection-transfer boundary mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualProjectionTransferConstantCutFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal projection-transfer evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal projection-transfer publication boundary mismatch/);
  ...
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal projection-transfer theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal projection-transfer theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map residual terminal projection-transfer milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal projection-transfer fingerprint mismatch/);
});

test("rejects terminal saturation release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalSaturationClosedTheorem = "PNP.Forged.closed";
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal saturation theorem identity mismatch/);
  ...
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-saturation-closure"
  ).nonClaim = "This derives every arbitrary-circuit support square and proves P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal saturation publication boundary mismatch/);
  ...
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal saturation theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal saturation theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map residual terminal saturation milestone mismatch/);
...
test("rejects saturated support-square release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalSupportSquareClosureFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal support-square closure boundary mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalSupportSquareSemanticExtractionFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal support-square closure evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-saturated-support-square-closure"
  ).nonClaim = "This proves the complete residual route and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal support-square closure publication boundary mismatch/);
  ...
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal support-square closure theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal support-square closure theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map residual terminal support-square closure milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal support-square closure fingerprint mismatch/);
});

test("rejects governed support-completion release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalGovernedSupportCompletionFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal governed-support completion boundary mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalGovernedProfilePartitionFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal governed-support completion evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-governed-support-completion"
  ).nonClaim = "This proves the manuscript square, polynomial runtime, and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal governed-support completion publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalGovernedCompletedSupport.profileCoordinates_disjoint"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal governed-support completion theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal governed-support completion theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map residual terminal governed-support completion milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal governed-support completion fingerprint mismatch/);
});

test("rejects governed frontier-pushout release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalFrontierPushoutFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal frontier-pushout boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalFrontierPushoutTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalSaturatedSupportSquare.governed_frontier_pushout"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal frontier-pushout fingerprint mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalFrontierInternalizationFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal frontier-pushout evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-governed-frontier-pushout"
  ).nonClaim = "This proves projection compatibility and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal frontier-pushout publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalSaturatedSupportSquare.governed_frontier_pushout"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal frontier-pushout theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal frontier-pushout theorem mismatch/);
  ...
  rewriteCorePayload(mapNonClaim, "publication/FORMAL_PUBLICATION_MAP.json", mapNonClaimPayload);
  expectFailure(mapNonClaim, /core publication map residual terminal frontier-pushout milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal frontier-pushout fingerprint mismatch/);
});

test("rejects governed projection-square release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalProjectionSquareFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal projection-square boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalProjectionSquareTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalGovernedFrontier.project_boundary"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal projection-square fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalProjectionSquareProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal projection-square axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalProjectionFrontierBoundaryTheorem =
    "PNP.DirectWire.TerminalGovernedFrontier.project_interface";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal projection-square theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalProjectionPushoutCommuteFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal projection-square evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-governed-projection-square"
  ).nonClaim = "This proves square legitimacy and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal projection-square publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalGovernedFrontier.project_boundary"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal projection-square theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal projection-square theorem mismatch/);
  ...
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /inventory residual terminal projection-square theorem mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal projection-square milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal projection-square fingerprint mismatch/);
});

test("rejects side-tight minimum release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalSideTightMinimumArithmeticFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal side-tight minimum arithmetic boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalSideTightMinimumTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalFourCornerSizes.tightValue?_sound"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal side-tight minimum arithmetic fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalSideTightMinimumProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal side-tight minimum arithmetic axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalSideTightFailClosedSoundnessTheorem =
    "PNP.DirectWire.TerminalFourCornerSizes.tightValue?_complete";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal side-tight minimum arithmetic theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalSideTightFailClosedGateFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal side-tight minimum arithmetic evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-side-tight-minimum-arithmetic"
  ).nonClaim = "This proves coherent four-corner completion and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal side-tight minimum arithmetic publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalFourCornerSizes.tightValue?_sound"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal side-tight minimum arithmetic theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal side-tight minimum arithmetic theorem mismatch/);
  ...
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /inventory residual terminal side-tight minimum arithmetic theorem mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal side-tight minimum arithmetic milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal side-tight minimum arithmetic fingerprint mismatch/);
});

test("rejects four-corner carrier release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalFourCornerCarrierTransportFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal four-corner carrier boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalFourCornerCarrierTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalFourCornerCarrier.boundaryDisposition?_eq_some_iff"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal four-corner carrier fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalFourCornerCarrierProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal four-corner carrier axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalFourCornerCarrierCompleteTransportTheorem =
    "PNP.DirectWire.TerminalFourCornerCarrier.projection_compatible";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal four-corner carrier theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalFourCornerCarrierFailClosedPhysicalTransportFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal four-corner carrier evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-four-corner-carrier-transport"
  ).nonClaim = "This transports four optimum realizers and proves P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal four-corner carrier publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalFourCornerCarrier.boundaryDisposition?_eq_some_iff"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal four-corner carrier theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal four-corner carrier theorem mismatch/);
  ...
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /inventory residual terminal four-corner carrier theorem mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal four-corner carrier milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal four-corner carrier fingerprint mismatch/);
});

test("rejects four-corner optimum carrier release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalFourCornerOptimaCarrierCompatibleFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal four-corner optimum carrier compatibility boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalFourCornerOptimaTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalFourCornerCarrier.fourCornerOptimaCarrierCompatible"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal four-corner optimum carrier compatibility fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalFourCornerOptimaProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal four-corner optimum carrier compatibility axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalFourCornerOptimaCompatibilityTheorem =
    "PNP.DirectWire.TerminalFourCornerCarrier.complete_transport";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal four-corner optimum carrier compatibility theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalFourCornerOptimaSharedObserverProjectionFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal four-corner optimum carrier compatibility evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-four-corner-optimum-carrier-compatibility"
  ).nonClaim = "This constructs one coherent four-corner optimum and proves P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal four-corner optimum carrier compatibility publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalFourCornerCarrier.fourCornerOptimaCarrierCompatible"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal four-corner optimum carrier compatibility theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal four-corner optimum carrier compatibility theorem mismatch/);
  ...
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /inventory residual terminal four-corner optimum carrier compatibility theorem mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal four-corner optimum carrier compatibility milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal four-corner optimum carrier compatibility fingerprint mismatch/);
});

test("rejects four-corner optimum coherence release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalFourCornerOptimumCoherenceClassifierFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal four-corner optimum coherence boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalFourCornerOptimumCoherenceTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalFourCornerCarrier.fourCornerOptimumCoherenceDichotomy"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal four-corner optimum coherence fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalFourCornerOptimumCoherenceProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal four-corner optimum coherence axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalFourCornerOptimumCoherenceClassifierTheorem =
    "PNP.DirectWire.TerminalFourCornerCarrier.fourCornerOptimaCarrierCompatible";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal four-corner optimum coherence theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalFourCornerOptimumModeFirewallFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal four-corner optimum coherence dichotomy evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-four-corner-optimum-coherence-dichotomy"
  ).nonClaim = "This proves every square is coherent and proves P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal four-corner optimum coherence dichotomy publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalFourCornerCarrier.fourCornerOptimumCoherenceDichotomy"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal four-corner optimum coherence theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal four-corner optimum coherence theorem mismatch/);
  ...
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /inventory residual terminal four-corner optimum coherence theorem mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal four-corner optimum coherence milestone mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal four-corner optimum coherence fingerprint mismatch/);
});

test("rejects four-corner side-tight completion release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalFourCornerOptimumRouteSilenceFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal four-corner side-tight completion boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalFourCornerSideTightCompletionTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalFourCornerCarrier.sideTightCompletionExists"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal four-corner side-tight completion fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalFourCornerSideTightCompletionProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal four-corner side-tight completion axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalFourCornerOptimumCompletionTheorem =
    "PNP.DirectWire.TerminalFourCornerCarrier.fourCornerOptimumCoherenceDichotomy";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal four-corner side-tight completion theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalFourCornerOptimumRouteSilenceFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal four-corner side-tight completion evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-four-corner-side-tight-completion"
  ).nonClaim = "This proves universal route silence, BN2 square legitimacy, and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal four-corner side-tight completion publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalFourCornerCarrier.sideTightCompletionExists"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal four-corner side-tight completion theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal four-corner side-tight completion theorem mismatch/);
  ...
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /inventory residual terminal four-corner side-tight completion theorem mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /pinned formal-publication map residual terminal four-corner side-tight completion boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal four-corner side-tight completion fingerprint mismatch/);
});

test("rejects four-corner tight-basis maximum release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalFourCornerTightBasisFamilyComplete = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal four-corner tight-basis maximum boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalFourCornerTightBasisMaximumTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalFourCornerCarrier.tightBasisMaximum?_eq_delta"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal four-corner tight-basis maximum fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalFourCornerTightBasisMaximumProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal four-corner tight-basis maximum axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalFourCornerTightBasisMaximumTheorem =
    "PNP.DirectWire.TerminalFourCornerCarrier.sideTightCompletionExists";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal four-corner tight-basis maximum theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalFourCornerTightBasisMaximumEqualsDeltaFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal four-corner tight-basis maximum evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal four-corner tight-basis maximum publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalFourCornerCarrier.tightBasisMaximum?_eq_delta"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal four-corner tight-basis maximum theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal four-corner tight-basis maximum theorem mismatch/);
  ...
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /inventory residual terminal four-corner tight-basis maximum theorem mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /pinned formal-publication map residual terminal four-corner tight-basis maximum boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal four-corner tight-basis maximum fingerprint mismatch/);
});

test("rejects computed terminal BN2 square-legitimacy release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalSquareFailClosedRouteDichotomyFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal computed BN2 square-legitimacy boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalSquareLegitimacyTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalFourCornerCarrier.computedBN2LocalConclusionOrFirstRoute"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal computed BN2 square-legitimacy fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalSquareLegitimacyProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal computed BN2 square-legitimacy axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalSquareLocalConclusionOrFirstRouteTheorem =
    "PNP.DirectWire.TerminalFourCornerCarrier.sideTightCompletionExists";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal computed BN2 square-legitimacy theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalSquareLocalConclusionUnderRouteSilenceFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal computed BN2 square-legitimacy evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-computed-bn2-square-legitimacy"
  ).nonClaim = "This proves universal route silence, SaturatePositive, and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal computed BN2 square-legitimacy publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.TerminalFourCornerCarrier.computedBN2LocalConclusionOrFirstRoute"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal computed BN2 square-legitimacy theorem evidence mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.TerminalComputedBN2SquareLegitimate.cornerCompatible"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal computed BN2 square legitimacy theorem mismatch/);
  ...
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /inventory residual terminal computed BN2 square legitimacy theorem mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal computed BN2 square-legitimacy boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal computed BN2 square-legitimacy fingerprint mismatch/);
});

test("rejects computed terminal BCEL anchor-nucleus release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalBCELCutRouteDichotomyFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal computed BCEL anchor-nucleus boundary mismatch/);

  const releaseGate = makeProject(t);
  releaseGate.release.earnedBoundary.bcelReadyFormalized = true;
  write(releaseGate.root, "downloads/formal-publication-release.json", json(releaseGate.release));
  expectFailure(releaseGate, /current manifest residual terminal computed BCEL anchor-nucleus boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalBCELAnchorNucleusTheoremKernelTypeSha256[
    "PNP.DirectWire.classifyTerminalBCELAnchorNucleus_exhaustive"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal computed BCEL anchor-nucleus fingerprint mismatch/);

  const releaseAxiom = makeProject(t);
  releaseAxiom.release.earnedBoundary.residualTerminalBCELAnchorNucleusProjectAxiomClosure = ["PNP.ForgedAxiom"];
  write(releaseAxiom.root, "downloads/formal-publication-release.json", json(releaseAxiom.release));
  expectFailure(releaseAxiom, /current manifest residual terminal computed BCEL anchor-nucleus axiom closure mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalBCELAnchorNucleusClassifierTheorem =
    "PNP.DirectWire.TerminalFourCornerCarrier.computedBN2SquareLegitimate";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal computed BCEL anchor-nucleus theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalBCELConstantCutConclusionFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal computed BCEL anchor-nucleus evidence mismatch/);

  const statusGate = makeProject(t);
  const statusGatePayload = JSON.parse(readFileSync(path.join(statusGate.sourceDir, "public/pnp-status.json"), "utf8"));
  statusGatePayload.leanSaturatePositiveFormalized = true;
  rewriteCorePayload(statusGate, "public/pnp-status.json", statusGatePayload);
  expectFailure(statusGate, /status residual terminal computed BCEL anchor-nucleus evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-computed-bcel-anchor-nucleus"
  ).nonClaim = "This derives every premise, establishes BCELReady, and proves P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal computed BCEL anchor-nucleus publication boundary mismatch/);
  ...
  statusTheoremPayload.formalPublicationMilestones.find(
    ...
    (row) => row.name === "PNP.DirectWire.classifyTerminalBCELAnchorNucleus_exhaustive"
  ).actualKernelTypeSha256 = "0".repeat(64);
  rewriteCorePayload(statusTheorem, "public/pnp-status.json", statusTheoremPayload);
  expectFailure(statusTheorem, /status residual terminal computed BCEL anchor-nucleus theorem evidence mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal computed BCEL anchor-nucleus theorem mismatch/);
  ...
  rewriteCorePayload(inventoryModule, "public/pnp-theorem-inventory.json", inventoryModulePayload);
  expectFailure(inventoryModule, /inventory residual terminal computed BCEL anchor-nucleus theorem mismatch/);

  const inventoryFingerprint = makeProject(t);
  const inventoryFingerprintPayload = JSON.parse(readFileSync(path.join(inventoryFingerprint.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryFingerprintPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.classifyTerminalBCELAnchorNucleus_exhaustive"
  ).kernelType = "forged-kernel-type";
  rewriteCorePayload(inventoryFingerprint, "public/pnp-theorem-inventory.json", inventoryFingerprintPayload);
  expectFailure(inventoryFingerprint, /inventory residual terminal computed BCEL anchor-nucleus fingerprint mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-computed-bcel-anchor-nucleus"
  ).scope = "unconditional-bcel-ready";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal computed BCEL anchor-nucleus boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal computed BCEL anchor-nucleus fingerprint mismatch/);
});

test("rejects terminal saturation-positivity firewall release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalSaturationPositivityFirewallFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal saturation-positivity firewall boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalSaturationPositivityFirewallTheoremKernelTypeSha256[
    "PNP.DirectWire.classifyTerminalSaturationPositivity_exhaustive"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal saturation-positivity firewall fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalSaturationPositivityFirewallClassifierTheorem =
    "PNP.DirectWire.classifyTerminalBCELAnchorNucleus_exhaustive";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal saturation-positivity firewall theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalSaturationPositivityFirewallFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal saturation-positivity firewall evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-saturation-positivity-firewall"
  ).nonClaim = "This establishes SaturatePositive and proves P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal saturation-positivity firewall publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.classifyTerminalSaturationPositivity_exhaustive"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal saturation-positivity firewall theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-saturation-positivity-firewall"
  ).scope = "full-saturate-positive";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal saturation-positivity firewall boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal saturation-positivity firewall fingerprint mismatch/);
});

test("rejects candidate saturation cost-balance release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalSaturationCostBalanceFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal candidate saturation cost-balance boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalSaturationCostBalanceTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalSaturationBalanceOutcome.balanced_event"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal candidate saturation cost-balance fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalSaturationCostBalanceOutcomeTheorem =
    "PNP.DirectWire.classifyTerminalSaturationPositivity_exhaustive";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal candidate saturation cost-balance theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalFirstNontransparentStepFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal candidate saturation cost-balance evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-candidate-saturation-cost-balance"
  ).nonClaim = "This routes every nontransparent event and proves P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal candidate saturation cost-balance publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.TerminalSaturationBalanceOutcome.balanced_event"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal candidate saturation cost-balance theorem mismatch/);
  ...
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal candidate saturation cost-balance boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal candidate saturation cost-balance fingerprint mismatch/);
});

test("rejects terminal interface-exposure routing release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalInterfaceExposureRoutingFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal interface-exposure routing boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalInterfaceExposureRoutingTheoremKernelTypeSha256[
    "PNP.DirectWire.terminalInterfaceExposure_transparent_or_eRoute"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal interface-exposure routing fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalInterfaceExposureClassifierTheorem =
    "PNP.DirectWire.TerminalSaturationBalanceOutcome.balanced_event";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal interface-exposure routing theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalFirstInterfaceExposureRouteFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal interface-exposure routing evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-interface-exposure-routing"
  ).nonClaim = "This establishes global Package E route completeness and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal interface-exposure routing publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.terminalInterfaceExposure_transparent_or_eRoute"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal interface-exposure routing theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-interface-exposure-routing"
  ).scope = "global-package-e-route-completeness";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal interface-exposure routing boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal interface-exposure routing fingerprint mismatch/);
});

test("rejects finite terminal positive-saturation composition release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalFiniteSaturatePositiveCompositionFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal finite SaturatePositive composition boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalFiniteSaturatePositiveCompositionTheoremKernelTypeSha256[
    "PNP.DirectWire.TerminalFiniteSaturatePositiveOutcome.sound"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal finite SaturatePositive composition fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalFiniteSaturatePositiveClassifierTheorem =
    "PNP.DirectWire.classifyTerminalSaturationInterfaceRouting_exhaustive";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal finite SaturatePositive composition theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalFiniteOriginKernelObligationClosureRoutedFormalized = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal finite SaturatePositive composition evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-finite-saturate-positive-composition"
  ).nonClaim = "This establishes manuscript-wide SaturatePositive and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal finite SaturatePositive composition publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.TerminalFiniteSaturatePositiveOutcome.sound"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal finite SaturatePositive composition theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-finite-saturate-positive-composition"
  ).scope = "manuscript-wide-saturate-positive";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal finite SaturatePositive composition boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal finite SaturatePositive composition fingerprint mismatch/);
});

test("rejects residual terminal RankWF release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalRankWFFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal RankWF boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalRankWFTheoremKernelTypeSha256[
    "PNP.DirectWire.terminalResidualRankLexLT_wellFounded"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal RankWF fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalRankWFWellFoundedTheorem =
    "PNP.DirectWire.classifyTerminalFiniteSaturatePositive_exhaustive";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal RankWF theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalRankWFAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal RankWF evidence mismatch/);
  ...
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal RankWF publication boundary mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal RankWF theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-rank-wf"
  ).scope = "all-routes-strictly-decrease-and-are-complete";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal RankWF boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal RankWF fingerprint mismatch/);
});

test("rejects residual terminal BN3 request-envelope release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalBN3RequestEnvelopeFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal BN3 request-envelope boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalBN3RequestEnvelopeTheoremKernelTypeSha256[
    "PNP.DirectWire.classifyTerminalBN3RequestEnvelope_exhaustive"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal BN3 request-envelope fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalBN3RequestEnvelopeClassifierTheorem =
    "PNP.DirectWire.classifyTerminalFiniteSaturatePositive_exhaustive";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal BN3 request-envelope theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalBN3RequestEnvelopeAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal BN3 request-envelope evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-bn3-request-envelope"
  ).nonClaim = "This establishes BN4-BN6, global ZeroSlack, polynomial PCCMin, and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal BN3 request-envelope publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.classifyTerminalBN3RequestEnvelope_exhaustive"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal BN3 request-envelope theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-bn3-request-envelope"
  ).scope = "polynomial-complete-bn3-through-bn6";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal BN3 request-envelope boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal BN3 request-envelope fingerprint mismatch/);
});

test("rejects residual terminal BN4 activation-cancellation release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalBN4ActivationCancellationFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal BN4 activation-cancellation boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalBN4ActivationCancellationTheoremKernelTypeSha256[
    "PNP.DirectWire.classifyTerminalBN4ActivationCancellation_exhaustive"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal BN4 activation-cancellation fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalBN4ActivationCancellationClassifierTheorem =
    "PNP.DirectWire.classifyTerminalBN3RequestEnvelope_exhaustive";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal BN4 activation-cancellation theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalBN4ActivationCancellationAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal BN4 activation-cancellation evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-bn4-activation-cancellation"
  ).nonClaim = "This establishes the full historical BN4 theorem, BN5, PkgC, BN6, and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal BN4 activation-cancellation publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.classifyTerminalBN4ActivationCancellation_exhaustive"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal BN4 activation-cancellation theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-bn4-activation-cancellation"
  ).scope = "full-historical-bn4-through-bn6";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal BN4 activation-cancellation boundary mismatch/);
...
test("rejects residual terminal V54 consumer-antichain normal-form release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalV54ConsumerAntichainNormalFormFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal V54 consumer-antichain normal-form boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalV54ConsumerAntichainNormalFormTheoremKernelTypeSha256[
    "PNP.DirectWire.terminalV54_consumerAntichain_normal_form"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal V54 consumer-antichain normal-form fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalV54ConsumerAntichainNormalFormTheorem =
    "PNP.DirectWire.classifyTerminalBN5FullShadowLocalization_exhaustive";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal V54 consumer-antichain normal-form theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalConsumerAntichainNormalFormAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal V54 consumer-antichain normal-form evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-consumer-antichain-normal-form"
  ).nonClaim = "This constructs PkgC, proves BN6, and establishes P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal V54 consumer-antichain normal-form publication boundary mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal V54 consumer-antichain normal-form theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-consumer-antichain-normal-form"
  ).scope = "full-pkgc-bn6-and-global-route-construction";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal V54 consumer-antichain normal-form boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal V54 consumer-antichain normal-form fingerprint mismatch/);
});

test("rejects residual terminal V53 constant-cut hypergraph-rigidity release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalV53ConstantCutHypergraphRigidityFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal V53 constant-cut hypergraph-rigidity boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalV53ConstantCutHypergraphRigidityTheoremKernelTypeSha256[
    "PNP.DirectWire.terminalV53_constantCut_hypergraph_rigidity"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal V53 constant-cut hypergraph-rigidity fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalV53ConstantCutHypergraphRigidityTheorem =
    "PNP.DirectWire.terminalV54_consumerAntichain_normal_form";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal V53 constant-cut hypergraph-rigidity theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalConstantCutHypergraphRigidityAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal V53 constant-cut hypergraph-rigidity evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-constant-cut-hypergraph-rigidity"
  ).nonClaim = "This constructs PkgC, BN6, ZeroSlack, PCCMin, and P = NP.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal V53 constant-cut hypergraph-rigidity publication boundary mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal V53 constant-cut hypergraph-rigidity theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-constant-cut-hypergraph-rigidity"
  ).scope = "full-pkgc-bn6-zeroslack-pccmin-and-root";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal V53 constant-cut hypergraph-rigidity boundary mismatch/);
...
test("rejects residual terminal PkgC typed-restoration release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalPkgCTypedRestorationFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal PkgC typed-restoration boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalPkgCTypedRestorationTheoremKernelTypeSha256[
    "PNP.DirectWire.classifyTerminalPkgCTypedRestoration_exhaustive"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal PkgC typed-restoration fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalPkgCTypedRestorationClassifierTheorem =
    "PNP.DirectWire.terminalPkgC_typedRestoration_realization";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal PkgC typed-restoration theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalPkgCTypedRestorationAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal PkgC typed-restoration evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-pkgc-typed-restoration"
  ).nonClaim = "This constructs full PkgC and proves the overall claim.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal PkgC typed-restoration publication boundary mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal PkgC typed-restoration theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-pkgc-typed-restoration"
  ).scope = "full-pkgc-and-global-route-completion";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal PkgC typed-restoration boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal PkgC typed-restoration fingerprint mismatch/);
});

test("rejects residual terminal PkgC same-key-cancellation release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalPkgCSameKeyCancellationFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal PkgC same-key-cancellation boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalPkgCSameKeyCancellationTheoremKernelTypeSha256[
    "PNP.DirectWire.classifyTerminalPkgCSameKeyCancellation_exhaustive"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal PkgC same-key-cancellation fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalPkgCSameKeyCancellationClassifierTheorem =
    "PNP.DirectWire.classifyTerminalPkgCTypedRestoration_exhaustive";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal PkgC same-key-cancellation theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalPkgCSameKeyCancellationAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal PkgC same-key-cancellation evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-pkgc-same-key-cancellation"
  ).nonClaim = "This is the terminal candidate's ambient BN4 ledger and proves full PkgC route silence.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal PkgC same-key-cancellation publication boundary mismatch/);
  ...
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal PkgC same-key-cancellation theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-pkgc-same-key-cancellation"
  ).scope = "ambient-bn4-ledger-full-pkgc-global-route-silence";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal PkgC same-key-cancellation boundary mismatch/);
  ...
  rewriteCorePayload(mapFingerprint, "publication/FORMAL_PUBLICATION_MAP.json", mapFingerprintPayload);
  expectFailure(mapFingerprint, /core publication map residual terminal PkgC same-key-cancellation fingerprint mismatch/);
});

test("rejects residual terminal PkgC ambient-BN4-ledger release, status, inventory, and publication-map mutation", (t) => {
  const releaseFlag = makeProject(t);
  releaseFlag.release.earnedBoundary.residualTerminalPkgCAmbientBN4LedgerFormalized = false;
  write(releaseFlag.root, "downloads/formal-publication-release.json", json(releaseFlag.release));
  expectFailure(releaseFlag, /current manifest residual terminal PkgC ambient-BN4-ledger boundary mismatch/);

  const releaseFingerprint = makeProject(t);
  releaseFingerprint.release.earnedBoundary.residualTerminalPkgCAmbientBN4LedgerTheoremKernelTypeSha256[
    "PNP.DirectWire.terminalPkgC_computedAmbientBN4_silence_singletonizes"
  ] = "0".repeat(64);
  write(releaseFingerprint.root, "downloads/formal-publication-release.json", json(releaseFingerprint.release));
  expectFailure(releaseFingerprint, /current manifest residual terminal PkgC ambient-BN4-ledger fingerprint mismatch/);

  const releaseIdentity = makeProject(t);
  releaseIdentity.release.earnedBoundary.residualTerminalPkgCAmbientBN4LedgerClassifierTheorem =
    "PNP.DirectWire.classifyTerminalPkgCSameKeyCancellation_exhaustive";
  write(releaseIdentity.root, "downloads/formal-publication-release.json", json(releaseIdentity.release));
  expectFailure(releaseIdentity, /current manifest residual terminal PkgC ambient-BN4-ledger theorem identity mismatch/);

  const statusFlag = makeProject(t);
  const statusFlagPayload = JSON.parse(readFileSync(path.join(statusFlag.sourceDir, "public/pnp-status.json"), "utf8"));
  statusFlagPayload.leanResidualTerminalPkgCAmbientBN4LedgerAxiomAuditPassed = false;
  rewriteCorePayload(statusFlag, "public/pnp-status.json", statusFlagPayload);
  expectFailure(statusFlag, /status residual terminal PkgC ambient-BN4-ledger evidence mismatch/);

  const statusMilestone = makeProject(t);
  const statusMilestonePayload = JSON.parse(readFileSync(path.join(statusMilestone.sourceDir, "public/pnp-status.json"), "utf8"));
  statusMilestonePayload.formalPublicationMilestones.find(
    (row) => row.id === "residual-terminal-pkgc-ambient-bn4-ledger"
  ).nonClaim = "This derives the ambient ledger and proves complete global PkgC route silence.";
  rewriteCorePayload(statusMilestone, "public/pnp-status.json", statusMilestonePayload);
  expectFailure(statusMilestone, /status residual terminal PkgC ambient-BN4-ledger publication boundary mismatch/);

  const inventoryAxiom = makeProject(t);
  const inventoryAxiomPayload = JSON.parse(readFileSync(path.join(inventoryAxiom.sourceDir, "public/pnp-theorem-inventory.json"), "utf8"));
  inventoryAxiomPayload.milestoneCandidates.find(
    (row) => row.name === "PNP.DirectWire.terminalPkgC_computedAmbientBN4_silence_singletonizes"
  ).axioms = ["PNP.ForgedAxiom"];
  rewriteCorePayload(inventoryAxiom, "public/pnp-theorem-inventory.json", inventoryAxiomPayload);
  expectFailure(inventoryAxiom, /inventory residual terminal PkgC ambient-BN4-ledger theorem mismatch/);

  const mapMilestone = makeProject(t);
  const mapMilestonePayload = JSON.parse(readFileSync(path.join(mapMilestone.sourceDir, "publication/FORMAL_PUBLICATION_MAP.json"), "utf8"));
  mapMilestonePayload.milestones.find(
    (row) => row.id === "residual-terminal-pkgc-ambient-bn4-ledger"
  ).scope = "derived-terminal-ledger-and-complete-global-pkgc";
  rewriteCorePayload(mapMilestone, "publication/FORMAL_PUBLICATION_MAP.json", mapMilestonePayload);
  expectFailure(mapMilestone, /core publication map residual terminal PkgC ambient-BN4-ledger boundary mismatch/);
