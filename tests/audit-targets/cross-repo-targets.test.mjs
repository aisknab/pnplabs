...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 23884,
    theoremCount: 12925,
    assumptionFreeTheoremCount: 6851,
    excludedPrivateDeclarationCount: 14317,
    sourceClosureModuleCount: 215,
    axiomCount: 4,
    milestoneCandidates: [{
