...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 8229,
    theoremCount: 4080,
    assumptionFreeTheoremCount: 2964,
    excludedPrivateDeclarationCount: 2585,
    sourceClosureModuleCount: 74,
    axiomCount: 4,
    milestoneCandidates: [{
