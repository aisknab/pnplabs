...
function makeProject(t) {
  ...
  const inventoryPayload = {
    ...
    declarationCount: 24758,
    theoremCount: 13298,
    assumptionFreeTheoremCount: 6989,
    excludedPrivateDeclarationCount: 14645,
    sourceClosureModuleCount: 227,
    axiomCount: 4,
    milestoneCandidates: [{
  ...
  assert.equal(inventoryPayload.milestoneCandidates.length, 2341, "synthetic inventory must match the published reviewed-candidate count");
