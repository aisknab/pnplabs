...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 11688,
    theoremCount: 6779,
    assumptionFreeTheoremCount: 3551,
    excludedPrivateDeclarationCount: 4464,
    sourceClosureModuleCount: 102,
    axiomCount: 4,
    milestoneCandidates: [{
