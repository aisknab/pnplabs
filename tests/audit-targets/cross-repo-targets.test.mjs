...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 10300,
    theoremCount: 5678,
    assumptionFreeTheoremCount: 3306,
    excludedPrivateDeclarationCount: 3828,
    sourceClosureModuleCount: 90,
    axiomCount: 4,
    milestoneCandidates: [{
