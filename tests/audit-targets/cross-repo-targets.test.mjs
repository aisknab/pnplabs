...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 9906,
    theoremCount: 5367,
    assumptionFreeTheoremCount: 3252,
    excludedPrivateDeclarationCount: 3630,
    sourceClosureModuleCount: 87,
    axiomCount: 4,
    milestoneCandidates: [{
