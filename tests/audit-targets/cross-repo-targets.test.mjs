...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 10049,
    theoremCount: 5476,
    assumptionFreeTheoremCount: 3272,
    excludedPrivateDeclarationCount: 3686,
    sourceClosureModuleCount: 88,
    axiomCount: 4,
    milestoneCandidates: [{
