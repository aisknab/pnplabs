...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 12247,
    theoremCount: 7160,
    assumptionFreeTheoremCount: 3676,
    excludedPrivateDeclarationCount: 5000,
    sourceClosureModuleCount: 106,
    axiomCount: 4,
    milestoneCandidates: [{
