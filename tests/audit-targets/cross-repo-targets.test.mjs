...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 24054,
    theoremCount: 12985,
    assumptionFreeTheoremCount: 6903,
    excludedPrivateDeclarationCount: 14317,
    sourceClosureModuleCount: 216,
    axiomCount: 4,
    milestoneCandidates: [{
