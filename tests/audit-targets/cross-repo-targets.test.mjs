...
function makeProject(t) {
  ...
  const inventoryPayload = {
    ...
    declarationCount: 24934,
    theoremCount: 13352,
    assumptionFreeTheoremCount: 7015,
    excludedPrivateDeclarationCount: 14691,
    sourceClosureModuleCount: 228,
    axiomCount: 4,
    milestoneCandidates: [{
  ...
  assert.equal(inventoryPayload.milestoneCandidates.length, 2352, "synthetic inventory must match the published reviewed-candidate count");
