...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 23819,
    theoremCount: 12894,
    assumptionFreeTheoremCount: 6846,
    excludedPrivateDeclarationCount: 14273,
    sourceClosureModuleCount: 213,
    axiomCount: 4,
    milestoneCandidates: [{
