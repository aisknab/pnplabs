...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 12233,
    theoremCount: 7146,
    assumptionFreeTheoremCount: 3669,
    excludedPrivateDeclarationCount: 4738,
