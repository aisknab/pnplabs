...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 10914,
    theoremCount: 6185,
    assumptionFreeTheoremCount: 3397,
    excludedPrivateDeclarationCount: 4240,
    sourceClosureModuleCount: 96,
    axiomCount: 4,
    milestoneCandidates: [{
