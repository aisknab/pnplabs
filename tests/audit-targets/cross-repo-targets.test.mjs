...
function makeProject(t) {
  ...
  const inventory = json({
    ...
    declarationCount: 11055,
    theoremCount: 6294,
    assumptionFreeTheoremCount: 3428,
    excludedPrivateDeclarationCount: 4278,
    sourceClosureModuleCount: 97,
    axiomCount: 4,
    milestoneCandidates: [{
